...
const Ro = (t) => t.substring(t.lastIndexOf(".") + 1), ta = (t) => t.split("/").pop(), lt = (t) => {
  const e = ta(t);
  if (e) {
...
class ia {
  constructor(e) {
    this.names = /* @__PURE__ */ new Set(), this.unsupportedChars = {}, this.encoding = e.encoding, e.alias.forEach((n) => this.names.add(n)), this.sourceByteLength = sa(e.data), this.cache = new Uo();
  }
  /**
  ...
  parse(e) {
    try {
      ...
      for (const [c, l] of Object.entries(s)) {
        ...
        const { name: f, bytecode: h } = la(l);
        i[u] = h, f && (a[f] = u);
      }
      const o = {
        data: i,
        names: Object.keys(a).length > 0 ? a : void 0,
        codeToName: Object.keys(a).length > 0 ? ca(a) : void 0,
        info: "",
        baseUp: 8,
        baseDown: 2,
        height: Ut,
      ...
      if (0 in i) {
        ...
        try {
          ...
          let u = c.findIndex((f) => No.includes(f));
          u >= 0 && (o.info = l.substring(0, u), u + 3 < c.length && (o.baseUp = c[u + 1], o.baseDown = c[u + 2], o.height = o.baseDown + o.baseUp, o.width = o.height, oa(o, c[u + 3])));
        } catch {
  ...
  parse(e) {
    try {
      ...
      try {
        ...
        let l = c.indexOf("\0");
        l >= 0 && (i.info = c.substring(0, l), l + 3 < s.length && (i.baseUp = s[l + 1], i.baseDown = s[l + 2], i.height = i.baseUp + i.baseDown, i.width = i.height, oa(i, s[l + 3])));
      } catch {
      ...
      return i.data = a, i.names = Object.keys(o).length > 0 ? o : void 0, i.codeToName = Object.keys(o).length > 0 ? ca(o) : void 0, i;
    } catch (n) {
      const r = n instanceof Error ? n.message : String(n);
...
class Tn extends Vo {
   ...
   */
  static computeAdvance(e, n, r = ms) {
...
function Xo(t, e, n, r, s, i, a) {
  const o = ` stroke-dasharray="${a}"`;
  return `<line x1="${t}" y1="${-e}" x2="${n}" y2="${-r}" stroke="${s}" stroke-width="${i}"${o}/>`;
}
function Ko(t, e, n) {
  const { capHeight: r, descenderHeight: s, origin: i = "baseline" } = t, a = r + s, o = ua(t);
  let c, l, u;
  ...
  const f = [
    c ? ys(c, "rgba(255, 0, 0, 0.06)") : "",
    l ? ys(l, "rgba(255, 0, 0, 0.14)") : "",
    Yo(o, e, n)
  ];
...
function ec(t, e, n) {
  ...
  if (r <= 0)
    return 0;
  const s = r * Zo, i = [], a = /* @__PURE__ */ new Set(), o = (l) => {
...
function nc(t, e, n, r = Nn, s = !1, i = 0) {
  var a;
  let o = t;
  ...
  if (e.header.fontType === K.UNIFONT || Qo(e, t, n)) {
    const u = e.header.fontType === K.UNIFONT && (s || e.content.dualOrientation || ha(t, n));
...
function rc(t, e, n, r = Nn, s = !1, i = 0) {
  const a = Gn(e.content, n);
  return nc(
    t,
    e,
    a,
...
class Zt {
  ...
  constructor(e) {
    if (e.start && e.end && e.bulge !== void 0) {
      ...
      this.center = e.center.clone(), this.radius = e.radius, this.isClockwise = e.isClockwise, this.startAngle = e.startOctant * vs;
      const n = (e.octantCount === 0 ? 8 : e.octantCount) * vs;
...
class ac {
  ...
  scaleShapeByHeightAndWidth(e, n, r) {
    ...
    return new Bt(u, f, e.hasExplicitAdvance);
  }
  /**
  ...
  buildShapeFromState(e) {
    ...
    return e.currentPolyline.length > 1 && n.push(e.currentPolyline.map((r) => r.clone())), new Bt(e.currentPoint.clone(), n, e.hasExplicitAdvance);
  }
  /**
  ...
  handleArcSegment(e, n, r, s, i, a) {
    ...
    if (i)
      if (r === 0)
        ...
        const c = o.clone().add(n), l = Zt.fromBulge(o, c, r / 127).tessellate();
        a.push(...l.slice(1));
      }
    return o.add(n), o;
  }
...
class oc {
  ...
  constructor(e) {
    if (e instanceof ArrayBuffer) {
      ...
      this.fontData = e;
    this.shapeParser = new ac(this.fontData);
  }
  /**
   ...
   */
  getFontMetrics(e) {
    return Gn(this.fontData.content, e);
  }
  /**
  ...
  getBigfontBaselineInkPaddingNative() {
    if (this.bigfontBaselineInkPaddingNative === void 0) {
      ...
      this.bigfontBaselineInkPaddingNative = ec(
        this.fontData,
  ...
  usesUnifontBaselineOriginFont(e) {
    return this.unifontBaselineOriginFont === void 0 && (this.unifontBaselineOriginFont = tc(
      this.fontData,
      (n) => this.getCharShape(n, e),
      e
...
function cc(t, e, n, r = Nn) {
  const s = Gn(e.content, n);
...
const mc = ["get", "getKey", "getAll", "getAllKeys", "count"], yc = ["put", "add", "delete", "clear"], Xn = /* @__PURE__ */ new Map();
function Cs(t, e) {
  if (!(t instanceof IDBDatabase && !(e in t) && typeof e == "string"))
    return;
  if (Xn.get(e))
    return Xn.get(e);
  const n = e.replace(/FromIndex$/, ""), r = e !== n, s = yc.includes(n);
  if (
    // Bail if the target doesn't exist on the target. Eg, getAll isn't in Edge.
    !(n in (r ? IDBIndex : IDBObjectStore).prototype) || !(s || mc.includes(n))
  )
    return;
...
const St = {
  ...
  constructor() {
    this.isClosing = !1, typeof window < "u" && window.addEventListener("pagehide", (e) => {
  ...
  async getDatabase() {
    ...
    return this.db ? this.db : (this.db = await gc(
      Be.DATABASE_NAME,
      Be.DATABASE_VERSION,
      {
...
de.prototype.fromSVG = function(t, e = {}) {
  ...
  function l(y) {
    return y.filter((m) => m.length).map((m) => {
      let b = parseFloat(m);
      return (e.decimalPlaces || e.decimalPlaces === 0) && (b = Ca(b, e.decimalPlaces)), b;
    });
  }
  function u(y) {
...
Nt.UTF8 = function(t, e, n) {
  const r = [], s = n;
  for (let i = 0; i < s; i++, e += 1)
    r[i] = t.getUint8(e);
  return String.fromCharCode.apply(null, r);
};
Nt.UTF16 = function(t, e, n) {
  const r = [], s = n / 2;
...
var hn = typeof WeakMap == "function" && /* @__PURE__ */ new WeakMap(), fn, Dc = function(t) {
  if (!fn) {
    fn = {};
    for (let s in kn)
      fn[s] = new String(s);
...
B.VARDELTAS = function(t) {
  ...
  for (; e < t.length; ) {
    const r = t[e];
    r === 0 ? e = _c(t, e, n) : r >= -128 && r <= 127 ? e = Uc(t, e, n) : e = Pc(t, e, n);
  }
  return n;
};
B.INDEX = function(t) {
  ...
  fe.call(
    ...
    Ht("scriptRecord", t, function(e, n) {
      ...
      return H.assert(!!s, "Unable to write GSUB: script " + e.tag + " has no default language system."), [
        ...
        ].concat(Ht("langSys", r.langSysRecords, function(i, a) {
          const o = i.langSys;
          return [
...
function Zc(t, e, n) {
  ...
  for (let c = 0; c < a; c++) {
    const l = s.parseUShort(), u = s.parseUShort(), f = s.parseUShort(), h = s.parseUShort(), p = Bn[h] || h, y = s.parseUShort(), m = s.parseUShort(), b = $c(l, f, n), v = $r(l, u, f), w = Kc(l);
...
var Ia = { parse: Zc, make: Qc, getNameByID: Mn };
function el(t, e, n, r) {
...
Da.prototype.charToGlyphIndex = function(t) {
...
function zt(t, e = "hexa") {
  ...
  let n = ["hsl", "hsla"].includes(e) ? xl(t) : null;
  switch (e) {
    case "rgba":
...
var Pa = { parse: yl, make: bl, getPaletteColor: Xr, parseColor: Dn, formatColor: zt };
function Sl(t, e) {
  let n = e || new Pt();
  return {
    configurable: !0,
...
Ce.prototype.bindConstructorValues = function(t) {
  ...
  this.name = t.name || null, this.unicode = t.unicode, this.unicodes = t.unicodes || (t.unicode !== void 0 ? [t.unicode] : []), "xMin" in t && (this.xMin = t.xMin), "yMin" in t && (this.yMin = t.yMin), "xMax" in t && (this.xMax = t.xMax), "yMax" in t && (this.yMax = t.yMax), "advanceWidth" in t && (this.advanceWidth = t.advanceWidth), "leftSideBearing" in t && (this.leftSideBearing = t.leftSideBearing), "points" in t && (this.points = t.points), Object.defineProperty(this, "path", Sl(this, t.path));
};
...
typeof Symbol < "u" && Symbol.iterator && (zn.prototype[Symbol.iterator] = function() {
  let t = -1;
  return {
    next: (function() {
      t++;
...
function wl(t, e) {
  return new Qt({ index: e, font: t });
}
function Cl(t, e, n, r, s, i) {
  return function() {
    const a = new Qt({ index: e, font: t });
...
function Ml(t, e, n, r) {
  ...
  return Zr(s, r > 1 ? Il : Ga, n);
}
function Jr(t, e, n, r, s) {
  const i = Kr(t, e, n, s);
  return Zr(i, s > 1 ? Rl : Ha, r);
}
function Dl(t, e, n) {
...
function _l(t, e, n) {
  const r = [];
  for (let s = 0; s < n.length; s++) {
    const i = new DataView(new Uint8Array(n[s]).buffer), a = Dl(i, 0, 2), o = a.private[0], c = a.private[1];
    if (o !== 0 && c !== 0) {
...
function Qn(t, e, n, r, s) {
  ...
  for (let a = 0; a < n.length; a += 1) {
    const o = new DataView(new Uint8Array(n[a]).buffer), c = Ml(o, 0, r, s);
...
function Va(t, e, n) {
  ...
  for (let s = 0; s < t.length; s += 1) {
    const i = t[s];
    let a = e[i.name];
    a !== void 0 && !Na(a, i.value) && (i.type === "SID" && (a = Wa(a, n)), r[i.op] = { name: i.name, type: i.type, value: a });
  }
  return r;
}
function Ns(t, e, n) {
...
function Xl(t, e) {
  ...
  const l = [];
  n.header = Hl(), n.nameIndex = zl([e.postScriptName]);
  let u = Ns(s, l);
  n.topDictIndex = Gs(u), n.globalSubrIndex = Vl(), n.charsets = ql(o, l), n.charStringsIndex = $l(t), n.privateDict = Yl(a, l), n.stringIndex = Wl(l);
...
var Ur = { parse: lu, make: uu, unicodeRanges: _r, getUnicodeRange: cu };
function hu(t, e) {
  const n = {}, r = new D.Parser(t, e);
...
function Cu(t, e) {
  ...
  for (let s = 0; s < t.axes.length; s++)
    n.fields = n.fields.concat(xu(s, t.axes[s]));
  const r = {};
...
function Bu(t, e) {
  ...
  for (let r = 0; r < t.axisSegmentMaps.length; r++) {
    const s = Ru(r, t.axisSegmentMaps[r]);
...
function oo(t) {
  ...
  const n = Math.pow(2, Hs(e.numTables));
  e.searchRange = 16 * n, e.entrySelector = Hs(n), e.rangeShift = e.numTables * 16 - e.searchRange;
  const r = [], s = [];
  let i = e.sizeOf() + zs().sizeOf() * e.numTables;
  for (; i % 4 !== 0; )
    i += 1, s.push({ name: "padding", type: "BYTE", value: 0 });
  for (let a = 0; a < t.length; a += 1) {
    const o = t[a];
    H.argument(o.tableName.length === 4, "Table name" + o.tableName + " is invalid.");
    const c = o.sizeOf(), l = zs(o.tableName, Qr(o.encode()), i, c);
...
function Vu(t) {
  ...
  const b = qa.make({
  ...
  }), w = Xa.make(t.glyphs.length), C = Ur.make(Object.assign({
    ...
    sxHeight: Ws(t, "xyvw", { yMax: Math.round(y.ascender / 2) }).yMax,
    sCapHeight: Ws(t, "HIKLEFJMNTZBDPRAGOQSUVWXY", y).yMax,
  ...
  _e && me.push(_e);
  const pe = oo(me), be = pe.encode(), ge = Qr(be), ye = pe.fields;
  let ce = !1;
...
var qu = { make: oo, fontToTable: Vu, computeCheckSum: Qr };
function er(t, e) {
...
function Zu(t) {
  ...
  return Sa(t.subarray(n, r), new Uint8Array(i));
}
function js(t) {
  return {
    x: t.x,
...
var Qu = Me, uo = class {
  ...
  getAll(t) {
    ...
    for (let r = 0; r < n.colorRecordIndices.length; r++) {
      ...
      for (let a = s; a < s + n.numPaletteEntries; a++)
        i.push(zt(n.colorRecords[a], t || "hexa"));
      e.push(i);
    }
    return e;
  }
  ...
  get(t) {
    ...
    if (!r || !s)
      return n;
    const i = Yu(r.baseGlyphRecords, "glyphID", t);
    if (!i)
      return n;
  ...
  updateColrTable(t, e) {
    ...
    let s = Xu(r.baseGlyphRecords, "glyphID", t);
    if (s === -1) {
      const u = { glyphID: t, firstLayerIndex: r.layerRecords.length, numLayers: 0 };
      s = Ku(r.baseGlyphRecords, "glyphID", u);
    }
  ...
  getOrCreateSvgImageCacheEntry(t) {
    ...
    r === void 0 && (r = nh(n), this.cache.set(n, r));
    let s = r.images.get(t);
    return s === void 0 && (s = rh(this.font, r.template, t), s.promise.then((i) => {
...
function rh(t, e, n) {
  return {
    promise: e.then((r) => {
      ...
      const i = ch(s, t.unitsPerEm);
      return i.image.decode().then(() => i);
    }),
    image: void 0
  };
}
var sh = typeof DecompressionStream == "function" ? ah : ih;
function ih(t) {
  try {
    return Promise.resolve(new TextDecoder().decode(lo(t) ? Zu(t) : t));
  } catch (e) {
  ...
  if (t._numberOfContours > 0) {
    ...
    if (H.argument(s.length === o, "Bad flags."), a.length > 0) {
      ...
      if (o > 0) {
        ...
        let u = 0;
        for (let h = 0; h < o; h += 1)
          i = s[h], l = c[h], l.x = $s(r, i, u, 2, 16), u = l.x;
        let f = 0;
        for (let h = 0; h < o; h += 1)
          i = s[h], l = c[h], l.y = $s(r, i, f, 4, 32), f = l.y;
      }
      t.points = c;
    } else
      t.points = [];
...
function fh(t, e, n, r, s) {
  return s.lowMemory ? hh(t, e, n, r) : uh(t, e, n, r);
}
var po = { getPath: ts, parse: fh }, ph = class {
  constructor(t) {
    this.font = t;
  }
  /**
  ...
  transformComponents(t, e, n, r, s, i) {
    ...
    for (let o = 0; o < t.components.length; o++) {
      const c = t.components[o], l = this.font.glyphs.get(c.glyphIndex), u = Ju(c), f = r.indexOf(o);
    ...
    if (n || r) {
      if (e || (e = this.font.variation.get()), r) {
        ...
        if (i) {
          ...
          s = new Qt(Object.assign({}, t, { points: o, path: ts(o) }));
        }
      } else if (n) {
        const i = t.getBlendPath(e);
        s = new Qt(Object.assign({}, t, { path: i }));
      }
    }
  ...
  constructor(t) {
    this.font = t, this.process = new ph(this.font), this.activateDefaultVariation(), this.getTransform = this.process.getTransform.bind(this.process);
  }
  /**
...
var en = Object.freeze(new at(0, 0)), vh = {
  cvCutIn: 17 / 16,
...
Tt = function(t) {
  ...
  for (t.ip = 0; t.ip < n; t.ip++) {
    if (++t.instructionCount > Ys)
      throw new Error(
        "Hinting instructions exceeded maximum of " + Ys
      );
    if (r = go[e[t.ip]], !r)
      throw new Error(
...
function Bh(t) {
  ...
  switch (t.zp0 = t.zp1 = t.zp2 = e, e) {
    case 0:
      t.tZone || Vn(t), t.z0 = t.z1 = t.z2 = t.tZone;
      break;
    case 1:
...
function ei(t, e) {
  ...
  let a = i.distance(r, en);
  t && (a = e.round(a)), s.setRelative(r, en, a, i), s.touch(r), e.rp0 = e.rp1 = n;
}
function ti(t, e) {
...
function ai(t, e) {
  ...
  let c = e.cvt[r], l = o.distance(i, en);
  t && (Math.abs(l - c) < e.cvCutIn && (l = c), l = e.round(l)), a.setRelative(i, en, l, o), e.zp0 === 0 && (i.xo = i.x, i.yo = i.y), a.touch(i), e.rp0 = e.rp1 = s;
}
function ef(t) {
  const e = t.prog;
  let n = t.ip;
...
function oi(t, e) {
  ...
  n.push(e.dpv.distance(s, en, t, !1) * 64);
}
function ci(t, e) {
...
function he(t) {
  this.tokens = [], this.registeredContexts = {}, this.contextCheckers = [], this.events = {}, this.registeredModifiers = [], $f.call(this, t);
}
...
qn.prototype.subscribe = function(t) {
...
function pp(t, e, n) {
  t instanceof ut && ui[t.id] && ui[t.id](t, e, n);
}
var At = pp;
function dp(t) {
  let e = [].concat(t.backtrack);
  for (let n = e.length - 1; n >= 0; n--) {
    const r = e[n], s = So(r), i = mt(r);
    if (!s && !i) return !0;
    if (s) return !1;
  }
  return !1;
...
function bp(t) {
  const e = "arab";
  let n = this.tokenizer.getRangeTokens(t), r = hi(n);
...
function Cp(t) {
  const e = "delf", n = "ccmp";
  let r = this.tokenizer.getRangeTokens(t), s = fi(r);
...
function Ap(t) {
  const e = "latn";
  let n = this.tokenizer.getRangeTokens(t), r = pi(n);
  for (let s = 0; s < r.context.length; s++) {
    r.setCurrentIndex(s);
    let i = this.query.lookupFeature({
      tag: "liga",
...
function Bp(t) {
  const e = "thai";
  let n = this.tokenizer.getRangeTokens(t), r = di(n, 0);
  for (let s = 0; s < r.context.length; s++) {
    r.setCurrentIndex(s);
    let i = this.query.lookupFeature({
      tag: "ccmp",
...
function Up(t) {
  const e = "thai";
  let n = this.tokenizer.getRangeTokens(t), r = mi(n, 0);
  for (let s = 0; s < r.context.length; s++) {
    r.setCurrentIndex(s);
    let i = this.query.lookupFeature({
      tag: "rlig",
...
ze.prototype.contextChecks = {
  ...
  latinWordCheck: Ep,
  arabicWordCheck: ap,
  arabicSentenceCheck: lp,
  thaiWordCheck: Rp,
  unicodeVariationSequenceCheck: Hp
};
function It(t) {
...
ze.prototype.applyFeatures = function(t, e) {
  ...
  this.query || (this.query = new rp(t));
  for (let n = 0; n < e.length; n++) {
    const r = e[n];
...
function te(t) {
  ...
  this.supported = !0, this.glyphs = new Qe.GlyphSet(this, t.glyphs || []), this.encoding = new Ba(this), this.position = new ju(this), this.substitution = new Qu(this), this.tables = this.tables || {}, this.tables = new Proxy(this.tables, {
    ...
    get: function() {
      return this._hinting ? this._hinting : this.outlinesFormat === "truetype" ? this._hinting = new qf(this) : null;
    }
  });
}
...
te.prototype.stringToGlyphIndexes = function(t, e) {
  const n = new Jp(), r = (i) => this.charToGlyphIndex(i.char);
...
te.prototype.getPath = function(t, e, n, r, s) {
  ...
  const i = new Pt();
  if (i._layers = [], za(this, i), i.stroke) {
...
function J(t, e) {
  if (e.compression === "WOFF") {
    ...
    if (Sa(n, r), r.byteLength !== e.length)
...
function Sd(t, e = {}) {
  ...
  for (let U = 0; U < a; U += 1) {
    ...
    switch (M.tag) {
      case "avar":
        ...
        break;
      case "cmap":
        _ = J(i, M), s.tables.cmap = Ra.parse(_.data, _.offset), s.encoding = new Ma(s.tables.cmap);
        break;
      case "cvt ":
      ...
      case "fpgm":
        ...
        break;
      case "head":
        _ = J(i, M), s.tables.head = qa.parse(_.data, _.offset), s.unitsPerEm = s.tables.head.unitsPerEm, n = s.tables.head.indexToLocFormat;
        break;
      case "hhea":
        _ = J(i, M), s.tables.hhea = ja.parse(_.data, _.offset), s.ascender = s.tables.hhea.ascender, s.descender = s.tables.hhea.descender, s.numberOfHMetrics = s.tables.hhea.numberOfHMetrics;
        break;
      case "HVAR":
        E = M;
        break;
      ...
      case "ltag":
        ...
        break;
      case "COLR":
        _ = J(i, M), s.tables.colr = Qa.parse(_.data, _.offset);
        break;
      case "CPAL":
        _ = J(i, M), s.tables.cpal = Pa.parse(_.data, _.offset);
        break;
      case "maxp":
        _ = J(i, M), s.tables.maxp = Xa.parse(_.data, _.offset), s.numGlyphs = s.tables.maxp.numGlyphs;
        break;
      case "name":
        W = M;
        break;
      case "OS/2":
        ...
        break;
      case "post":
        _ = J(i, M), s.tables.post = Ka.parse(_.data, _.offset), s.glyphNames = new Yr(s.tables.post);
        break;
      case "prep":
      ...
      case "gasp":
        try {
          _ = J(i, M), s.tables.gasp = io.parse(_.data, _.offset);
        } catch (re) {
          console.warn("Failed to parse gasp table, skipping."), console.warn(re);
        }
        break;
      case "SVG ":
        _ = J(i, M), s.tables.svg = ao.parse(_.data, _.offset);
        break;
    }
  }
  const X = J(i, W);
  if (s.tables.name = Ia.parse(X.data, X.offset, r), s.names = s.tables.name, b && P) {
    const U = n === 0, M = J(i, P), _ = xd.parse(M.data, M.offset, s.numGlyphs, U), re = J(i, b);
    s.glyphs = po.parse(re.data, re.offset, _, s, e);
  } else if (l) {
    const U = J(i, l);
  ...
  if (v) {
    const U = J(i, v);
    s.tables.gdef = ld.parse(U.data, U.offset);
  }
  if (w) {
    const U = J(i, w);
    s.tables.gpos = pd.parse(U.data, U.offset), s.position.init();
  }
  if (C) {
    const U = J(i, C);
    s.tables.gsub = Za.parse(U.data, U.offset);
  }
  if (f) {
    const U = J(i, f);
    s.tables.fvar = eo.parse(U.data, U.offset, s.names);
  }
  if (h) {
    const U = J(i, h);
    s.tables.stat = to.parse(U.data, U.offset, s.tables.fvar);
  }
  if (p) {
    ...
    const U = J(i, p);
    s.tables.gvar = so.parse(U.data, U.offset, s.tables.fvar, s.glyphs);
  }
  if (y) {
    ...
    const U = J(i, y);
    s.tables.cvar = ro.parse(U.data, U.offset, s.tables.fvar, s.tables.cvt || []);
  }
  if (m) {
  ...
  if (j) {
    const U = J(i, j);
    s.tables.meta = Ja.parse(U.data, U.offset), s.metas = s.tables.meta;
  }
...
function Td(t) {
  ...
  if (!bi(t, "A"))
    return 1;
  const n = t.charToGlyph("A"), r = n == null ? void 0 : n.yMax;
  if (!r || r <= 0)
    return 1;
  const s = e / r;
  let i = 0;
...
class Ad extends aa {
  ...
  toGeometry() {
    ...
    if (e == null) {
      ...
      if (e = new I.ShapeGeometry(n, 4), !vi(e))
        return e.dispose(), new I.BufferGeometry();
      e.hasAttribute("uv") && e.deleteAttribute("uv"), e.hasAttribute("normal") && e.deleteAttribute("normal"), e = Ed(e, 1e-6), this.font.cache.setGeometry(this.char.charCodeAt(0), this.fontSize, e);
    }
    return vi(e) ? e : new I.BufferGeometry();
  }
  /** @inheritdoc */
  hasStrokeGeometry() {
...
class Rd extends Ld {
  ...
  generateShapes(e, n = 100, r = "ltr") {
    const s = [];
    return Bd(e, n, this.data, r).forEach((a) => {
      s.push(...Gd(a));
    }), s;
  }
}
function Bd(t, e, n, r = "ltr") {
...
function _d(t) {
  ...
  for (let r = 0; r < e; r++) {
    let s = null, i = 1 / 0;
    for (let a = 0; a < e; a++)
      if (r !== a && t[r].every((o) => Dd(o, t[a]))) {
        const o = Math.abs(ea.area(t[a]));
        o < i && (i = o, s = a);
      }
    n[r] = s;
  }
...
function Si(t, e) {
  const n = ea.area(t.getPoints(32)) > 0, r = e === n ? t.curves.slice() : Nd(t.curves), s = new Io();
  return s.curves.push(...r), s;
}
function Gd(t, e = 32) {
  const n = t.subPaths;
  if (!n || n.length === 0) return [];
  const r = n.map((p) => p.getPoints(e)), s = _d(r), i = Ud(s), a = Pd(s), o = n.length, c = Array(o).fill(-1), l = Array(o).fill(-1);
  for (const p of a) {
    const y = [{ idx: p, d: 0 }];
    for (; y.length; ) {
      const m = y.pop();
...
function Zd(t, e, n) {
  for (var r, s = [], i = e; i < n; i += 3)
    r = (t[i] << 16 & 16711680) + (t[i + 1] << 8 & 65280) + (t[i + 2] & 255), s.push(Kd(r));
  return s.join("");
}
function Jd(t) {
...
function n0() {
  if (Ci) return ur;
  Ci = 1;
  var t = t0().Buffer, e = t.isEncoding || function(v) {
...
const S0 = {}, w0 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: S0
...
class cs extends aa {
   ...
   */
  constructor(e, n, r, s) {
    super(), this.fontSize = n, this.shape = r, this.font = s, this.code = e, this.width = cc(r, s.data, n);
  }
  /**
...
const ft = class ft extends ia {
  /**
   * Creates a new SHX font wrapper.
   * @param fontData - Font metadata and binary SHX data used to initialize the font.
   */
  constructor(e) {
    super(e), this.type = "shx", this.layoutShapeCache = new zr(4096), this.codeCache = /* @__PURE__ */ new Map(), this.font = new oc(e.data), this.data = this.font.fontData;
  }
  /**
  ...
  getCode(e) {
    ...
    if (r === K.BIGFONT && this.encoding) {
      const i = Ui.encode(e[0], this.encoding);
      if (Ui.decode(i, this.encoding) !== e[0])
...
class T0 {
  ...
  async getAvailableFonts() {
    ...
    const e = this._baseUrl, n = this.fetchAvailableFonts(e).finally(() => {
...
function k0(t) {
  return t && "getMaterialStats" in t && typeof t.getMaterialStats == "function" ? t.getMaterialStats() : da();
}
function ko(t, e) {
  const n = e.materials ?? k0(e.styleManager);
...
function I0(t) {
  return t === null ? null : `#${Eo(t).toString(16).padStart(6, "0")}`;
}
function R0(t) {
  if (!t)
    return null;
...
function B0(t) {
  ...
  const n = R0(e);
  if (n)
    return Eo(Number.parseInt(n.slice(1), 16));
...
class _0 {
  ...
  constructor(e, n, r = {}) {
    ...
    const s = n ?? new ln();
    this.ctxStack = new D0(s), this.yieldPropertyCommands = r.yieldPropertyCommands ?? !1, this.resetParagraphParameters = r.resetParagraphParameters ?? !1, this.yieldPercentSymbols = r.yieldPercentSymbols ?? !1, this.mifDecoder = r.mifDecoder ?? this.decodeMultiByteChar.bind(this), this.mifCodeLength = r.mifCodeLength ?? "auto";
  }
  /**
...
`)
        ...
        if (l === "%" && this.scanner.peek(1) === "%") {
          const f = this.scanner.peek(2).toLowerCase(), h = A0[f];
          if (h) {
...
class bt {
   ...
   */
  toCssColor() {
    return this._rgbValue !== null ? I0(this._rgbValue) : null;
  }
  /**
...
function Kt(t) {
  ...
  return n === 0 ? Yt(t.byBlockColor) : n === 256 ? Yt(t.byLayerColor) : n != null ? na(n) : e.rgbValue !== null ? Yt(e.rgbValue) : Yt(t.byLayerColor);
}
function o1(t) {
...
const H0 = 1.5, z0 = 0.8, W0 = 1e6, V0 = 1e4;
function Hi(t, e) {
  return Math.max(
    1,
...
function zi(t) {
  ...
  if (e < r)
    return Hi(t.text, n);
  const s = Hi(t.text, n), i = e / n, a = e / Math.max(s, Number.EPSILON);
  return i > W0 || a > V0 ? s : e;
}
...
const Y0 = /* @__PURE__ */ new I.Vector3(), Wi = /* @__PURE__ */ new I.Matrix4(), Vi = /* @__PURE__ */ new I.Matrix4(), Sr = /* @__PURE__ */ new I.Matrix4(), wr = /* @__PURE__ */ new I.Matrix4(), qi = /* @__PURE__ */ new I.Matrix4(), ji = /* @__PURE__ */ new I.Box3();
class ls extends ln {
  /**
...
class $i {
  ...
  constructor(e, n, r, s, i) {
    ...
    }), this._currentContext.color = this._colorSettings.color.copy(), this._currentContext.fontFace.family = a, this._currentContext.widthFactor = {
      value: i.widthFactor,
      isRelative: !0
  ...
  get currentLineHeight() {
    return Math.max(this.defaultLineSpaceFactor, 0) * this.currentLayoutFontSize * N0;
  }
  /**
  ...
  applyWidthFactorChange(e) {
    e && (e.isRelative ? this._currentContext.widthFactor = {
      value: e.value * this._currentContext.widthFactor.value,
      isRelative: !1
  ...
  buildCharTransformMatrix(e, n, r) {
    Vi.makeScale(this.currentWidthFactor, 1, 1);
    ...
    this._currentContext.bold && a === "mesh" ? wr.makeScale(1.06, 1.06, 1) : wr.identity(), qi.makeTranslation(e, n, 0);
    const o = new I.Matrix4();
    return o.copy(qi).multiply(wr).multiply(Sr).multiply(Vi), { matrix: o, obliqueExtraAdvance: i };
  }
  /**
  ...
  appendCharGeometry(e, n, r, s, i, a, o) {
    ...
    this._lineBatchEntries.push({ geometry: r, matrix: s }), this._options.collectCharBoxes !== !1 && (r.boundingBox || r.computeBoundingBox(), ji.copy(r.boundingBox).applyMatrix4(s), o.push({
      type: ue.CHAR,
      box: new I.Box3().copy(ji),
      char: n,
      children: []
  ...
  processAlignment() {
    ...
    const r = n, s = r.getSize(Y0), i = (o, c) => {
      var u, f;
  ...
  toThreeObject(e, n, r, s, i) {
    ...
    if (h.length > 0) {
      const y = h.length > 1 ? kd(h) : h[0], m = new I.Mesh(y, c);
    ...
    const p = [
      ...
      ...e.filter((y) => !(y instanceof I.ShapeGeometry)).map((y) => ({ geometry: y, matrix: Wi }))
    ];
    if (p.length > 0) {
...
const J0 = /\\U\+([0-9A-Fa-f]{4})/g;
function Q0(t) {
  return t.replace(J0, (e, n) => {
...
class tn extends I.Object3D {
  ...
  finalizePlacement(e, n, r, s) {
    ...
    if (n.directionVector && (s == null ? void 0 : s.shxFontType) !== K.SHAPES) {
      const y = n.directionVector, m = new I.Vector3(y.x, y.y, y.z), b = m.clone().cross(Yi), v = Yi.angleTo(m);
      f = b.z > 0 ? -v : v;
    }
    const h = n.position;
  ...
  createMTextGroup(e, n) {
    ...
    const r = zi(e) || 0, s = Number.isFinite(r) && r > 0;
    let i = oe.LEFT;
    s && e.attachmentPoint && ([
      Q.TopLeft,
      Q.MiddleLeft,
    ...
    h.fontFace.family = this.fontManager.findAndReplaceFont(n.font).toLowerCase(), h.capHeight = {
      value: o,
      isRelative: !1
    }, h.widthFactor = {
      value: c,
...
const Ki = /* @__PURE__ */ new I.Vector3(), Zi = /* @__PURE__ */ new I.Vector3(), Ji = /* @__PURE__ */ new I.Vector3();
class e1 {
  constructor(e = {}) {
    ...
    ), this.defaultStyleManager = new Ao();
  ...
  collectLayout(e, n, r) {
    ...
    const s = (c = (o = e.userData) == null ? void 0 : o.layout) == null ? void 0 : c.chars, i = (l = e.userData) == null ? void 0 : l.lineLayouts;
    if (i && i.length > 0 && i.forEach((h) => {
      Ki.set(0, h.y, 0).applyMatrix4(e.matrixWorld), Zi.set(0, h.y - h.height / 2, 0).applyMatrix4(e.matrixWorld), Ji.set(0, h.y + h.height / 2, 0).applyMatrix4(e.matrixWorld), r.push({
        y: Ki.y,
        height: Math.abs(Ji.y - Zi.y),
        breakIndex: h.breakIndex
      });
    }), s && s.length > 0) {
      const h = (u = e.userData) == null ? void 0 : u.charBoxType, p = Hr(
...
class t1 {
  constructor() {
    this.fontManager = $.instance, this.defaultStyleManager = new Ao(), this.isInitialized = !1;
  }
  /**
   * Used to manage materials used by texts
   */
...
export {
  ia as BaseFont,
  aa as BaseTextShape,
  z0 as CJK_MTEXT_CHAR_WIDTH_HEIGHT_RATIO,
  ue as CharBoxType,
  ...
  V0 as MAX_REASONABLE_MTEXT_WIDTH_CONTENT_EXCESS,
  W0 as MAX_REASONABLE_MTEXT_WIDTH_HEIGHT_RATIO,
  Cc as MESH_PARSED_FONT_OVERHEAD,
  H0 as MIN_REASONABLE_MTEXT_WIDTH_HEIGHT_RATIO,
  tn as MText,
  ...
  xr as TextScanner,
  ee as TokenType,
  c1 as UnifiedRenderer,
  e1 as WebWorkerRenderer,
  P0 as buildWorkerMaterialColorSettings,
  ko as collectIsolateMemoryStats,
  Ie as createDefaultColorSettings,
  U0 as deserializeMTextColor,
  da as emptyMaterialStats,
  i1 as escapeDxfLineEndings,
  ...
  M0 as getFonts,
  k0 as getMaterialStatsFromStyleManager,
  sa as getSourceByteLength,
  a1 as hasInlineFormattingCodes,
  s1 as int2rgb,
