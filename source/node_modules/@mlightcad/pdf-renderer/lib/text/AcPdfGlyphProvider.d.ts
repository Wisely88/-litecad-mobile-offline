import { AcGiMTextData, AcGiShapeData, AcGiTextStyle } from '@mlightcad/data-model';
/**
...
export interface AcPdfGlyphProvider {
    renderMText(data: AcGiMTextData, style: AcGiTextStyle): Promise<AcPdfMTextGlyphResult> | AcPdfMTextGlyphResult;
    renderShape(shape: AcGiShapeData, style?: AcGiTextStyle): Promise<AcPdfShapeGlyphResult> | AcPdfShapeGlyphResult;
}
//# sourceMappingURL=AcPdfGlyphProvider.d.ts.map