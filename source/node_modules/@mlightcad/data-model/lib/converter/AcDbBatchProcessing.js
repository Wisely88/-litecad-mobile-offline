...
var AcDbBatchProcessing = /** @class */ (function () {
    ...
    AcDbBatchProcessing.prototype.scheduleTask = function (callback) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, accmYieldToUi()];
                    case 1:
                        _a.sent();
     ...
     * ```
     */
    AcDbBatchProcessing.prototype.processChunk = function (callback, onComplete) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this._count <= 0)) return [3 /*break*/, 2];
                        return [4 /*yield*/, (onComplete === null || onComplete === void 0 ? void 0 : onComplete())];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                    case 2:
