...
var AcDbWorkerManager = /** @class */ (function () {
    ...
    AcDbWorkerManager.prototype.execute = function (input, workerUrl) {
        return __awaiter(this, void 0, void 0, function () {
            var startTime, taskId, error_1, duration, message;
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        var messageHandler = function (event) {
                            var _a = event.data, id = _a.id, success = _a.success, data = _a.data, error = _a.error, errorCode = _a.errorCode;
                            if (id !== taskId)
                                return;
                            _this.cleanupTask(taskId);
                        ...
                        var message = { id: taskId, input: input };
 ...
 */
export function acdbCreateWorkerApi(config) {
