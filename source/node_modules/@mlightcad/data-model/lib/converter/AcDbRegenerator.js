...
var AcDbRegenerator = /** @class */ (function (_super) {
     ...
     */
    AcDbRegenerator.prototype.processClasses = function () {
        // Do nothing
    };
    /**
    ...
    AcDbRegenerator.prototype.processObjects = function () {
        ...
        var layouts = this._database.objects.layout.newIterator();
        try {
        ...
        var imageDefs = this._database.objects.imageDefinition.newIterator();
        try {
        ...
        var mleaderStyles = this._database.objects.mleaderStyle.newIterator();
        try {
            for (var mleaderStyles_1 = __values(mleaderStyles), mleaderStyles_1_1 = mleaderStyles_1.next(); !mleaderStyles_1_1.done; mleaderStyles_1_1 = mleaderStyles_1.next()) {
                var mleaderStyle = mleaderStyles_1_1.value;
                this._database.events.dictObjetSet.dispatch({
                    database: this._database,
                    object: mleaderStyle,
            ...
            try {
                if (mleaderStyles_1_1 && !mleaderStyles_1_1.done && (_c = mleaderStyles_1.return)) _c.call(mleaderStyles_1);
            }
            finally { if (e_4) throw e_4.error; }
        }
        var layerFilters = this._database.objects.layerFilter.newIterator();
        try {
            for (var layerFilters_1 = __values(layerFilters), layerFilters_1_1 = layerFilters_1.next(); !layerFilters_1_1.done; layerFilters_1_1 = layerFilters_1.next()) {
                var layerFilter = layerFilters_1_1.value;
                this._database.events.dictObjetSet.dispatch({
                    database: this._database,
                    object: layerFilter,
            ...
            try {
                if (layerFilters_1_1 && !layerFilters_1_1.done && (_d = layerFilters_1.return)) _d.call(layerFilters_1);
            }
            finally { if (e_5) throw e_5.error; }
        }
        var layerIndexes = this._database.objects.layerIndex.newIterator();
        try {
            for (var layerIndexes_1 = __values(layerIndexes), layerIndexes_1_1 = layerIndexes_1.next(); !layerIndexes_1_1.done; layerIndexes_1_1 = layerIndexes_1.next()) {
                var layerIndex = layerIndexes_1_1.value;
                this._database.events.dictObjetSet.dispatch({
                    database: this._database,
                    object: layerIndex,
            ...
            try {
                if (layerIndexes_1_1 && !layerIndexes_1_1.done && (_e = layerIndexes_1.return)) _e.call(layerIndexes_1);
            }
