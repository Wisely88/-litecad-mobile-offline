...
var AcDbDictionary = /** @class */ (function (_super) {
    ...
    function AcDbDictionary(db) {
        ...
        _this.database = db;
        _this.objectId = db.generateHandle();
    ...
    AcDbDictionary.prototype.setAt = function (key, value) {
        ...
        if (manager.strictMode &&
            ...
            throw new Error('Cannot modify dictionary entries outside an active transaction.');
        }
        var existing = this.getAt(key);
        if (existing) {
        ...
        this.database.commitObjectHandle(value, function (id) { return _this.hasId(id); });
    ...
    AcDbDictionary.prototype.removeId = function (id) {
        ...
        if (object) {
            ...
            this.removeStoredObject(object, removedKey_1);
            return true;
        }
        return false;
    };
     ...
     */
    AcDbDictionary.prototype.removeStoredObject = function (object, key) {
        var _this = this;
        var manager = this.database.transactionManager;
        if (manager.strictMode &&
            !manager.isRecording() &&
            !manager.isApplyingUndoRedo()) {
            throw new Error('Cannot remove dictionary entries outside an active transaction.');
        }
        if (manager.isRecording()) {
            manager.recordRemove({
                type: 'dictionary',
        ...
        this._recordsByName.forEach(function (value, entryKey) {
            if (value === object) {
                _this._recordsByName.delete(entryKey);
            }
        });
    ...
    AcDbDictionary.prototype.removeAll = function () {
        var _this = this;
        this._recordsByName.forEach(function (value, key) {
            _this.database.releaseObjectHandle(value);
     ...
     */
    AcDbDictionary.prototype.entries = function () {
     ...
     */
    AcDbDictionary.prototype.dxfOutFields = function (filer) {
        var e_1, _a;
     ...
     */
    AcDbDictionary.prototype.dxfInFields = function (filer) {
