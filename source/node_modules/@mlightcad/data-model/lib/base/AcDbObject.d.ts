...
export declare const TEMP_OBJECT_ID_PREFIX = "TEMP_";
export declare function acdbSetHostApplicationServicesProvider(provider: () => {
 ...
 */
export declare function acdbAssignWorkingDatabase(database: AcDbDatabase): void;
export declare function acdbGetWorkingDatabase(): AcDbDatabase;
/**
...
export declare class AcDbObject<ATTRS extends AcDbObjectAttrs = AcDbObjectAttrs> {
     ...
     */
    private generateTemporaryHandle;
    /**
     ...
     */
    protected assignDatabase(db: AcDbDatabase): void;
    /**
    ...
    private static readonly SNAPSHOT_EXCLUDED_KEYS;
    /** Own-property keys restored through dedicated attribute/xdata helpers instead of generic copy. */
    private static readonly SNAPSHOT_INTERNAL_KEYS;
    /**
