 ...
 */
export function acdbCreateEntityForDxfIn(typeName) {
    ...
    switch (type) {
        ...
        case 'ELLIPSE':
            return new AcDbEllipse(new AcGePoint3d(), AcGeVector3d.Z_AXIS, AcGeVector3d.X_AXIS, 1, 1, 0, Math.PI * 2);
        case 'SOLID':
        ...
        case 'SPLINE': {
            var spline = AcDbSpline.fromControlPoints([
                { x: 0, y: 0, z: 0 },
                { x: 1, y: 0, z: 0 },
                { x: 2, y: 0, z: 0 },
                { x: 3, y: 0, z: 0 }
            ], [0, 0, 0, 0, 1, 1, 1, 1], undefined, 3, false);
            return spline;
        }
        case 'ATTDEF':
 ...
 */
export function acdbDxfInEntity(filer, typeName) {
    var name = typeName;
    if (name == null) {
    ...
    var entity = acdbCreateEntityForDxfIn(name);
    if (!entity)
        return null;
    entity.dxfIn(filer);
    return entity;
}
//# sourceMappingURL=AcDbDxfEntityFactory.js.map