 ...
 */
export function acdbDecryptAcisData(encrypted) {
    var decrypted = '';
 ...
 */
export function acdbIsEncryptedAcisData(data) {
    ...
    if (/^(body|point|plane|cone|cylinder|sphere|torus|lump|shell|face|edge|wire|transform)\b/i.test(trimmed)) {
        return false;
    }
 ...
 */
export function acdbNormalizeAcisData(data) {
 ...
 */
export function acdbJoinAcisPayloadLines(lines) {
    if (lines.length === 0) {
        return '';
    }
    return lines.map(function (line) { return acdbNormalizeAcisData(line); }).join('\n');
}
/**
 ...
 */
export function acdbAppendAcisPayloadFragment(lines, code, value) {
    if (code === 1) {
        lines.push(value);
        return;
    }
 ...
 */
export function acdbJoinAcisObjectChunks(chunks) {
    if (chunks.length === 0) {
        return '';
    }
    return acdbNormalizeAcisData(chunks.join(''));
}
//# sourceMappingURL=AcDbAcisDecrypt.js.map