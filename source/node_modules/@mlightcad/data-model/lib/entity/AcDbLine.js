...
import { AcGeLine3d, AcGeMatrix3d, AcGePoint3d, acgeTransformOcsPointToWcs, acgeTransformWcsPointToOcs, AcGeVector3d } from '@mlightcad/geometry-engine';
...
var AcDbLine = /** @class */ (function (_super) {
    ...
    Object.defineProperty(AcDbLine.prototype, "dxfTypeName", {
        get: function () {
            return 'LINE';
        },
        enumerable: false,
    ...
    Object.defineProperty(AcDbLine.prototype, "thickness", {
        /**
    ...
    Object.defineProperty(AcDbLine.prototype, "normal", {
        /**
    ...
    /** @inheritdoc */
    AcDbLine.prototype.subGetIntersectCurves = function () {
        return [
            {
                kind: 'line',
    ...
    Object.defineProperty(AcDbLine.prototype, "area", {
        /** @inheritdoc */
        get: function () {
            return 0;
        },
     ...
     */
    AcDbLine.prototype.subMoveGripPointsAt = function (indices, offset) {
        var _this = this;
        acdbForEachGripIndex(indices, function (index) {
            switch (index) {
                case 0:
                    _this.transformBy(AcGeMatrix3d.makeTranslation(offset));
                    break;
                case 1:
                    _this.startPoint.add(offset);
                    break;
                case 2:
                    _this.endPoint.add(offset);
                    break;
                default:
                    break;
            }
    ...
    Object.defineProperty(AcDbLine.prototype, "directBatchPrimitive", {
        /**
     ...
     */
    AcDbLine.prototype.dxfOutFields = function (filer) {
        _super.prototype.dxfOutFields.call(this, filer);
        filer.writeSubclassMarker('AcDbLine');
        if (this.thickness !== 0) {
            filer.writeDouble(39, this.thickness);
        }
        var startOcs = acgeTransformWcsPointToOcs(this.startPoint, this.normal);
        var endOcs = acgeTransformWcsPointToOcs(this.endPoint, this.normal);
        filer.writePoint3d(10, startOcs);
        filer.writePoint3d(11, endOcs);
        filer.writeVector3d(210, this.normal);
        return this;
    };
    AcDbLine.prototype.dxfInFields = function (filer) {
        ...
        var z1 = this.startPoint.z;
        var x2 = this.endPoint.x;
        var y2 = this.endPoint.y;
        var z2 = this.endPoint.z;
    ...
    AcDbLine.prototype.getOffsetCurves = function (offsetDist) {
        var geo = this._geo.offset(offsetDist);
        return [new AcDbLine(geo.startPoint, geo.endPoint)];
    };
    AcDbLine.prototype.getOffsetSideAtPoint = function (point) {
