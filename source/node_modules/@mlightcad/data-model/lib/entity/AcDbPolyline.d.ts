import { AcGeBox3d, AcGeIntersectPrimitive, AcGeMatrix3d, AcGePoint2d, AcGePoint3d, AcGePoint3dLike, AcGePolyline2d, AcGeVector3d, AcGeVector3dLike } from '@mlightcad/geometry-engine';
...
export declare class AcDbPolyline extends AcDbCurve {
     ...
     */
    private appendSegmentMidpointGrips;
    /**
     ...
     * @internal
     */
    get directBatchPrimitive(): "lineStrip" | "area";
    /**
     ...
     */
    dxfOutAs2dPolyline(filer: AcDbDxfFiler, _allXdata?: boolean): this;
 ...
 * or offsetting fails
 */
export declare function acdbOffsetVertexPathAsPolyline(points: AcGePoint2d[], closed: boolean, offsetDist: number): AcDbPolyline | null;
