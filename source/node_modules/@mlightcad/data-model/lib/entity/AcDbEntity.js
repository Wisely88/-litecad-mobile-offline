...
import { acgeIntersectCurves } from '@mlightcad/geometry-engine';
...
var AcDbEntity = /** @class */ (function (_super) {
    ...
    Object.defineProperty(AcDbEntity.prototype, "layer", {
        ...
        get: function () {
            var _a;
            if (this._layer == null) {
                this._layer = (_a = this.database.clayer) !== null && _a !== void 0 ? _a : '0';
            }
            return this._layer;
        },
        /**
    ...
    Object.defineProperty(AcDbEntity.prototype, "resolvedColor", {
        /**
     ...
     */
    AcDbEntity.prototype.resolveStandardColor = function () {
    ...
    Object.defineProperty(AcDbEntity.prototype, "lineType", {
        ...
        get: function () {
            ...
            if (this._lineType == null) {
                this._lineType = (_b = (_a = this.database) === null || _a === void 0 ? void 0 : _a.celtype) !== null && _b !== void 0 ? _b : ByLayer;
            }
    ...
    Object.defineProperty(AcDbEntity.prototype, "lineWeight", {
        ...
        get: function () {
            ...
            if (this._lineWeight == null) {
                this._lineWeight = (_a = this.database.celweight) !== null && _a !== void 0 ? _a : AcGiLineWeight.ByLayer;
            }
    ...
    Object.defineProperty(AcDbEntity.prototype, "linetypeScale", {
        ...
        get: function () {
            ...
            if (this._linetypeScale == null) {
                this._linetypeScale = (_a = this.database.celtscale) !== null && _a !== void 0 ? _a : -1;
            }
     ...
     */
    AcDbEntity.prototype.setEntityColor = function (value) {
        if (this._color == null)
            this._color = new AcCmColor();
     ...
     */
    AcDbEntity.prototype.shouldResolveColorFromCecolor = function () {
        return true;
    };
    /**
     * Returns whether transparency has been explicitly assigned on this entity.
     */
    AcDbEntity.prototype.hasExplicitTransparency = function () {
     ...
     */
    AcDbEntity.prototype.dxfOutFields = function (filer) {
        ...
        var owner = this.database.tables.blockTable.getIdAt(this.ownerId);
        if (owner === null || owner === void 0 ? void 0 : owner.isPaperSapce) {
     ...
     */
    AcDbEntity.prototype.dxfInFields = function (filer) {
    ...
    Object.defineProperty(AcDbEntity.prototype, "dxfPaperSpace", {
        /**
     ...
     */
    AcDbEntity.prototype.resolveEffectiveProperties = function () {
        var _a, _b, _c, _d;
        if (this._layer == null) {
            this._layer = (_a = this.database.clayer) !== null && _a !== void 0 ? _a : '0';
        }
        ...
        if (this._lineType == null) {
            this._lineType = (_b = this.database.celtype) !== null && _b !== void 0 ? _b : ByLayer;
        }
        if (this._linetypeScale == null) {
            this._linetypeScale = (_c = this.database.celtscale) !== null && _c !== void 0 ? _c : -1;
        }
        if (this._lineWeight == null) {
            this._lineWeight = (_d = this.database.celweight) !== null && _d !== void 0 ? _d : AcGiLineWeight.ByLayer;
        }
    };
    Object.defineProperty(AcDbEntity.prototype, "properties", {
        /**
     ...
     * ```
     */
    AcDbEntity.prototype.subMoveGripPointsAt = function (
     ...
     */
    AcDbEntity.prototype.intersectWith = function (entity, intType, projPlane) {
        if (intType === void 0) { intType = AcDbIntersect.OnBothOperands; }
        var a = this.subGetIntersectCurves();
        var b = entity.subGetIntersectCurves();
        if (a.length === 0 || b.length === 0)
            return [];
        var extendA = intType === AcDbIntersect.ExtendThis ||
            intType === AcDbIntersect.ExtendBoth;
        var extendB = intType === AcDbIntersect.ExtendArg ||
            intType === AcDbIntersect.ExtendBoth;
     ...
     */
    AcDbEntity.prototype.subGetIntersectCurves = function () {
        return [];
    };
    /**
    ...
    Object.defineProperty(AcDbEntity.prototype, "directBatchPrimitive", {
        /**
    ...
    AcDbEntity.prototype.worldDraw = function (renderer, delay) {
        ...
        var drawable = this.subWorldDraw(renderer, delay);
     ...
     */
    AcDbEntity.prototype.getGeneralProperties = function () {
        var _this = this;
        return {
            groupName: 'general',
            properties: [
                ...
                },
                {
                    ...
                    editable: true,
                    accessor: {
                        get: function () { return _this.layer; },
                        set: function (newVal) {
                            _this.layer = newVal;
                        }
                    }
    ...
    Object.defineProperty(AcDbEntity.prototype, "lineStyle", {
        ...
        get: function () {
            var _a;
            var _b = this.getLineType(), type = _b.type, name = _b.name;
            var lineTypeRecord = (_a = this.database) === null || _a === void 0 ? void 0 : _a.tables.linetypeTable.getAt(name);
            if (lineTypeRecord) {
