import { AcGeIntersectPrimitive, AcGeKnotParameterizationType, AcGeMatrix3d, AcGePoint3dLike, AcGeVector3d, AcGeVector3dLike } from '@mlightcad/geometry-engine';
...
export declare class AcDbSpline extends AcDbCurve {
     ...
     * ```
     */
    static fromControlPoints(controlPoints: AcGePoint3dLike[], knots: number[], weights: number[] | undefined, declaredDegree: number | undefined, closed: boolean): AcDbSpline | null;
    /**
     ...
     * ```
     */
    static fromFitPoints(fitPoints: AcGePoint3dLike[], knotParam: AcGeKnotParameterizationType, declaredDegree: number | undefined, closed: boolean, startTangent?: AcGePoint3dLike | null, endTangent?: AcGePoint3dLike | null): AcDbSpline | null;
    /**
    ...
    private _knotTolerance;
    /** Control-point tolerance (DXF group 43) */
    private _controlTolerance;
    /** Fit tolerance (DXF group 44) */
    private _fitTolerance;
    ...
    /** Knot tolerance (DXF group 42). */
    get knotTolerance(): number;
    set knotTolerance(value: number);
    /** Control-point tolerance (DXF group 43). */
    get controlTolerance(): number;
    set controlTolerance(value: number);
    /** Fit tolerance (DXF group 44). */
    get fitTolerance(): number;
     ...
     */
    subGetGripPoints(): import("@mlightcad/geometry-engine").AcGePoint3d[];
    /** @inheritdoc */
