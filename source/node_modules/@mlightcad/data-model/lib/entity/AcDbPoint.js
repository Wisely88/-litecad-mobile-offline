...
import { AcGeBox3d, AcGePoint3d, acgeTransformOcsPointToWcs, acgeTransformWcsPointToOcs, AcGeVector3d } from '@mlightcad/geometry-engine';
...
var AcDbPoint = /** @class */ (function (_super) {
    ...
    function AcDbPoint() {
         ...
         */
        _this._ecsRotation = 0;
        _this._geo = new AcGePoint3d();
        return _this;
    }
    Object.defineProperty(AcDbPoint.prototype, "dxfTypeName", {
        get: function () {
            return 'POINT';
        },
        enumerable: false,
    ...
    Object.defineProperty(AcDbPoint.prototype, "thickness", {
        /**
    ...
    Object.defineProperty(AcDbPoint.prototype, "normal", {
        /**
    ...
    Object.defineProperty(AcDbPoint.prototype, "ecsRotation", {
        /**
         * Angle of the X axis for the UCS in effect when the point was drawn
     ...
     */
    AcDbPoint.prototype.subGetGripPoints = function () {
        return [this._geo];
    };
    /** @inheritdoc */
    AcDbPoint.prototype.subMoveGripPointsAt = function (indices, offset) {
    ...
    Object.defineProperty(AcDbPoint.prototype, "directBatchPrimitive", {
        /**
        ...
        get: function () {
            var _a, _b;
            var mode = (_b = (_a = this.database) === null || _a === void 0 ? void 0 : _a.pdmode) !== null && _b !== void 0 ? _b : 0;
            return mode === 0 ? 'point' : null;
        },
        enumerable: false,
        configurable: true
    });
     ...
     */
    AcDbPoint.prototype.subWorldDraw = function (renderer) {
     ...
     */
    AcDbPoint.prototype.dxfOutFields = function (filer) {
    ...
    AcDbPoint.prototype.dxfInFields = function (filer) {
        ...
        var angleDeg = (this.ecsRotation * 180) / Math.PI;
        ...
        this.position = acgeTransformOcsPointToWcs({ x: x, y: y, z: z }, this.normal);
        return this;
    };
