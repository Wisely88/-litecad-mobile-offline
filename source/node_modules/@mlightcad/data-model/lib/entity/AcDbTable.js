...
var AcDbTable = /** @class */ (function (_super) {
    ...
    function AcDbTable(name, numRows, numColumns) {
        var _this = _super.call(this, name !== null && name !== void 0 ? name : '') || this;
    ...
    Object.defineProperty(AcDbTable.prototype, "blockTableRecord", {
        /**
        ...
        get: function () {
            ...
            if (blockName) {
                var byName = this.database.tables.blockTable.getAt(blockName);
                if (byName) {
                    return byName;
                }
            }
            var owningId = this.owningBlockRecordId;
            if (!owningId) {
                return undefined;
            }
     ...
     */
    AcDbTable.prototype.resizeGrid = function (numRows, numColumns) {
        var rows = Math.max(0, numRows);
        var cols = Math.max(0, numColumns);
        this._numRows = rows;
        this._numColumns = cols;
        this._rowHeight = new Array(rows).fill(0);
        this._columnWidth = new Array(cols).fill(0);
    ...
    Object.defineProperty(AcDbTable.prototype, "geometricExtents", {
        ...
        get: function () {
            ...
            if (blockTableRecord && blockTableRecord.newIterator().count > 0) {
                var box_1 = new AcGeBox3d();
                try {
                    for (var _d = __values(blockTableRecord.newIterator()), _e = _d.next(); !_e.done; _e = _d.next()) {
                        var entity = _e.value;
                        box_1.union(entity.geometricExtents);
                    }
                }
                ...
                box_1.applyMatrix4(this.blockTransform);
                return box_1;
            }
            var totalWidth = this._columnWidth.reduce(function (sum, value) { return sum + value; }, 0);
            var totalHeight = this._rowHeight.reduce(function (sum, value) { return sum + value; }, 0);
            ...
            try {
                for (var localCorners_1 = __values(localCorners), localCorners_1_1 = localCorners_1.next(); !localCorners_1_1.done; localCorners_1_1 = localCorners_1.next()) {
                    var corner = localCorners_1_1.value;
                ...
                try {
                    if (localCorners_1_1 && !localCorners_1_1.done && (_b = localCorners_1.return)) _b.call(localCorners_1);
                }
        ...
        try {
            for (var entities_1 = __values(entities), entities_1_1 = entities_1.next(); !entities_1_1.done; entities_1_1 = entities_1.next()) {
                ...
                if (entity.color.isByBlock) {
                    ...
                    var tableColor = this.resolvedColor;
    ...
    AcDbTable.prototype.dxfOutFields = function (filer) {
        ...
        var is2007OrLater = acdbDxfVersionCaps(version).supportsUtf8CodePage;
        ...
        for (var i = 0; i < totalCells; i++) {
            ...
            if (cellType === 1) {
                ...
                if ((_q = cell === null || cell === void 0 ? void 0 : cell.attrDefineId) === null || _q === void 0 ? void 0 : _q.length) {
                    try {
                        for (var _v = (e_4 = void 0, __values(cell.attrDefineId)), _w = _v.next(); !_w.done; _w = _v.next()) {
                            var attrId = _w.value;
                ...
                if ((cell === null || cell === void 0 ? void 0 : cell.attrText) != null) {
                    if (Array.isArray(cell.attrText)) {
                        try {
                            for (var _x = (e_5 = void 0, __values(cell.attrText)), _y = _x.next(); !_y.done; _y = _x.next()) {
                                var text = _y.value;
    ...
    AcDbTable.prototype.dxfInFields = function (filer) {
        var _this = this;
        var _a, _b, _c, _d, _e, _f;
        _super.prototype.dxfInFields.call(this, filer);
        filer.atSubclassData('AcDbTable');
        var rows = this._numRows;
        var cols = this._numColumns;
        var resized = false;
        var rowHeights = [];
        var columnWidths = [];
        var cellIndex = 0;
        ...
        var textChunks = [];
        var hx = (_b = (_a = this.horizontalDirection) === null || _a === void 0 ? void 0 : _a.x) !== null && _b !== void 0 ? _b : 1;
        var hy = (_d = (_c = this.horizontalDirection) === null || _c === void 0 ? void 0 : _c.y) !== null && _d !== void 0 ? _d : 0;
        var hz = (_f = (_e = this.horizontalDirection) === null || _e === void 0 ? void 0 : _e.z) !== null && _f !== void 0 ? _f : 0;
        var ensureGrid = function () {
            if (rows > 0 && cols > 0) {
                if (!resized ||
                    _this._numRows !== rows ||
                    _this._numColumns !== cols) {
                    _this.resizeGrid(rows, cols);
                    resized = true;
                }
            }
        };
        var flushCell = function () {
            if (!currentCell)
                return;
            ...
            ensureGrid();
            if (cellIndex < _this._cells.length) {
                _this.setCell(cellIndex, currentCell);
            }
            cellIndex += 1;
            currentCell = null;
        };
        while (!filer.atEndOfObject && !filer.atEof && !filer.atExtendedData) {
            ...
            switch (code) {
                ...
                case 172:
                    if (currentCell)
                        currentCell.flagValue = n;
                    break;
                case 173:
                    if (currentCell)
                        currentCell.mergedValue = n;
                    break;
                case 174:
                    if (currentCell)
                        currentCell.autoFit = Boolean(item.value) || n !== 0;
                    break;
                case 175:
                    if (currentCell)
                        currentCell.borderWidth = n;
                    break;
                case 176:
                    if (currentCell)
                        currentCell.borderHeight = n;
                    break;
                case 177:
                    if (currentCell)
                        currentCell.overrideFlag = n;
                ...
                case 178:
                    if (currentCell)
                        currentCell.virtualEdgeFlag = n;
                    break;
                case 145:
                    if (currentCell)
                        currentCell.rotation = (n * Math.PI) / 180;
                    break;
                case 1:
                case 2:
                case 302:
                ...
                case 300:
                    ...
                    if (currentCell) {
                        var existing = currentCell.attrText;
                ...
                case 7:
                    if (currentCell)
                        currentCell.textStyle = String(item.value);
                    break;
                case 140:
                    if (currentCell)
                        currentCell.textHeight = n;
                    break;
                case 340:
                    if (currentCell)
                        currentCell.blockTableRecordId = String(item.value);
                    break;
                case 344:
                case 345:
                    if (currentCell)
                        currentCell.fieldObjetId = String(item.value);
                    break;
                case 144:
                case 146:
                    if (currentCell)
                        currentCell.blockScale = n;
                    break;
                case 179:
                    if (currentCell)
                        currentCell.blockAttrNum = n;
                    break;
                case 70:
        ...
        rowHeights.forEach(function (h, i) { return _this.setRowHeight(i, h); });
        columnWidths.forEach(function (w, i) { return _this.setColumnWidth(i, w); });
        return this;
    };
