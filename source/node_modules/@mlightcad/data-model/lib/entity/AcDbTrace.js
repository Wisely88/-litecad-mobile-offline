...
import { AcGeArea2d, AcGeBox3d, AcGePoint2d, AcGePoint3d, AcGePolyline2d, acgeTransformOcsPointToWcs, acgeTransformWcsPointToOcs, AcGeVector3d } from '@mlightcad/geometry-engine';
...
var AcDbTrace = /** @class */ (function (_super) {
    ...
    Object.defineProperty(AcDbTrace.prototype, "area", {
        /** @inheritdoc */
        get: function () {
    ...
    Object.defineProperty(AcDbTrace.prototype, "normal", {
        /**
    ...
    /** @inheritdoc */
    AcDbTrace.prototype.subGetIntersectCurves = function () {
        var v0 = this._vertices[0];
        var v1 = this._vertices[1];
        var v2 = this._vertices[2];
        var v3 = this._vertices[3];
    ...
    /** @inheritdoc */
    AcDbTrace.prototype.subMoveGripPointsAt = function (indices, offset) {
    ...
    Object.defineProperty(AcDbTrace.prototype, "directBatchPrimitive", {
        /**
    ...
    AcDbTrace.prototype.dxfInFields = function (filer) {
        var _this = this;
        ...
        pts.forEach(function (p, i) {
            return _this.setPointAt(i, acgeTransformOcsPointToWcs(p, _this.normal));
        });
        return this;
    };
    /**
    ...
    AcDbTrace.prototype.createOffsetCurve = function (offsetDist) {
        return acdbOffsetVertexPathAsPolyline(this.collectBoundary2d(), true, offsetDist);
    };
    /**
