...
var AcDbXline = /** @class */ (function (_super) {
    ...
    Object.defineProperty(AcDbXline.prototype, "dxfTypeName", {
        get: function () {
            return 'XLINE';
        },
        enumerable: false,
    ...
    Object.defineProperty(AcDbXline.prototype, "area", {
        /** @inheritdoc */
        get: function () {
            return 0;
        },
    ...
    /** @inheritdoc */
    AcDbXline.prototype.subGetIntersectCurves = function () {
    ...
    /** @inheritdoc */
    AcDbXline.prototype.subMoveGripPointsAt = function (indices, offset) {
     ...
     */
    AcDbXline.prototype.subGetOsnapPoints = function (osnapMode, pickPoint, _lastPoint, snapPoints) {
     ...
     */
    AcDbXline.prototype.transformBy = function (matrix) {
        this._basePoint.applyMatrix4(matrix);
        this._unitDir.transformDirection(matrix);
        return this;
    };
    Object.defineProperty(AcDbXline.prototype, "directBatchPrimitive", {
        /**
     ...
     */
    AcDbXline.prototype.subWorldDraw = function (renderer) {
        var points = [];
     ...
     */
    AcDbXline.prototype.dxfOutFields = function (filer) {
    ...
    AcDbXline.prototype.dxfInFields = function (filer) {
        _super.prototype.dxfInFields.call(this, filer);
        filer.atSubclassData('AcDbXline');
     ...
     */
    AcDbXline.prototype.getOffsetCurves = function (offsetDist) {
     ...
     */
    AcDbXline.prototype.getOffsetSideAtPoint = function (point) {
