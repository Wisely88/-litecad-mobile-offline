...
import { AcGeBox3d, AcGeIntersectPrimitive, AcGeMatrix3d, AcGePlane, AcGePoint3d, AcGeVector3dLike } from '@mlightcad/geometry-engine';
import { AcGiDirectBatchPrimitive, AcGiEntity, AcGiLineStyle, AcGiLineWeight, AcGiRenderer } from '@mlightcad/graphic-interface';
import { AcDbDxfFiler } from '../base/AcDbDxfFiler';
import { AcDbObject } from '../base/AcDbObject';
import { AcDbIntersect } from '../misc/AcDbIntersect';
import { AcDbOsnapMode } from '../misc/AcDbOsnapMode';
import { AcDbEntityProperties, AcDbEntityPropertyGroup } from './AcDbEntityProperties';
/**
...
export declare abstract class AcDbEntity extends AcDbObject {
     ...
     * ```
     */
    get transparency(): AcCmTransparency;
    /**
     ...
     */
    protected hasExplicitTransparency(): boolean;
    /**
     ...
     * ```
     */
    subGetOsnapPoints(osnapMode: AcDbOsnapMode, pickPoint: AcGePoint3dLike, lastPoint: AcGePoint3dLike, snapPoints: AcGePoint3dLike[], gsMark?: AcDbObjectId, insertionMat?: AcGeMatrix3d): void;
    /**
     ...
     */
    intersectWith(entity: AcDbEntity, intType?: AcDbIntersect, projPlane?: AcGePlane): AcGePoint3d[];
    /**
