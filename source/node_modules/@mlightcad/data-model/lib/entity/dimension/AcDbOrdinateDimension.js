...
var AcDbOrdinateDimension = /** @class */ (function (_super) {
    ...
    Object.defineProperty(AcDbOrdinateDimension.prototype, "properties", {
        get: function () {
            var _this = this;
            ...
            return {
                ...
                groups: __spreadArray(__spreadArray([], __read(baseProperties.groups), false), [
                    {
                        groupName: 'geometry',
                        properties: __spreadArray(__spreadArray([], __read(this.createPoint3dProperties('definingPoint', function () { return _this.definingPoint; })), false), __read(this.createPoint3dProperties('leaderEndPoint', function () { return _this.leaderEndPoint; })), false)
                    }
                ], false)
            };
        },
     ...
     * @inheritdoc
     */
    AcDbOrdinateDimension.prototype.collectDimensionDefinitionGripPoints = function () {
        return [this.definingPoint, this.leaderEndPoint];
    };
    /**
     * @inheritdoc
     */
    AcDbOrdinateDimension.prototype.subTransformBy = function (matrix) {
     ...
     */
    AcDbOrdinateDimension.prototype.dxfOutFields = function (filer) {
    ...
    AcDbOrdinateDimension.prototype.dxfInFields = function (filer) {
        var _this = this;
        _super.prototype.dxfInFields.call(this, filer);
        filer.atSubclassData('AcDbOrdinateDimension');
        var dx = this.definingPoint.x;
        var dy = this.definingPoint.y;
        var dz = this.definingPoint.z;
        var lx = this.leaderEndPoint.x;
        var ly = this.leaderEndPoint.y;
        var lz = this.leaderEndPoint.z;
        var commit = function () {
            _this.definingPoint = new AcGePoint3d(dx, dy, dz);
            _this.leaderEndPoint = new AcGePoint3d(lx, ly, lz);
        };
