...
import { AcGeLine3d, AcGePoint3d, AcGeVector3d } from '@mlightcad/geometry-engine';
...
var AcDbAlignedDimension = /** @class */ (function (_super) {
    ...
    Object.defineProperty(AcDbAlignedDimension.prototype, "properties", {
        get: function () {
            var _this = this;
            ...
            return {
                ...
                groups: __spreadArray(__spreadArray([], __read(baseProperties.groups), false), [
                    {
                        groupName: 'geometry',
                        properties: __spreadArray(__spreadArray(__spreadArray(__spreadArray([], __read(this.createPoint3dProperties('xLine1Point', function () { return _this.xLine1Point; })), false), __read(this.createPoint3dProperties('xLine2Point', function () { return _this.xLine2Point; })), false), __read(this.createPoint3dProperties('dimLinePoint', function () { return _this.dimLinePoint; })), false), [
                            this.createProperty('rotation', 'float', function () { return _this.rotation; }, function (value) {
                                _this.rotation = value;
                            }),
                            this.createProperty('oblique', 'float', function () { return _this.oblique; }, function (value) {
                                _this.oblique = value;
                            })
                        ], false)
                    }
     ...
     * @inheritdoc
     */
    AcDbAlignedDimension.prototype.collectDimensionDefinitionGripPoints = function () {
        return [this.xLine1Point, this.xLine2Point, this.dimLinePoint];
    };
    /** @inheritdoc */
    AcDbAlignedDimension.prototype.subMoveGripPointsAt = function (indices, offset) {
        _super.prototype.subMoveGripPointsAt.call(this, indices, offset);
     ...
     * @inheritdoc
     */
    AcDbAlignedDimension.prototype.subTransformBy = function (matrix) {
    ...
    Object.defineProperty(AcDbAlignedDimension.prototype, "dxfSubclassMarker", {
        /**
    ...
    AcDbAlignedDimension.prototype.getMeasurementPropertyValue = function () {
        var _a;
        return (_a = this.measurement) !== null && _a !== void 0 ? _a : this.xLine1Point.distanceTo(this.xLine2Point);
    };
    /**
     ...
     */
    AcDbAlignedDimension.prototype.dxfOutFields = function (filer) {
    ...
    AcDbAlignedDimension.prototype.dxfInFields = function (filer) {
        _super.prototype.dxfInFields.call(this, filer);
        filer.atSubclassData(this.dxfSubclassMarker);
        var x1 = this.xLine1Point.x;
        var y1 = this.xLine1Point.y;
        var z1 = this.xLine1Point.z;
        var x2 = this.xLine2Point.x;
        var y2 = this.xLine2Point.y;
        var z2 = this.xLine2Point.z;
        var dx = this.dimLinePoint.x;
        var dy = this.dimLinePoint.y;
        var dz = this.dimLinePoint.z;
        var rotDeg = (this.rotation * 180) / Math.PI;
        var oblDeg = (this.oblique * 180) / Math.PI;
        var ix = this.dimBlockPosition.x;
        var iy = this.dimBlockPosition.y;
        var iz = this.dimBlockPosition.z;
        var hasInsertion = false;
        var hasDimLine = false;
        while (!filer.atEndOfObject && !filer.atEof && !filer.atExtendedData) {
            ...
            switch (code) {
                ...
                case 100:
                    ...
                    this.finishAlignedDxfIn(x1, y1, z1, x2, y2, z2, dx, dy, dz, rotDeg, oblDeg, ix, iy, iz, hasInsertion, hasDimLine);
                    return this;
                default:
                    break;
            }
    ...
    AcDbAlignedDimension.prototype.finishAlignedDxfIn = function (x1, y1, z1, x2, y2, z2, dx, dy, dz, rotDeg, oblDeg, ix, iy, iz, hasInsertion, hasDimLine) {
