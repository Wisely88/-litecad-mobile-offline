...
var AcDbRadialDimension = /** @class */ (function (_super) {
     ...
     * @inheritdoc
     */
    AcDbRadialDimension.prototype.collectDimensionDefinitionGripPoints = function () {
        return [this.center, this.chordPoint];
    };
    /**
     * @inheritdoc
     */
    AcDbRadialDimension.prototype.subTransformBy = function (matrix) {
    ...
    Object.defineProperty(AcDbRadialDimension.prototype, "geometricExtents", {
         ...
         */
        get: function () {
            var points = [this.center, this.chordPoint];
            if (this.leaderLength > 0) {
                var direction = this.chordPoint.clone().sub(this.center);
     ...
     */
    AcDbRadialDimension.prototype.dxfOutFields = function (filer) {
    ...
    AcDbRadialDimension.prototype.dxfInFields = function (filer) {
        var _this = this;
        ...
        var hx = this.chordPoint.x;
        var hy = this.chordPoint.y;
        var hz = this.chordPoint.z;
        var hasChord = false;
        var startDeg = (this.extArcStartAngle * 180) / Math.PI;
        var endDeg = (this.extArcEndAngle * 180) / Math.PI;
        var commit = function () {
            _this.center = new AcGePoint3d(cx, cy, cz);
            _this.chordPoint = new AcGePoint3d(hx, hy, hz);
