...
import { AcGeBox3d, acgeClosedPolygonArea3d, AcGePoint3d } from '@mlightcad/geometry-engine';
...
var AcDbFace = /** @class */ (function (_super) {
    ...
    Object.defineProperty(AcDbFace.prototype, "dxfTypeName", {
        get: function () {
            return '3DFACE';
        },
        enumerable: false,
    ...
    /** @inheritdoc */
    AcDbFace.prototype.subGetIntersectCurves = function () {
        return acdbIntersectPrimitivesFromPointPath(this._vertices, true);
    };
    Object.defineProperty(AcDbFace.prototype, "area", {
        /**
        ...
        get: function () {
            ...
            var fourth = this.getVertexAt(3);
            if (fourth.x !== points[2].x ||
                fourth.y !== points[2].y ||
                fourth.z !== points[2].z) {
                points.push(fourth);
            }
    ...
    /** @inheritdoc */
    AcDbFace.prototype.subMoveGripPointsAt = function (indices, offset) {
     ...
     */
    AcDbFace.prototype.subGetOsnapPoints = function (osnapMode, pickPoint, _lastPoint, snapPoints) {
        acdbCollectVertexPathOsnapPoints(this._vertices, true, osnapMode, pickPoint, snapPoints);
    };
    /**
     * Transforms this face by the specified matrix.
     */
    AcDbFace.prototype.transformBy = function (matrix) {
        this._vertices.forEach(function (vertex) { return vertex.applyMatrix4(matrix); });
        return this;
    };
    Object.defineProperty(AcDbFace.prototype, "directBatchPrimitive", {
        /**
     ...
     */
    AcDbFace.prototype.dxfOutFields = function (filer) {
        _super.prototype.dxfOutFields.call(this, filer);
        var p0 = this.getVertexAt(0);
        var p1 = this.getVertexAt(1);
        var p2 = this.getVertexAt(2);
        var p3 = this.getVertexAt(3);
    ...
    AcDbFace.prototype.dxfInFields = function (filer) {
        var _this = this;
        ...
        var edgeMask = this._edgeInvisibilities;
        ...
        pts.forEach(function (p, i) { return _this.setVertexAt(i, p); });
