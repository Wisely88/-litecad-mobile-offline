...
import { AcGeBox3d, AcGeMathUtil, AcGeMatrix3d, AcGePoint3d, AcGeVector3d } from '@mlightcad/geometry-engine';
...
var AcDbShape = /** @class */ (function (_super) {
    ...
    /** @inheritdoc */
    AcDbShape.prototype.subMoveGripPointsAt = function (indices, offset) {
    ...
    AcDbShape.prototype.subWorldDraw = function (renderer, delay) {
        ...
        var style = textStyle
            ? __assign(__assign({}, textStyle), { widthFactor: this.widthFactor, 
                // MText renderer stores oblique in degrees on the text style.
                obliqueAngle: (this.oblique * 180) / Math.PI }) : undefined;
        var shapeData = __assign(__assign({}, this.renderGlyphIdentity()), { size: this.size, position: this._position, rotation: this._rotation, directionVector: this._normal, widthFactor: this.widthFactor });
     ...
     */
    AcDbShape.prototype.renderGlyphIdentity = function () {
        var trimmedName = this._name.trim();
        var asNumber = Number(trimmedName);
        if (trimmedName !== '' &&
    ...
    AcDbShape.prototype.getTextStyle = function () {
        var trimmed = this.styleName.trim();
        if (!trimmed) {
            return undefined;
        }
        var style = this.database.tables.textStyleTable.resolveAt(trimmed);
        return style === null || style === void 0 ? void 0 : style.textStyle;
    };
    Object.defineProperty(AcDbShape.prototype, "dxfShapeIdentity", {
        /**
    ...
    AcDbShape.prototype.dxfOutFields = function (filer) {
        ...
        var shapeId = this.dxfShapeIdentity;
        if (shapeId) {
    ...
    AcDbShape.prototype.dxfInFields = function (filer) {
        ...
        while (!filer.atEndOfObject && !filer.atEof && !filer.atExtendedData) {
            ...
            switch (code) {
                ...
                case 30:
                    ...
                    break;
                case 2: {
                    var shapeName = String(item.value).trim();
                    var asNumber = Number(shapeName);
                    if (shapeName !== '' &&
                        Number.isInteger(asNumber) &&
                        asNumber !== 0 &&
