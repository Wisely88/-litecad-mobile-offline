...
function isBlockReferenceOwner(owner) {
...
var AcDbAttribute = /** @class */ (function (_super) {
    ...
    Object.defineProperty(AcDbAttribute.prototype, "dxfTypeName", {
        get: function () {
            return 'ATTRIB';
        },
        enumerable: false,
    ...
    Object.defineProperty(AcDbAttribute.prototype, "resolvedColor", {
        /**
        ...
        get: function () {
            ...
            if (this.color.isByBlock) {
                var owner = (_a = this.database) === null || _a === void 0 ? void 0 : _a.tables.blockTable.getEntityById(this.ownerId);
     ...
     */
    AcDbAttribute.prototype.dxfOutFields = function (filer) {
    ...
    AcDbAttribute.prototype.dxfInFields = function (filer) {
        _super.prototype.dxfInFields.call(this, filer);
        filer.atSubclassData('AcDbAttribute');
        while (!filer.atEndOfObject && !filer.atEof && !filer.atExtendedData) {
            ...
            switch (code) {
                ...
                case 73:
                    ...
                    break;
                case 74:
                    // DXF: vertical text justification for ATTRIB.
                    this.verticalMode = n;
                    break;
                case 280:
