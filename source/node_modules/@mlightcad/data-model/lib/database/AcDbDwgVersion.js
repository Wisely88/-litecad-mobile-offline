...
var AcDbDwgVersion = /** @class */ (function () {
    /**
     ...
     */
    function AcDbDwgVersion(nameOrValue) {
        if (typeof nameOrValue === 'string') {
            var entry = dwgVersions.find(function (v) { return v.name === nameOrValue; });
            if (!entry) {
                throw new Error("Unknown DWG version name: ".concat(nameOrValue));
            }
        ...
        if (typeof nameOrValue === 'number') {
            var entry = dwgVersions.find(function (v) { return v.value === nameOrValue; });
            if (!entry) {
                throw new Error("Unknown DWG version value: ".concat(nameOrValue));
            }
            this.name = entry.name;
            this.value = entry.value;
            return;
    ...
    Object.defineProperty(AcDbDwgVersion.prototype, "capabilities", {
    ...
    Object.defineProperty(AcDbDwgVersion, "latest", {
    ...
    AcDbDwgVersion.capabilitiesFor = function (value) {
        var r13OrLater = value >= 19;
        return {
    ...
    return AcDbDwgVersion;
}());
export { AcDbDwgVersion };
//# sourceMappingURL=AcDbDwgVersion.js.map