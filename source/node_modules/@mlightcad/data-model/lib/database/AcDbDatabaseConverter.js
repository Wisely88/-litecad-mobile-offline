...
var DEFAULT_WORKER_TIMEOUT_MS = 30000;
var MAX_WORKER_TIMEOUT_MS = 120000;
var BYTES_PER_MEBIBYTE = 1024 * 1024;
/**
...
var AcDbDatabaseConverter = /** @class */ (function () {
    ...
    function AcDbDatabaseConverter(config) {
        ...
        var _a;
        this.config = __assign({ useWorker: (_a = config.useWorker) !== null && _a !== void 0 ? _a : true }, config);
    }
    /**
     ...
     *
     */
    AcDbDatabaseConverter.prototype.read = function (data_1, db_1) {
        return __awaiter(this, arguments, void 0, function (data, db, options) {
            var _a, minimumChunkSize, progress, timeout, sysVars, loadDbTimeEntry, percentage, scheduler, t;
            var _this = this;
            if (options === void 0) { options = {}; }
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = options.minimumChunkSize, minimumChunkSize = _a === void 0 ? 10 : _a, progress = options.progress, timeout = options.timeout, sysVars = options.sysVars;
                        loadDbTimeEntry = {
                        ...
                        scheduler.addTask(new AcDbConversionTask({
                            ...
                            task: function (data) { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, this.parse(data, timeout)];
                        ...
                        scheduler.addTask(new AcDbConversionTask({
                            ...
                            progress: percentage,
                            task: function (data) { return __awaiter(_this, void 0, void 0, function () {
                                var sysVarManager, _a, _b, _c, name_1, value;
                                var e_1, _d;
                                return __generator(this, function (_e) {
                                    ...
                                    if (sysVars) {
                                        ...
                                        try {
                                            for (_a = __values(Object.entries(sysVars)), _b = _a.next(); !_b.done; _b = _a.next()) {
                                                _c = __read(_b.value, 2), name_1 = _c[0], value = _c[1];
                                                sysVarManager.setVar(name_1, value, db);
                                            }
                                        }
     ...
     */
    AcDbDatabaseConverter.prototype.getParserWorkerTimeout = function (data, timeout) {
        var resolvedTimeout = timeout !== null && timeout !== void 0 ? timeout : this.config.timeout;
        if (resolvedTimeout != null) {
            return resolvedTimeout;
        }
        var sizeInMiB = Math.ceil(data.byteLength / BYTES_PER_MEBIBYTE);
        var dynamicTimeout = DEFAULT_WORKER_TIMEOUT_MS + sizeInMiB * 1000;
        return Math.min(MAX_WORKER_TIMEOUT_MS, Math.max(DEFAULT_WORKER_TIMEOUT_MS, dynamicTimeout));
    };
    AcDbDatabaseConverter.prototype.parse = function (_data, _timeout) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
     ...
     */
    AcDbDatabaseConverter.prototype.processClasses = function (_model, _db) {
