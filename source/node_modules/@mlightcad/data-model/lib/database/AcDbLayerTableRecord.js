...
export var LAYER_TABLE_RECORD_DIFF_ATTR_KEYS = __spreadArray([
    'name'
], __read(Object.keys(acdbCreateLayerTableRecordDefaultAttrs())), false);
/**
...
var AcDbLayerTableRecord = /** @class */ (function (_super) {
    ...
    Object.defineProperty(AcDbLayerTableRecord.prototype, "lineStyle", {
        /**
        ...
        get: function () {
            var _a;
            var lineTypeRecord = (_a = this.database) === null || _a === void 0 ? void 0 : _a.tables.linetypeTable.getAt(this.linetype);
            if (lineTypeRecord) {
     ...
     */
    AcDbLayerTableRecord.prototype.dxfOutFields = function (filer) {
    ...
    AcDbLayerTableRecord.prototype.dxfInFields = function (filer) {
