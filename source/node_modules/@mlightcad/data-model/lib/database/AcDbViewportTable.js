...
var AcDbViewportTable = /** @class */ (function (_super) {
     ...
     */
    AcDbViewportTable.prototype.normalizeName = function (name) {
        var trimmed = (name !== null && name !== void 0 ? name : '').trim();
        if (!trimmed) {
            return '';
        }
        ...
        return _super.prototype.normalizeName.call(this, trimmed);
    };
    /**
     * Returns the model-space VPORT table record AutoCAD saves as `*Active`.
     */
    AcDbViewportTable.prototype.getActiveVport = function () {
     ...
     * and usable.
     */
    AcDbViewportTable.prototype.getActiveVportBox = function (canvasAspectRatio, drawingExtents) {
        var vport = this.getActiveVport();
        return vport === null || vport === void 0 ? void 0 : vport.resolveModelViewBox(canvasAspectRatio, drawingExtents);
    };
