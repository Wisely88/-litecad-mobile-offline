...
var AcDbSymbolTableRecord = /** @class */ (function (_super) {
     ...
     */
    AcDbSymbolTableRecord.prototype.setAttr = function (attrName, val) {
        this.assertOpenForWrite();
        _super.prototype.setAttr.call(this, attrName, val);
    };
    /**
     ...
     */
    AcDbSymbolTableRecord.prototype.assertOpenForWrite = function () {
        if (this.isTemp) {
            return;
        }
        ...
        if (manager.strictMode && !manager.isRecording()) {
            throw new Error('Cannot modify symbol table records outside an active transaction.');
        }
        if (!manager.isRecording()) {
            return;
        }
        if (!manager.isOpenedForWriteInTransaction(this.objectId)) {
            throw new Error("Symbol table record \"".concat(this.name || this.objectId, "\" is not open for write. Use openObjectForWrite()."));
        }
    };
    /**
     ...
     */
    AcDbSymbolTableRecord.prototype.dxfOutFields = function (filer) {
