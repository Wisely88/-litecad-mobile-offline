...
export declare class AcDbDatabaseConverterManager {
     ...
     * ```
     */
    register(fileType: AcDbConverterType, converter: AcDbDatabaseConverter): void;
    /**
     ...
     * ```
     */
    get(fileType: AcDbConverterType): AcDbDatabaseConverter<unknown> | undefined;
    /**
     ...
     * ```
     */
    unregister(fileType: AcDbConverterType): void;
}
