...
export type { AcDbCreateDefaultDataOptions, AcDbDictObjectEventArgs, AcDbEntityEventArgs, AcDbLayerEventArgs, AcDbLayerModifiedEventArgs, AcDbOpenDatabaseOptions, AcDbOpenFailedEventArgs, AcDbOpenFileStage, AcDbProgressdEventArgs, AcDbTables } from './AcDbDatabase';
...
export { AcDbBlockScaling, AcDbBlockTableRecord, AcDbBlockTableRecordFlag } from './AcDbBlockTableRecord';
export type { AcDbBlockTableRecordAttrs } from './AcDbBlockTableRecord';
export { AcDbDatabaseConverter } from './AcDbDatabaseConverter';
export type { AcDbConversionProgressCallback, AcDbConversionStage, AcDbConvertDatabasePerformanceData, AcDbDatabaseConverterConfig, AcDbDatabaseConverterReadOptions, AcDbParsingTaskResult, AcDbParsingTaskStats, AcDbStageStatus } from './AcDbDatabaseConverter';
export { AcDbDatabaseConverterManager, AcDbFileType } from './AcDbDatabaseConverterManager';
export type { AcDbConverterType, AcDbDatabaseConverterManagerEventArgs } from './AcDbDatabaseConverterManager';
export { AcDbDimStyleTable } from './AcDbDimStyleTable';
export { AcDbDimStyleTableRecord, AcDbDimTextHorizontal, AcDbDimTextVertical, AcDbDimVerticalJustification, AcDbDimZeroSuppression, AcDbDimZeroSuppressionAngular } from './AcDbDimStyleTableRecord';
export type { AcDbDimStyleTableRecordAttrs } from './AcDbDimStyleTableRecord';
export { AcDbDwgVersion } from './AcDbDwgVersion';
export type { AcDbDwgVersionEntry, AcDbDxfVersionCapabilities } from './AcDbDwgVersion';
...
export type { AcDbLinetypePreviewSvgOptions, AcDbLinetypeTableRecordAttrs } from './AcDbLinetypeTableRecord';
...
export { AC_DB_SYSTEM_VARIABLE_NAMES, AcDbSystemVariables } from './AcDbSystemVariables';
export type { AcDbColorTheme, AcDbSystemVariableName } from './AcDbSystemVariables';
export { AcDbSysVarManager } from './AcDbSysVarManager';
export type { AcDbSysVarDescriptor, AcDbSysVarEventArgs, AcDbSysVarType, AcDbSysVarTypeName } from './AcDbSysVarManager';
export { AcDbChangeApplier, AcDbChangeRecorder, AcDbDatabaseTransaction, AcDbDatabaseTransactionManager, AcDbTransaction, AcDbTransactionManager, AcDbUndoStack, acdbAreChangeContainersEqual, acdbCollectChangeEntities, acdbCollectDictionaryChanges } from './transaction';
export type { AcDbChangeContainer, AcDbDatabaseChange, AcDbDictionaryChangeEntry, AcDbUndoRecord } from './transaction';
