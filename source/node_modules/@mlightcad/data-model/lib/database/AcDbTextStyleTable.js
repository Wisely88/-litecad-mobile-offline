...
var AcDbTextStyleTable = /** @class */ (function (_super) {
     ...
     */
    AcDbTextStyleTable.normalizeFontFileName = function (fontFileName) {
        if (!fontFileName) {
            return undefined;
        }
        ...
        get: function () {
            ...
            try {
                for (var _b = __values(this.newIterator()), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var item = _c.value;
                    var fileName = AcDbTextStyleTable.normalizeFontFileName(item.fileName);
                    if (fileName) {
                        fonts.add(fileName);
                    }
                    var bigFontFileName = AcDbTextStyleTable.normalizeFontFileName(item.bigFontFileName);
                    if (bigFontFileName) {
