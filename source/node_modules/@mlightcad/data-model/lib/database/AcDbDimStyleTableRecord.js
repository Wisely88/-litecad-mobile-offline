...
var AcDbDimStyleTableRecord = /** @class */ (function (_super) {
     ...
     */
    AcDbDimStyleTableRecord.prototype.dxfOut = function () {
        var args = [];
     ...
     * @returns The instance (for chaining).
     */
    AcDbDimStyleTableRecord.prototype.dxfOutFields = function (filer) {
        _super.prototype.dxfOutFields.call(this, filer);
        var textStyle = this.database.tables.textStyleTable.getAt(this.dimtxsty);
        var dimldrblk = this.database.tables.blockTable.getAt(this.dimldrblk);
        var dimblk = this.database.tables.blockTable.getAt(this.dimblk);
        var dimblk1 = this.database.tables.blockTable.getAt(this.dimblk1);
        var dimblk2 = this.database.tables.blockTable.getAt(this.dimblk2);
        ...
        filer.writeObjectId(340, textStyle === null || textStyle === void 0 ? void 0 : textStyle.objectId);
        filer.writeObjectId(341, dimldrblk === null || dimldrblk === void 0 ? void 0 : dimldrblk.objectId);
        filer.writeObjectId(342, dimblk === null || dimblk === void 0 ? void 0 : dimblk.objectId);
        filer.writeObjectId(343, dimblk1 === null || dimblk1 === void 0 ? void 0 : dimblk1.objectId);
        filer.writeObjectId(344, dimblk2 === null || dimblk2 === void 0 ? void 0 : dimblk2.objectId);
        filer.writeInt16(371, this.dimlwd);
        filer.writeInt16(372, this.dimlwe);
        return this;
    };
    AcDbDimStyleTableRecord.prototype.dxfInFields = function (filer) {
        ...
        var flag01 = function (v) { return (v === 0 ? 0 : 1); };
