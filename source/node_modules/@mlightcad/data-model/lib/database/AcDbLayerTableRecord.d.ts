 ...
 */
export declare function acdbCreateLayerTableRecordDefaultAttrs(): {
    color: AcCmColor;
    description: string;
    standardFlags: number;
    isHidden: boolean;
...
export declare const LAYER_TABLE_RECORD_DIFF_ATTR_KEYS: readonly ["name", ...("color" | "transparency" | "linetype" | "lineWeight" | "description" | "standardFlags" | "isHidden" | "isInUse" | "isOff" | "isPlottable" | "materialId")[]];
/**
...
//# sourceMappingURL=AcDbLayerTableRecord.d.ts.map