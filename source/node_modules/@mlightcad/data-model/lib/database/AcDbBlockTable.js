...
var AcDbBlockTable = /** @class */ (function (_super) {
     ...
     */
    AcDbBlockTable.prototype.getXrefs = function () {
        var e_2, _a;
        var result = [];
        try {
     ...
     */
    AcDbBlockTable.prototype.getUnresolvedXrefs = function () {
        return this.getXrefs().filter(function (btr) { return btr.isUnresolvedXref; });
    };
    /**
    ...
    AcDbBlockTable.prototype.normalizeName = function (name) {
        ...
        if (AcDbBlockTableRecord.isPaperSapceName(trimmed)) {
            ...
            var suffix = trimmed.substring(prefix.length);
