...
import { acdbAreChangeContainersEqual } from './AcDbDatabaseChange';
/**
...
var AcDbChangeRecorder = /** @class */ (function () {
     ...
     */
    AcDbChangeRecorder.prototype.hasModify = function (objectId) {
        return this.changes.some(function (c) { return c.kind === 'modify' && c.objectId === objectId; });
    };
    /**
