export { AcDbChangeApplier, acdbCollectChangeEntities, acdbCollectDictionaryChanges } from './AcDbChangeApplier';
export { AcDbChangeRecorder } from './AcDbChangeRecorder';
export { acdbAreChangeContainersEqual } from './AcDbDatabaseChange';
export type { AcDbChangeContainer, AcDbDatabaseChange } from './AcDbDatabaseChange';
