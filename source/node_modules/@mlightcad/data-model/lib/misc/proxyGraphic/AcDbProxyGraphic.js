...
import { AcGeArea2d, AcGeCircArc3d, AcGeEllipseArc3d, acgeGetOcsAngle, acgeGetOcsReferenceVector, AcGeMatrix3d, AcGePoint3d, AcGePolyline2d, acgeTransformOcsPointToWcs, acgeTransformWcsPointToOcs, AcGeVector3d, TAU } from '@mlightcad/geometry-engine';
...
import { acdbCombineDxfBinaryChunks, AcDbProxyGraphicBitStream, AcDbProxyGraphicByteStream } from './AcDbProxyGraphicBinaryStream';
/**
...
var AcDbProxyGraphic = /** @class */ (function () {
    ...
    AcDbProxyGraphic.prototype.transformVector = function (vector) {
        ...
        if (!Number.isFinite(transformed.lengthSq()) ||
    ...
    AcDbProxyGraphic.prototype.drawCircle = function (renderer, entities, data) {
        ...
        var refVec = acgeGetOcsReferenceVector(normalVec);
        var arc = new AcGeCircArc3d(acgeTransformOcsPointToWcs(centerPoint, normalVec), radius, 0, TAU, normalVec, refVec);
    ...
    AcDbProxyGraphic.prototype.drawCircularArc = function (renderer, entities, data) {
        ...
        var refVec = Number.isFinite(rawStart.lengthSq()) && rawStart.lengthSq() >= 1e-24
            ? rawStart.normalize()
    ...
    AcDbProxyGraphic.prototype.drawCircularArc3P = function (renderer, entities, data) {
        ...
        if (!center)
            return;
        var radius = center.distanceTo(p1);
        var startAngle = acgeGetOcsAngle(center, p1, Z_AXIS);
        var endAngle = acgeGetOcsAngle(center, p3, Z_AXIS);
    ...
    AcDbProxyGraphic.prototype.drawEllipticArc = function (renderer, entities, data) {
        ...
        var majorAxis = acgeTransformOcsPointToWcs({
    ...
    AcDbProxyGraphic.prototype.drawPolyline = function (renderer, entities, data, _loadNormal) {
        ...
        if (vertices.length === 1) {
            ...
            this.pushEntity(entities, renderer.point(vertices[0], {
                displayMode: pdmode,
                displaySize: pdsize
            }));
            return;
    ...
    AcDbProxyGraphic.prototype.drawText = function (renderer, entities, data, unicode) {
        ...
        var _a = __read(bs.readStruct([8, 8, 8]), 3), height = _a[0], widthFactor = _a[1], obliqueAngle = _a[2];
        var text = unicode
 ...
 */
export function acdbLoadProxyGraphicFromDxf(length, chunks) {
    if (!(chunks === null || chunks === void 0 ? void 0 : chunks.length)) {
        return undefined;
    }
    var bytes = acdbCombineDxfBinaryChunks(chunks);
