 ...
 */
export function acdbEncodeMLeaderStyleRawColor(color) {
    if (color.isByBlock) {
 ...
 *   https://raw.githubusercontent.com/mozman/ezdxf/master/src/ezdxf/colors.py
 */
export function acdbDecodeMLeaderStyleRawColor(rawColor) {
    var color = new AcCmColor(AcCmColorMethod.ByBlock);
    var flags = (rawColor >>> 24) & 0xff;
    switch (flags) {
...
//# sourceMappingURL=AcDbMLeaderStyleColorCodec.js.map