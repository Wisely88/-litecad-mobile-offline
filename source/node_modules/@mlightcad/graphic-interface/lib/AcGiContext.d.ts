 ...
 */
export declare class AcGiContext {
    /**
     * Database being drawn. Runtime type is `AcDbDatabase` (data-model); typed as
     * `unknown` here so graphic-interface does not depend on data-model.
     *
     ...
     */
    static fromBackgroundColor(backgroundColor?: number, database?: unknown): AcGiContext;
}
/** AutoCAD model-space default background: RGB(0, 0, 0). */
export declare const ACGI_MODEL_SPACE_BACKGROUND = 0;
/** ACI-7 foreground on a dark canvas background. */
export declare const ACGI_DARK_THEME_FOREGROUND = 16777215;
/** ACI-7 foreground on a light canvas background. */
export declare const ACGI_LIGHT_THEME_FOREGROUND = 0;
/** AutoCAD paper-space default background: RGB(255, 255, 255). */
export declare const ACGI_PAPER_SPACE_BACKGROUND = 16777215;
/** Default draw context matching a dark AutoCAD model-space background. */
export declare const DEFAULT_ACGI_CONTEXT: AcGiContext;
/**
 * Whether a packed RGB colour is perceptually light (paper-like).
 */
export declare function acgiIsLightBackground(color: number): boolean;
/**
 * ACI-7 foreground that contrasts with the canvas background.
 */
export declare function acgiForegroundColorForBackground(backgroundColor: number): number;
/**
 * ACI-7 foreground that contrasts with a light or dark UI theme flag.
 */
export declare function acgiContrastingForegroundColor(isLight: boolean): number;
/**
 * Convenience wrapper when only the canvas background is available.
 */
export declare function acgiResolveSubEntityTraitsRgbFromBackground(traits: AcGiSubEntityTraits, backgroundColor: number): number;
//# sourceMappingURL=AcGiContext.d.ts.map