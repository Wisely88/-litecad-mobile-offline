...
export var PDF_PLUGIN_NAME = 'PdfPlugin';
/**
 ...
 */
export var PDF_PLUGIN_TRIGGERS = ['-cpdf', 'cpdf', 'ipdf'];
/**
 ...
 */
export function registerLazyPdfPlugin(pluginManager, options) {
    var _this = this;
    if (options === void 0) { options = {}; }
    var disableExport = options.disableExport === true;
    var triggers = disableExport
        ? ['ipdf']
        : __spreadArray([], __read(PDF_PLUGIN_TRIGGERS), false);
    pluginManager.registerLazyPlugin({
        name: PDF_PLUGIN_NAME,
        triggers: __spreadArray([], __read(triggers), false),
        loader: function () { return __awaiter(_this, void 0, void 0, function () {
            var createPdfPlugin;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, import('@mlightcad/cad-pdf-plugin')];
                    case 1:
                        createPdfPlugin = (_a.sent()).createPdfPlugin;
                        return [2 /*return*/, createPdfPlugin({ disableExport: disableExport })];
                }
            });
        }); }
    });
