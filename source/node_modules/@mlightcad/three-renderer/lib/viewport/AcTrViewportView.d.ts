 ...
 */
export declare class AcTrViewportView extends AcTrBaseView {
    private _parentView;
    private _viewport;
    /**
     * Calcuate the bounding box of this viewport in client window coordinate system
     */
    static calculateViewportWindowBox(parentView: AcTrBaseView, viewport: AcGiViewport): AcGeBox2d;
    /**
     ...
     */
    constructor(parentView: AcTrBaseView, viewport: AcGiViewport, renderer: AcTrRenderer);
    /**
     * The viewport associated with this viewport view.
     */
    get viewport(): AcGiViewport;
    /**
...
//# sourceMappingURL=AcTrViewportView.d.ts.map