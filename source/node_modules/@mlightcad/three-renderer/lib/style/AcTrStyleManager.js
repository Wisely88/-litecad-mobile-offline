...
import { ACGI_MODEL_SPACE_BACKGROUND, acgiForegroundColorForBackground } from '@mlightcad/data-model';
 ...
 */
var AcTrStyleManager = /** @class */ (function () {
    function AcTrStyleManager() {
        this.options = {
         ...
         */
        this._forceShowLineWeight = false;
        /** Unsupported text styles mapped by name → usage count. */
        this.unsupportedTextStyles = {};
     ...
     */
    AcTrStyleManager.prototype.getPointsMaterial = function (traits, size) {
        if (size === void 0) { size = 2; }
        return this.pointMgr.getMaterial(traits, { size: size });
    };
    /**
     ...
     */
    AcTrStyleManager.prototype.getLineMaterial = function (traits, basicMaterialOnly) {
        var hasLinePattern = !!(traits.lineType.pattern && traits.lineType.pattern.length > 0);
        var showLineWeight = this.options.showLineWeight || this._forceShowLineWeight;
        var forceBasicMaterial = !showLineWeight && !hasLinePattern;
        return this.lineMgr.getMaterial(traits, {
            basicMaterialOnly: basicMaterialOnly || forceBasicMaterial
        });
    };
    Object.defineProperty(AcTrStyleManager.prototype, "showLineWeight", {
        /**
    ...
    Object.defineProperty(AcTrStyleManager.prototype, "forceShowLineWeight", {
        /**
    ...
    Object.defineProperty(AcTrStyleManager.prototype, "currentBackgroundColor", {
        /**
     ...
     */
    AcTrStyleManager.prototype.getFillMaterial = function (traits, rebaseOffset, gradientBounds) {
        if (rebaseOffset === void 0) { rebaseOffset = _rebaseOffset; }
     ...
     */
    AcTrStyleManager.prototype.getMTextFillMaterial = function (traits, rebaseOffset) {
        if (rebaseOffset === void 0) { rebaseOffset = _rebaseOffset; }
        return this.fillMgr.getMaterial(traits, {
            rebaseOffset: rebaseOffset
        });
     ...
     */
    AcTrStyleManager.prototype.getBackSideVariant = function (material) {
     ...
     */
    AcTrStyleManager.prototype.updateLayerMaterial = function (layerName, newTraits) {
        return __assign(__assign(__assign({}, this.lineMgr.updateLayerMaterial(layerName, newTraits)), this.pointMgr.updateLayerMaterial(layerName, newTraits)), this.fillMgr.updateLayerMaterial(layerName, newTraits));
    };
    /**
     ...
     */
    AcTrStyleManager.prototype.getLayerBoundMaterial = function (material, layerName, layerTraits) {
        return (this.lineMgr.getLayerBoundMaterial(material, layerName, layerTraits) ||
     ...
     */
    AcTrStyleManager.prototype.repaintForegroundMaterials = function (color) {
     ...
     */
    AcTrStyleManager.prototype.changeBackground = function (color) {
     ...
     */
    AcTrStyleManager.prototype.dispose = function () {
     ...
     */
    AcTrStyleManager.prototype.getStats = function () {
        var point = this.pointMgr.getStats();
        var line = this.lineMgr.getStats();
        var fill = this.fillMgr.getStats();
        return {
            point: point,
            line: line,
            fill: fill,
            totalCount: point.count + line.count + fill.count,
            totalEstimatedBytes: point.estimatedBytes + line.estimatedBytes + fill.estimatedBytes
        };
    };
    AcTrStyleManager.prototype.updateLineResolution = function (width, height) {
        this.options.resolution.set(width, height);
        this.lineMgr.updateResolution();
    };
    return AcTrStyleManager;
}());
export { AcTrStyleManager };
var _rebaseOffset = /*@__PURE__*/ new THREE.Vector2(0, 0);
//# sourceMappingURL=AcTrStyleManager.js.map