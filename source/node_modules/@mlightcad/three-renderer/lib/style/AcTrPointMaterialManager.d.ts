 ...
 */
export declare class AcTrPointMaterialManager extends AcTrMaterialManager<AcTrPointMaterialOptions> {
    /**
     * Builds a stable material key from traits.
     */
    protected buildKey(traits: AcGiSubEntityTraits, options: AcTrPointMaterialOptions): string;
    /** Returns true if color is ByLayer. */
    protected hasByLayerKeyTraits(traits: AcGiSubEntityTraits): boolean;
    protected createMaterialImpl(traits: AcGiSubEntityTraits, options?: AcTrPointMaterialOptions, layerColorRgb?: number): THREE.Material;
}
//# sourceMappingURL=AcTrPointMaterialManager.d.ts.map