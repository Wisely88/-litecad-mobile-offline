 ...
 */
export declare class AcTrStyleManager {
    options: AcTrStyleManagerOptions;
    private pointMgr;
    private lineMgr;
    private fillMgr;
    /**
     ...
     */
    getPointsMaterial(traits: AcGiSubEntityTraits, size?: number): THREE.Material;
    /**
     ...
     */
    getLineMaterial(traits: AcGiSubEntityTraits, basicMaterialOnly?: boolean): THREE.Material;
    /**
     ...
     */
    getFillMaterial(traits: AcGiSubEntityTraits, rebaseOffset?: THREE.Vector2, gradientBounds?: {
        minX: number;
        minY: number;
        maxX: number;
        maxY: number;
     ...
     */
    getMTextFillMaterial(traits: AcGiSubEntityTraits, rebaseOffset?: THREE.Vector2): THREE.Material;
    /**
     ...
     */
    private repaintForegroundMaterials;
    /**
...
//# sourceMappingURL=AcTrStyleManager.d.ts.map