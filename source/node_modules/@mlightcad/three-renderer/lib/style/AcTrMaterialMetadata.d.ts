 ...
 */
export declare function asAcTrMaterial(material: THREE.Material): AcTrMaterial;
/**
 * Returns typed material metadata stored in `material.userData`.
 */
export declare function getMaterialMetadata(material: THREE.Material): AcTrMaterialMetadataPatch;
/**
 * Merges metadata fields into `material.userData` with strong typing.
 */
export declare function setMaterialMetadata(material: THREE.Material, patch: AcTrMaterialMetadataPatch): void;
/**
 * Returns whether metadata indicates at least one ByLayer-bound trait.
 */
export declare function hasByLayerBinding(metadata: AcTrMaterialMetadataPatch): boolean;
/**
 ...
 */
export declare function followsLayerStyle(material: THREE.Material, layerName: string, objectLayerName?: string): boolean;
//# sourceMappingURL=AcTrMaterialMetadata.d.ts.map