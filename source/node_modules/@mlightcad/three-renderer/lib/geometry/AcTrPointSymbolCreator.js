...
var pointTypeData = new Map([
    ...
    [
        34,
        {
            position: new Float32Array(__spreadArray(__spreadArray([], __read(circlePointData), false), [
                -1,
                0,
                0,
                1,
            ...
            indices: new Uint16Array(__spreadArray(__spreadArray([], __read(circlePointIndexData), false), [26, 27, 28, 29], false))
        }
    ],
    [
        35,
    ...
    [
        36,
        {
            position: new Float32Array(__spreadArray(__spreadArray([], __read(circlePointData), false), [0, 0, 0, 0, 0.5, 0], false)),
            indices: new Uint16Array(__spreadArray(__spreadArray([], __read(circlePointIndexData), false), [26, 27], false))
        }
    ],
    [
        64,
    ...
    [
        96,
        {
            ...
            indices: new Uint16Array(__spreadArray(__spreadArray([], __read(circlePointIndexData), false), [
                26,
                27,
                27,
                28,
 ...
 * @internal
 */
var AcTrPointSymbolCreator = /** @class */ (function () {
    function AcTrPointSymbolCreator() {
        this._symbols = this.initialize();
    }
    Object.defineProperty(AcTrPointSymbolCreator, "instance", {
        get: function () {
     ...
     */
    AcTrPointSymbolCreator.prototype.isShowPoint = function (displayMode) {
        if (displayMode === void 0) { displayMode = null; }
     ...
     */
    AcTrPointSymbolCreator.resolveDisplayScale = function (displaySize) {
        return displaySize > 0 ? displaySize : 1;
    };
    AcTrPointSymbolCreator.prototype.create = function (displayMode, _point, displaySize) {
        if (displayMode === void 0) { displayMode = null; }
        if (_point === void 0) { _point = { x: 0, y: 0, z: 0 }; }
        if (displaySize === void 0) { displaySize = 0; }
        var result = {};
        var scale = AcTrPointSymbolCreator.resolveDisplayScale(displaySize);
        if (displayMode == null || displayMode == 0) {
            ...
            var pointSymbolGeometry = this._symbols.get(displayMode);
            if (pointSymbolGeometry == null) {
                throw new Error("[AcTrPointSymbolCreator] Invalid point type value: '".concat(displayMode, "'!"));
            }
            else {
    ...
    AcTrPointSymbolCreator.prototype.initialize = function () {
        var results = new Map();
        pointTypeData.forEach(function (lines, index) {
            var geometry = new THREE.BufferGeometry();
            geometry.setAttribute('position', new THREE.BufferAttribute(lines.position, 3));
            geometry.setIndex(new THREE.BufferAttribute(lines.indices, 1));
            results.set(index, geometry);
        });
        return results;
    };
    return AcTrPointSymbolCreator;
}());
export { AcTrPointSymbolCreator };
var _originPoint = /*@__PURE__*/ new THREE.Vector3(0, 0, 0);
//# sourceMappingURL=AcTrPointSymbolCreator.js.map