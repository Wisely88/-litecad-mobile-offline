...
import { AcTrMaterialUtil, AcTrMatrixUtil, effectiveLayer, isObjectHierarchyVisible } from '../util';
...
var AcTrEntity = /** @class */ (function (_super) {
                ...
                for (var children_1 = __values(children), children_1_1 = children_1.next(); !children_1_1.done; children_1_1 = children_1.next()) {
                    ...
                    if (objectData.layerName) {
                        if (!childData.layerName) {
                            ...
                            var resolved = effectiveLayer(childData.layerName, objectData.layerName);
    ...
    AcTrEntity.disposeObject = function (object, isRemoveFromParent) {
        ...
        var sharesTemplateGeometry = getSceneDrawableUserData(object).sharesTemplateGeometry === true;
     ...
     */
    AcTrEntity.prototype.asyncDraw = function () {
     ...
     */
    AcTrEntity.prototype.syncDraw = function () { };
    /**
     * Returns true when drawable child geometry is already attached.
     */
    AcTrEntity.prototype.hasDrawableGeometry = function () {
        return this.children.length > 0;
    };
    Object.defineProperty(AcTrEntity.prototype, "childCount", {
        /**
     ...
     */
    AcTrEntity.prototype.applyFullMatrix4 = function (threeMatrix) {
     ...
     */
    AcTrEntity.prototype.fastDeepClone = function (shareGeometry) {
        if (shareGeometry === void 0) { shareGeometry = false; }
     ...
     */
    AcTrEntity.prototype.copyGeometry = function (source, target, shareGeometry) {
        if (shareGeometry === void 0) { shareGeometry = false; }
