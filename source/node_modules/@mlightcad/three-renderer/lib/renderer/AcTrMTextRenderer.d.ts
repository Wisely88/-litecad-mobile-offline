import { ColorSettings, DefaultFontsPreset, type MemoryUsageReport, MTextData, MTextObject, RenderMode, ShapeData, TextStyle } from '@mlightcad/mtext-renderer';
...
export declare class AcTrMTextRenderer {
    ...
    private _lazyFontLoading?;
    private _awaitFontsBeforeDraw?;
    private constructor();
    /**
    ...
    private applyLazyFontLoading;
    private applyAwaitFontsBeforeDraw;
}
