...
import { ACGI_DARK_THEME_FOREGROUND, ACGI_LIGHT_THEME_FOREGROUND, AcGiContext, acgiIsLightBackground } from '@mlightcad/data-model';
import { alwaysBatchDrawPolicy } from '../draw/AcTrBatchDrawPolicy';
 ...
 */
var AcTrRenderContext = /** @class */ (function (_super) {
    __extends(AcTrRenderContext, _super);
    function AcTrRenderContext(styleManager, batchDrawPolicy) {
        if (styleManager === void 0) { styleManager = new AcTrStyleManager(); }
        if (batchDrawPolicy === void 0) { batchDrawPolicy = alwaysBatchDrawPolicy; }
        ...
        _this.styleManager = styleManager;
        _this.batchDrawPolicy = batchDrawPolicy;
        return _this;
    }
    /**
     * Refreshes background-dependent fields from the canvas background colour.
     */
    AcTrRenderContext.prototype.syncBackgroundColor = function (backgroundColor) {
    ...
    return AcTrRenderContext;
}(AcGiContext));
export { AcTrRenderContext };
//# sourceMappingURL=AcTrRenderContext.js.map