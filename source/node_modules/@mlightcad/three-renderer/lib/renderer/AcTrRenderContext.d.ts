import { AcDbDatabase, AcGiContext } from '@mlightcad/data-model';
import { AcTrBatchDrawPolicy } from '../draw/AcTrBatchDrawPolicy';
 ...
 */
export declare class AcTrRenderContext extends AcGiContext {
     ...
     */
    database: AcDbDatabase | undefined;
    constructor(styleManager?: AcTrStyleManager, batchDrawPolicy?: AcTrBatchDrawPolicy);
    /**
     * Refreshes background-dependent fields from the canvas background colour.
     */
    syncBackgroundColor(backgroundColor: number): void;
}
//# sourceMappingURL=AcTrRenderContext.d.ts.map