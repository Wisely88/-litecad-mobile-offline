...
export { isBatchGeometryActive, isBatchGeometryVisible } from './batch/AcTrBatchedGeometryInfo';
export * from './draw';
...
export { createGradientHatchShaderMaterial, createGradientHatchShaderMaterialFromUniforms, type AcTrGradientHatchStyle } from './style/AcTrGradientHatchShaders';
export { createHatchPatternShaderMaterial, type AcTrPatternLine } from './style/AcTrHatchPatternShaders';
...
export { getSceneDrawableUserData, isHighlightCloneDrawable, isHighlightOverlayDescendant, resolveDrawableExportMaterial, markHighlightOverlayGroup, patchDrawableMaterialFromCache, resolveCachedMaterialRemap, syncStyleMaterialIdFromMaterials, type AcTrHighlightOverlayGroup, type AcTrHighlightOverlayGroupUserData } from './util/AcTrObjectUserData';
