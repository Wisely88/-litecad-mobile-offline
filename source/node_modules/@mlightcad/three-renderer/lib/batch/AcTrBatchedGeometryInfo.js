...
export function copyAttributeData(src, target, targetOffset) {
    ...
    if (src.isInterleavedBufferAttribute ||
        ...
        var srcLength = src.count * itemSize;
        target.array.set(src.array.subarray(0, srcLength), targetOffset * itemSize);
    }
