...
import { AcTrBatchGeometryUserData, AcTrVertexBatchGeometryInfo } from './AcTrBatchedGeometryInfo';
declare const AcTrBatchedLine2Base: {
    new (...args: any[]): {
        boundingBox: THREE.Box3 | null;
        boundingSphere: THREE.Sphere | null;
        _geometryInfo: AcTrVertexBatchGeometryInfo[];
        ...
        readonly _highlightState: import("./highlight").AcTrBatchHighlightState;
        get mappingStats(): {
            count: number;
            size: number;
        };
        validateGeometryId(geometryId: number): void;
        getGeometryRangeAt(geometryId: number): AcTrVertexBatchGeometryInfo;
        ...
        setHighlightAt(geometryId: number, kind: import("./highlight").AcTrBatchHighlightKind, enabled: boolean): boolean;
        setCompareRoleAt(geometryId: number, role: import("./highlight").AcTrBatchCompareRole | null): boolean;
        applyPackedCompareRoles(roles: ReadonlyMap<string, import("./highlight").AcTrBatchCompareRole>): /*elided*/ any;
 ...
 */
export declare class AcTrBatchedLine2 extends AcTrBatchedLine2Base {
     ...
     */
    addGeometry(geometry: LineSegmentsGeometry, reservedSegmentCount?: number, worldOffset?: THREE.Vector3): number;
     ...
     */
    setGeometryAt(geometryId: number, geometry: LineSegmentsGeometry): number;
    /**
    ...
    getGeometryAt(geometryId: number): AcTrVertexBatchGeometryInfo;
    /**
     * Resizes packed segment capacity while preserving existing segment data.
     */
    setGeometrySize(maxSegmentCount: number): void;
    /**
     * Builds a standalone `LineSegments2` object for one packed geometry id.
     */
    getObjectAt(batchId: number): LineSegments2;
    /**
     ...
     */
    copy(source: AcTrBatchedLine2): this;
    /**
...
export {};
//# sourceMappingURL=AcTrBatchedLine2.d.ts.map