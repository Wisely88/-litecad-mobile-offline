 ...
 */
declare const AcTrBatchedPointBase: {
    new (...args: any[]): {
 ...
 */
export declare class AcTrBatchedPoint extends AcTrBatchedPointBase {
     ...
     */
    constructor(maxVertexCount?: number, material?: THREE.Material);
    /**
     ...
     */
    addGeometry(geometry: THREE.BufferGeometry, reservedVertexCount?: number, worldOffset?: THREE.Vector3): number;
    /**
     ...
     */
    setGeometrySize(maxVertexCount: number): void;
    /**
     ...
     * @returns This instance for chaining.
     */
    copy(source: AcTrBatchedPoint): this;
}
export {};
//# sourceMappingURL=AcTrBatchedPoint.d.ts.map