 ...
 */
declare const AcTrBatchedLineBase: {
    new (...args: any[]): {
 ...
 */
export declare class AcTrBatchedLine extends AcTrBatchedLineBase {
     ...
     */
    getUserData(): AcTrBatchGeometryUserData[];
    /**
     ...
     */
    resetGeometry(displayMode: number, displaySize?: number): void;
    /**
     ...
     */
    getGeometryAt(geometryId: number): import("./AcTrBatchedGeometryInfo").AcTrIndexedBatchGeometryInfo;
    /**
     ...
     */
    _initializeRaycastObject(raycastObject: THREE.Object3D & {
        geometry: THREE.BufferGeometry;
        material: THREE.Material | THREE.Material[];
    }): void;
    /**
     ...
     * @returns This instance for chaining.
     */
    copy(source: AcTrBatchedLine): this;
}
export {};
//# sourceMappingURL=AcTrBatchedLine.d.ts.map