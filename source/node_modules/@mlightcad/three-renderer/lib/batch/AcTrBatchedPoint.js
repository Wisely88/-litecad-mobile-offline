 ...
 */
var AcTrBatchedPointBase = createAcTrBatchedMixin(THREE.Points, {
    typeName: 'AcTrBatchedPoint',
    createObject: function () { return new THREE.Points(); },
 ...
 */
var AcTrBatchedPoint = /** @class */ (function (_super) {
    __extends(AcTrBatchedPoint, _super);
    /**
     ...
     */
    function AcTrBatchedPoint(maxVertexCount, material) {
    ...
    Object.defineProperty(AcTrBatchedPoint.prototype, "geometryCount", {
        /**
    ...
    Object.defineProperty(AcTrBatchedPoint.prototype, "unusedVertexCount", {
        /**
    ...
    Object.defineProperty(AcTrBatchedPoint.prototype, "origin", {
     ...
     */
    AcTrBatchedPoint.prototype._initializeGeometry = function (reference) {
     ...
     */
    AcTrBatchedPoint.prototype._validateGeometry = function (geometry) {
     ...
     */
    AcTrBatchedPoint.prototype._resizeSpaceIfNeeded = function (geometry) {
     ...
     */
    AcTrBatchedPoint.prototype.reset = function () {
     ...
     */
    AcTrBatchedPoint.prototype.addGeometry = function (geometry, reservedVertexCount, worldOffset) {
        ...
        var geometryInfo = __assign({ 
            ...
            vertexStart: this._nextVertexStart, vertexCount: -1, reservedVertexCount: resolveReservedCount(reservedVertexCount, positionCount) }, createGeometryState());
     ...
     */
    AcTrBatchedPoint.prototype.rebaseGeometryInPlace = function (geometry, worldOffset) {
     ...
     */
    AcTrBatchedPoint.prototype.setGeometryInfo = function (geometryId, userData) {
     ...
     */
    AcTrBatchedPoint.prototype.setGeometryAt = function (geometryId, geometry) {
        if (geometryId >= this._geometryCount) {
            throw new Error('AcTrBatchedPoint: Maximum geometry count reached.');
        }
        this._validateGeometry(geometry);
     ...
     */
    AcTrBatchedPoint.prototype.optimize = function () {
        var nextVertexStart = 0;
        var geometry = this.geometry;
        var geometryInfoList = this._geometryInfo;
        // Sort ACTIVE geometries by original buffer order
        var indices = geometryInfoList
            .map(function (_g, i) { return i; })
            .filter(function (i) { return isBatchGeometryActive(geometryInfoList[i].flags); })
            .sort(function (a, b) {
        ...
        for (var k = 0; k < indices.length; k++) {
            ...
            if (oldVertexStart !== nextVertexStart) {
                for (var key in geometry.attributes) {
                    ...
                    array.copyWithin(nextVertexStart * itemSize, oldVertexStart * itemSize, (oldVertexStart + count) * itemSize);
     ...
     */
    AcTrBatchedPoint.prototype.getBoundingBoxAt = function (geometryId, target) {
        if (geometryId >= this._geometryCount) {
            return null;
        }
     ...
     * @returns `target` when the id is valid, otherwise `null`.
     */
    AcTrBatchedPoint.prototype.getBoundingSphereAt = function (geometryId, target) {
        if (geometryId >= this._geometryCount) {
            return null;
        }
     ...
     */
    AcTrBatchedPoint.prototype.getGeometryAt = function (geometryId) {
     ...
     */
    AcTrBatchedPoint.prototype.setGeometrySize = function (maxVertexCount) {
     ...
     */
    AcTrBatchedPoint.prototype._syncDrawRange = function () {
        this.geometry.setDrawRange(0, this._nextVertexStart);
    };
    /**
     ...
     * @returns This instance for chaining.
     */
    AcTrBatchedPoint.prototype.copy = function (source) {
        var _a;
    ...
    AcTrBatchedPoint.GROWTH_FACTOR = 1.25;
    return AcTrBatchedPoint;
}(AcTrBatchedPointBase));
export { AcTrBatchedPoint };
//# sourceMappingURL=AcTrBatchedPoint.js.map