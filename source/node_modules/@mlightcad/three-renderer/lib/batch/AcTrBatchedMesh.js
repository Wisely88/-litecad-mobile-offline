 ...
 */
var AcTrBatchedMeshBase = createAcTrBatchedMixin(THREE.Mesh, {
    typeName: 'AcTrBatchedMesh',
    createObject: function () { return new THREE.Mesh(); },
 ...
 */
var AcTrBatchedMesh = /** @class */ (function (_super) {
    __extends(AcTrBatchedMesh, _super);
    /**
     ...
     */
    function AcTrBatchedMesh(maxVertexCount, maxIndexCount, material) {
    ...
    Object.defineProperty(AcTrBatchedMesh.prototype, "unusedVertexCount", {
        /**
    ...
    Object.defineProperty(AcTrBatchedMesh.prototype, "unusedIndexCount", {
        /**
    ...
    Object.defineProperty(AcTrBatchedMesh.prototype, "origin", {
     ...
     */
    AcTrBatchedMesh.prototype._initializeGeometry = function (reference) {
     ...
     */
    AcTrBatchedMesh.prototype._validateGeometry = function (geometry) {
     ...
     */
    AcTrBatchedMesh.prototype._resizeSpaceIfNeeded = function (geometry) {
     ...
     */
    AcTrBatchedMesh.prototype.addGeometry = function (geometry, reservedVertexCount, reservedIndexCount, worldOffset) {
     ...
     */
    AcTrBatchedMesh.prototype.rebaseGeometryInPlace = function (geometry, worldOffset) {
     ...
     */
    AcTrBatchedMesh.prototype.setGeometryInfo = function (geometryId, userData) {
     ...
     */
    AcTrBatchedMesh.prototype.setGeometryAt = function (geometryId, geometry) {
        if (geometryId >= this._geometryCount) {
            throw new Error('AcTrBatchedMesh: Maximum geometry count reached.');
        }
        this._validateGeometry(geometry);
     ...
     */
    AcTrBatchedMesh.prototype.optimize = function () {
        var e_1, _a;
        ...
        var activeInfos = this._geometryInfo
            .map(function (info, i) { return ({ info: info, i: i }); })
        ...
        try {
            ...
            for (var activeInfos_1 = __values(activeInfos), activeInfos_1_1 = activeInfos_1.next(); !activeInfos_1_1.done; activeInfos_1_1 = activeInfos_1.next()) {
                var info = activeInfos_1_1.value.info;
                ...
                if (oldVertexStart !== nextVertexStart) {
                    for (var key in attributes) {
                        ...
                        array.copyWithin(nextVertexStart * itemSize, oldVertexStart * itemSize, (oldVertexStart + vertexCount) * itemSize);
                        attr.addUpdateRange(nextVertexStart * itemSize, vertexCount * itemSize);
                ...
                if (hasIndex && indexAttr) {
                    if (oldIndexStart !== nextIndexStart) {
                        ...
                        var delta = nextVertexStart - oldVertexStart;
            ...
            try {
                if (activeInfos_1_1 && !activeInfos_1_1.done && (_a = activeInfos_1.return)) _a.call(activeInfos_1);
            }
            finally { if (e_1) throw e_1.error; }
        }
        // ---- clear unused index tail (safety) ----
        if (hasIndex && indexAttr) {
            var array = indexAttr.array;
            for (var i = nextIndexStart, l = array.length; i < l; i++) {
                array[i] = 0;
            }
            indexAttr.needsUpdate = true;
        }
     ...
     */
    AcTrBatchedMesh.prototype.getBoundingBoxAt = function (geometryId, target) {
        if (geometryId >= this._geometryCount) {
            return null;
        }
     ...
     * @returns `target` when the id is valid, otherwise `null`.
     */
    AcTrBatchedMesh.prototype.getBoundingSphereAt = function (geometryId, target) {
        if (geometryId >= this._geometryCount) {
            return null;
        }
     ...
     */
    AcTrBatchedMesh.prototype.setGeometrySize = function (maxVertexCount, maxIndexCount) {
     ...
     */
    AcTrBatchedMesh.prototype._syncDrawRange = function () {
        var geometry = this.geometry;
        if (geometry.index) {
     ...
     * @returns This instance for chaining.
     */
    AcTrBatchedMesh.prototype.copy = function (source) {
        var _a;
    ...
    AcTrBatchedMesh.GROWTH_FACTOR = 1.25;
    return AcTrBatchedMesh;
}(AcTrBatchedMeshBase));
export { AcTrBatchedMesh };
//# sourceMappingURL=AcTrBatchedMesh.js.map