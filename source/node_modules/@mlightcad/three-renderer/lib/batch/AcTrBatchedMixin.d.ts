...
import { type AcTrBatchCompareRole, type AcTrBatchHighlightKind, AcTrBatchHighlightState } from './highlight';
/**
 ...
 */
export declare function applyGeometryAt<T extends AcTrBatchGeometryLike>(geometryInfo: T, batchGeometry: THREE.BufferGeometry, geometry: THREE.BufferGeometry, typeName: string, slotId: number): void;
/**
...
export declare function createAcTrBatchedMixin<TInfo extends AcTrBatchGeometryLike, TBase extends Constructor<AcTrBatchBaseObject> = Constructor<AcTrBatchBaseObject>>(Base: TBase, options: AcTrBatchedMixinOptions<TInfo>): {
    new (...args: any[]): {
        ...
        readonly _highlightState: AcTrBatchHighlightState;
        /**
         ...
         */
        setHighlightAt(geometryId: number, kind: AcTrBatchHighlightKind, enabled: boolean): boolean;
        /**
         ...
         * @returns `true` when the slot mask changed.
         */
        setCompareRoleAt(geometryId: number, role: AcTrBatchCompareRole | null): boolean;
        /**
         ...
         * @returns This instance for chaining.
         */
        applyPackedCompareRoles(roles: ReadonlyMap<string, AcTrBatchCompareRole>): /*elided*/ any;
        /**
         ...
         * @returns This instance for chaining.
         */
        clearHighlightSlot(geometryId: number): /*elided*/ any;
        /**
         * Clears all highlight state owned by this batch.
         *
         * @returns This instance for chaining.
         */
        clearHighlightState(): /*elided*/ any;
        /**
