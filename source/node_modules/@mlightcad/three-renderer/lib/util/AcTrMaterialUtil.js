 ...
 */
export var HIGHLIGHT_SELECT_COLOR = new THREE.Color(0x08e8de);
/**
 * Hover highlight color.
 *
 * Replace with a system-variable-driven value when CAD sysvars are wired in.
 */
export var HIGHLIGHT_HOVER_COLOR = new THREE.Color(0x66fff8);
/**
 * @deprecated Use {@link HIGHLIGHT_SELECT_COLOR} instead.
 */
export var HIGHLIGHT_COLOR = HIGHLIGHT_SELECT_COLOR;
/**
 * @internal
 */
var AcTrMaterialUtil = /** @class */ (function () {
    ...
    AcTrMaterialUtil.setMaterialColor = function (material, color) {
        var _this = this;
        if (color === void 0) { color = HIGHLIGHT_SELECT_COLOR; }
        if (Array.isArray(material)) {
