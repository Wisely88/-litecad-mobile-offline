 ...
 */
export declare class AcTrMTextColorUtil {
    /**
     ...
     */
    static buildColorSettingsFromTraits(traits: AcGiSubEntityTraits, backgroundColor?: number): ColorSettings;
    /**
     ...
     */
    static snapshotEntityTraits(traits: AcGiSubEntityTraits): AcTrMTextEntityTraits;
    /** Clones a text-entity traits snapshot for storage on scene drawables. */
    static cloneEntityTraits(traits: AcTrMTextEntityTraits): AcTrMTextEntityTraits;
    /** Stores a text traits snapshot on one drawable for later rematerialization. */
    static storeTextEntityTraitsOnDrawable(object: THREE.Object3D, traits: AcTrMTextEntityTraits): void;
    /**
     ...
     */
    static rematerializeTextHierarchy(root: THREE.Object3D, traits: AcTrMTextEntityTraits, styleManager: AcTrStyleManager): void;
    /**
    ...
    static resolveRgbColor(settings: ColorSettings, backgroundColor?: number): number;
}
//# sourceMappingURL=AcTrMTextColorUtil.d.ts.map