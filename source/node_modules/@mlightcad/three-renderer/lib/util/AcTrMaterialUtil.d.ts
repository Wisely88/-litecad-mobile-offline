 ...
 */
export declare const HIGHLIGHT_SELECT_COLOR: THREE.Color;
/**
 * Hover highlight color.
 *
 * Replace with a system-variable-driven value when CAD sysvars are wired in.
 */
export declare const HIGHLIGHT_HOVER_COLOR: THREE.Color;
/**
 * @deprecated Use {@link HIGHLIGHT_SELECT_COLOR} instead.
 */
export declare const HIGHLIGHT_COLOR: THREE.Color;
/**
 * @internal
 */
export declare class AcTrMaterialUtil {
    /**
    ...
    private static cloneSingleMaterial;
    /**
     ...
     */
    private static resetRuntimeShaderState;
}
//# sourceMappingURL=AcTrMaterialUtil.d.ts.map