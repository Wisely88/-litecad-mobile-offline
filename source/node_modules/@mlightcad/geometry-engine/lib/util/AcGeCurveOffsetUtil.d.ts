 ...
 */
export declare function acgeOffsetPointByDirectionInXY(point: AcGePoint3dLike, direction: AcGeVector3dLike, offsetDist: number): AcGePoint3d | null;
/**
 ...
 */
export declare function acgeOffsetVertexPath(points: AcGePoint2d[], closed: boolean, offsetDist: number): AcGePolyline2d | null;
//# sourceMappingURL=AcGeCurveOffsetUtil.d.ts.map