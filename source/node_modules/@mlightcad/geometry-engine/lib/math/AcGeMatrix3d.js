...
var AcGeMatrix3d = /** @class */ (function () {
     ...
     */
    AcGeMatrix3d.makeTranslation = function (x, y, z) {
    ...
    AcGeMatrix3d.prototype.setFromExtrusionDirection = function (extrusion) {
        var length = Math.hypot(extrusion.x, extrusion.y, extrusion.z);
        if (!Number.isFinite(length) || length < 1e-12) {
            this.identity();
            return this;
        }
        var normal = Math.abs(length - 1) > 1e-6
    ...
    AcGeMatrix3d.prototype.makeTranslation = function (x, y, z) {
        var _a;
        if (typeof x === 'object') {
            this.set(1, 0, 0, x.x, 0, 1, 0, x.y, 0, 0, 1, (_a = x.z) !== null && _a !== void 0 ? _a : 0, 0, 0, 0, 1);
        }
        else {
