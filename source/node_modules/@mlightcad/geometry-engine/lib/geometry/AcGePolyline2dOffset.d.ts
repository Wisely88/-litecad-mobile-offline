 ...
 */
export declare function acgeOffsetPolyline2d(polyline: AcGePolyline2d, offsetDist: number): AcGePolyline2d[];
/**
 ...
 */
export declare function acgePreparePolylineForOffset(polyline: AcGePolyline2d): AcGePolyline2d;
//# sourceMappingURL=AcGePolyline2dOffset.d.ts.map