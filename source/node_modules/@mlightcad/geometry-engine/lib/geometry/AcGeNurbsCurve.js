...
import { acgeCalculateCurveLength, acgeEvaluateNurbsDerivatives, acgeInterpolateNurbsCurve, acgeSignedPlanarCurvature } from '../util';
...
var AcGeNurbsCurve = /** @class */ (function () {
    ...
    AcGeNurbsCurve.prototype.evaluate = function (u) {
        ...
        return acgeEvaluateNurbsDerivatives(u, this._degree, this._knots, controlPointsArray, this._weights);
    };
    /**
    ...
    AcGeNurbsCurve.prototype.length = function () {
        ...
        var controlPointsArray = this._controlPoints.map(function (p) { return [p.x, p.y, p.z]; });
        return acgeCalculateCurveLength(this._degree, this._knots, controlPointsArray, this._weights);
    };
    /**
    ...
    AcGeNurbsCurve.byPoints = function (points, degree, parameterization, startTangent, endTangent) {
        ...
        var result = acgeInterpolateNurbsCurve(points, degree, parameterization, startTangent, endTangent);
