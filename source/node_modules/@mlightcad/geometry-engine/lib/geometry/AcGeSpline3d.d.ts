import { AcGeBox3d, AcGeMatrix3d, AcGePoint2d, AcGePoint3d, AcGePoint3dLike, AcGePointLike, AcGeVector3dLike } from '../math';
...
export declare class AcGeSpline3d extends AcGeCurve3d {
    ...
    get controlPoints(): AcGeVector3dLike[];
    get fitPoints(): AcGeVector3dLike[] | undefined;
    get knots(): number[];
    get weights(): number[];
    /**
     ...
     * @returns
     */
    getControlPointAt(index: number): AcGeVector3dLike;
    /**
     ...
     */
    moveGripPointsAt(indices: readonly number[], offset: AcGeVector3dLike): this;
    /**
