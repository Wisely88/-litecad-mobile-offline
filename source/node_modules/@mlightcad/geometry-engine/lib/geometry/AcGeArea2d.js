...
var AcGeArea2d = /** @class */ (function (_super) {
     ...
     */
    AcGeArea2d.prototype.tessellate = function (options) {
        return this.loops.map(function (loop) { return loop.tessellate(options); });
    };
    AcGeArea2d.prototype.buildHierarchy = function (options) {
        var _a;
        var pointBoundaries = this.tessellate(options);
    ...
    Object.defineProperty(AcGeArea2d.prototype, "area", {
        /**
        ...
        get: function () {
            ...
            for (var i = 0; i < this._loops.length; i++) {
                ...
                var points = loop.getPoints(128);
                var loopArea = acgeSignedPolygonArea2d(points);
                if (i === 0) {
                    // outter loop
