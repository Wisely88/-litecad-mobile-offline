...
export declare class AcGeCircArc3d extends AcGeCurve3d {
     ...
     * collinear.
     */
    static tryCreateByThreePoints(startPoint: AcGePoint3dLike, endPoint: AcGePoint3dLike, pointOnArc: AcGePoint3dLike): AcGeCircArc3d | null;
    /**
     ...
     */
    static createByThreePoints(startPoint: AcGePoint3dLike, endPoint: AcGePoint3dLike, pointOnArc: AcGePoint3dLike): AcGeCircArc3d | null;
    /**
