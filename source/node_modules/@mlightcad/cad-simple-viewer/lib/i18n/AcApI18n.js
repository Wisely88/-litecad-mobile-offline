...
var AcApI18n = /** @class */ (function () {
     ...
     */
    AcApI18n.cmdKey = function (groupName, cmdName, key) {
        return "command.".concat(groupName, ".").concat(cmdName.toLowerCase(), ".").concat(key);
    };
    /**
     ...
     */
    AcApI18n.cmd = function (groupName, cmdName, key) {
     ...
     * @returns localized string
     */
    AcApI18n.sysCmd = function (cmdName, key) {
     ...
     */
    AcApI18n.sysCmdKey = function (cmdName, key) {
     ...
     * @returns localized string
     */
    AcApI18n.userCmd = function (cmdName, key) {
     ...
     */
    AcApI18n.userCmdKey = function (cmdName, key) {
