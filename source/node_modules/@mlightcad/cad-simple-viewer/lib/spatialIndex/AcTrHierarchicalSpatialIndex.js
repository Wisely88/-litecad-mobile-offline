...
import { unionSpatialQueryItems, uniquifySpatialItemIds } from '../editor/view/AcEdSpatialQueryResult';
...
var AcTrHierarchicalSpatialIndex = /** @class */ (function () {
     ...
     */
    AcTrHierarchicalSpatialIndex.prototype.hasChildIndex = function (id) {
     ...
     */
    AcTrHierarchicalSpatialIndex.prototype.getRootById = function (id) {
        var _a;
        var root = this.rootIndex;
        return (_a = root.getById) === null || _a === void 0 ? void 0 : _a.call(root, id);
    };
    /**
     * Aggregates memory / cardinality stats from the root index and all children.
     */
    AcTrHierarchicalSpatialIndex.prototype.getStats = function () {
        var e_3, _a;
        var rootStats = this.rootIndex.getStats();
        var childItemCount = 0;
        var childBytes = 0;
        var rbushChildCount = 0;
        var linearChildCount = 0;
        try {
            for (var _b = __values(this.childIndexes.values()), _c = _b.next(); !_c.done; _c = _b.next()) {
                var child = _c.value;
                var childStats = child.getStats();
                childItemCount += childStats.itemCount;
                childBytes += childStats.estimatedBytes;
                if (childStats.kind === 'rbush')
                    rbushChildCount++;
                else if (childStats.kind === 'linear')
                    linearChildCount++;
            }
        }
        ...
        var childMapBytes = this.childIndexes.size * 64;
        return {
            kind: 'hierarchical',
            ...
            rbushChildCount: rbushChildCount,
            linearChildCount: linearChildCount
        };
    };
    /**
    ...
    AcTrHierarchicalSpatialIndex.prototype.ensureChildIndex = function (id, items) {
        var finiteItems = uniquifySpatialItemIds(items.filter(isFiniteSpatialBBox));
     ...
     */
    AcTrHierarchicalSpatialIndex.prototype.createIndexBySize = function (size) {
