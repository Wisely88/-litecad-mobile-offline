...
import { AcTrSpatialIndex, AcTrSpatialIndexBBox, AcTrSpatialIndexStats, AcTrSpatialSearchOptions } from './AcTrSpatialIndex';
/**
...
export declare class AcTrHierarchicalSpatialIndex implements AcTrSpatialIndex {
     ...
     */
    hasChildIndex(id: AcDbObjectId): boolean;
    /**
     ...
     */
    ensureChildIndex(id: AcDbObjectId, items: readonly AcEdSpatialQueryResultItem[]): AcTrSpatialIndex<AcEdSpatialQueryResultItem> | undefined;
    /**
