 ...
 */
export declare function estimateSpatialQueryItemBytes(item: AcEdSpatialQueryResultItem): number;
/**
 * Estimates total item payload bytes from a sample of spatial-query items.
 */
export declare function estimateSpatialItemsBytes(items: readonly AcEdSpatialQueryResultItem[], sampleSize?: number): number;
