...
import { AcDbCurve, AcGePoint3d, AcGeTol } from '@mlightcad/data-model';
import { AcApDocManager } from '../../app';
import { AcEdCommand, AcEdOpenMode, AcEdPreviewJig, AcEdPromptDistanceOptions, AcEdPromptDoubleResult, AcEdPromptEntityOptions, AcEdPromptEntityResult, AcEdPromptPointOptions, AcEdPromptPointResult, AcEdPromptStateMachine, AcEdPromptStatus } from '../../editor';
 ...
 */
function isOffsettableCurve(entity) {
 ...
 */
function buildOffsetCurves(curve, offsetDistance, sidePoint) {
    try {
        var side = curve.getOffsetSideAtPoint(sidePoint);
        var offsetCurves = curve.getOffsetCurves(offsetDistance * side);
        offsetCurves.forEach(function (offsetCurve) {
            return AcApEntityService.copyDisplayTraits(curve, offsetCurve);
        });
        return offsetCurves;
    }
    catch (_a) {
 ...
 */
var AcApOffsetPreviewJig = /** @class */ (function (_super) {
    __extends(AcApOffsetPreviewJig, _super);
    /**
     ...
     */
    function AcApOffsetPreviewJig(view, curve, distance) {
        var _this = _super.call(this, view) || this;
        _this._previewCurves = [];
        _this._renderedIds = [];
        _this._view = view;
        _this._curve = curve;
     ...
     */
    AcApOffsetPreviewJig.prototype.update = function (point) {
        this.clearRendered();
     ...
     */
    AcApOffsetPreviewJig.prototype.render = function () {
        if (this._previewCurves.length === 0)
            return;
        this._view.addTransientEntity(this._previewCurves);
        this._renderedIds = this._previewCurves.map(function (entity) { return entity.objectId; });
    };
    /**
     * Removes every transient preview curve from the view when the prompt ends.
     */
    AcApOffsetPreviewJig.prototype.end = function () {
        this.clearRendered();
    };
    /**
     ...
     */
    AcApOffsetPreviewJig.prototype.clearRendered = function () {
        var _this = this;
        this._renderedIds.forEach(function (id) { return _this._view.removeTransientEntity(id); });
        this._renderedIds = [];
    };
    return AcApOffsetPreviewJig;
}(AcEdPreviewJig));
/**
 ...
 */
var AcApOffsetCmd = /** @class */ (function (_super) {
    __extends(AcApOffsetCmd, _super);
    /**
     * Creates the OFFSET command. Drawing geometry may only be offset in Write mode.
     */
    function AcApOffsetCmd() {
     ...
     */
    AcApOffsetCmd.prototype.execute = function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var showCommandMessage, blockTable, offsetDistance, currentCurve, DistanceState, SelectCurveState, SidePointState, machine;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        showCommandMessage = function (message, type) {
                            if (type === void 0) { type = 'info'; }
                            _this.showMessage(message, type);
                        };
                        blockTable = context.doc.database.tables.blockTable;
                        DistanceState = /** @class */ (function () {
                            /**
                             * Creates the distance-entry state.
                             *
                             * @param machine - Parent state machine used to transition to selection.
                             */
                            function DistanceState(machine) {
                             ...
                             */
                            DistanceState.prototype.buildPrompt = function () {
                                var lastDistance = AcApOffsetCmd._lastDistance;
                                var prompt = new AcEdPromptDistanceOptions(AcApI18n.t('jig.offset.distance'));
                             ...
                             */
                            DistanceState.prototype.handleResult = function (result) {
                                if (!(result instanceof AcEdPromptDoubleResult))
                                    return 'finish';
                                ...
                                if (!Number.isFinite(result.value) ||
                                    ...
                                    showCommandMessage(AcApI18n.t('jig.offset.invalidDistance'), 'warning');
                                    return 'finish';
                                }
                        ...
                        SelectCurveState = /** @class */ (function () {
                             ...
                             */
                            SelectCurveState.prototype.buildPrompt = function () {
                                var prompt = new AcEdPromptEntityOptions(AcApI18n.t('jig.offset.selectObject'));
                                prompt.allowNone = true;
                             ...
                             */
                            SelectCurveState.prototype.handleResult = function (result) {
                                if (!(result instanceof AcEdPromptEntityResult))
                                    return 'finish';
                                ...
                                var entity = context.doc.database.openEntityForRead(result.objectId);
                                if (!isOffsettableCurve(entity)) {
                                    showCommandMessage(AcApI18n.t('jig.offset.invalidSelection'), 'warning');
                                    return 'continue';
                                }
                                currentCurve = entity;
                        ...
                        SidePointState = /** @class */ (function () {
                             ...
                             */
                            SidePointState.prototype.buildPrompt = function () {
                                var prompt = new AcEdPromptPointOptions(AcApI18n.t('jig.offset.sidePoint'));
                                prompt.allowNone = true;
                                prompt.disableOSnap = true;
                                if (currentCurve && offsetDistance != null) {
                                    var jig = new AcApOffsetPreviewJig(context.view, currentCurve, offsetDistance);
                                    jig.update(__assign(__assign({}, context.view.curPos), { z: 0 }));
                                    jig.render();
                                    prompt.jig = jig;
                                }
                                return prompt;
                             ...
                             */
                            SidePointState.prototype.handleResult = function (result) {
                                if (!(result instanceof AcEdPromptPointResult))
                                    return 'finish';
                                ...
                                var offsetCurves = buildOffsetCurves(currentCurve, offsetDistance, new AcGePoint3d(result.value));
    ...
    return AcApOffsetCmd;
}(AcEdCommand));
export { AcApOffsetCmd };
//# sourceMappingURL=AcApOffsetCmd.js.map