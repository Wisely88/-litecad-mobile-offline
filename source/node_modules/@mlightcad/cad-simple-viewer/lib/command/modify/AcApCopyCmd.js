...
import { AcEdCommand, AcEdOpenMode, AcEdPromptIntegerOptions, AcEdPromptKeywordOptions, AcEdPromptPointOptions, AcEdPromptStatus, scaleCopyDisplacement } from '../../editor';
...
var AcApCopyCmd = /** @class */ (function (_super) {
     ...
     */
    AcApCopyCmd.prototype.appendCopies = function (context, copies) {
        if (copies.length === 0) {
            return;
        }
    ...
    AcApCopyCmd.prototype.promptCopyMode = function (currentMode) {
        return __awaiter(this, void 0, void 0, function () {
            var prompt, defaultKeyword, result, keyword;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        prompt = new AcEdPromptKeywordOptions(AcApI18n.t('jig.copy.modePrompt'));
                        prompt.allowNone = true;
                        this.addKeyword(prompt, 'single');
                        this.addKeyword(prompt, 'multiple');
                        defaultKeyword = prompt.keywords.findByGlobalName(currentMode);
                        if (defaultKeyword) {
    ...
    AcApCopyCmd.prototype.executeCopyLoop = function (context_1, sourceEntities_1, basePoint_1, copyMode_1) {
        return __awaiter(this, arguments, void 0, function (context, sourceEntities, basePoint, copyMode, useDisplacementPrompt) {
            var pointPrompt, pointResult, copies, placement, copies;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!(pointResult.status === AcEdPromptStatus.Keyword &&
                            pointResult.stringResult === 'Array')) return [3 /*break*/, 3];
    ...
    AcApCopyCmd.prototype.execute = function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var selectionSet, resolved, sourceEntities, copyMode, basePoint, useDisplacementPrompt, pointPrompt, pointResult, keyword, modeResult;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        sourceEntities = resolved.entities
                            .map(function (entity) { return context.doc.database.openEntityForRead(entity.objectId); })
                            .filter(function (entity) { return !!entity; });
                    ...
                    case 3:
                        ...
                        keyword = (_a = pointResult.stringResult) !== null && _a !== void 0 ? _a : '';
                    ...
                    case 4:
                        ...
                        return [3 /*break*/, 2];
                    case 5: return [4 /*yield*/, this.executeCopyLoop(context, sourceEntities, basePoint, copyMode, useDisplacementPrompt)];
                    case 6:
                        _b.sent();
                        selectionSet.clear();
                        return [2 /*return*/];
