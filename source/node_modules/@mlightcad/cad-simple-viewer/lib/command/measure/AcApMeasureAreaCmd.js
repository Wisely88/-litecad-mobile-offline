...
import { acapColorToCssAlpha, acapCssColor, acapGetCurrentMeasurementStyle, acapGetMeasurementColor, acapMeasurementCanvasLineWidth, formatMeasurementArea } from '../../util';
import { acapOverlayDash, acapScaledOverlayLineWidth, acapSyncLiveOverlayTextHeight } from '../overlay/AcApOverlayDrawUtil';
...
var AcApMeasureAreaJig = /** @class */ (function (_super) {
    ...
    function AcApMeasureAreaJig(view, _from, _color, onMove) {
 ...
 */
export function placeAreaMeasurement(view, db, points, style, options) {
    if (points.length < 3)
        return;
...
var AcApMeasureAreaCmd = /** @class */ (function (_super) {
    ...
    AcApMeasureAreaCmd.prototype.execute = function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var editor, db, color, style, canvasLineWidth, points, fillOverlay, fillCanvas, htManagerLive, liveBadgeId, liveBadge, drawPolygon, redrawOnViewChange, cleanupLive;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        points = [];
                        fillOverlay = new AcTrHtmlCanvasOverlay({
                            id: "live-area-canvas-".concat(Date.now()),
                            container: context.view.container,
                            layer: MEASUREMENT_LIVE_LAYER,
                            layoutId: context.view.activeLayoutBtrId
                        });
                        fillCanvas = fillOverlay.canvas;
                        htManagerLive = context.view.htmlTransientManager;
                        htManagerLive.add(fillOverlay);
                        liveBadgeId = "live-area-badge-".concat(Date.now());
                        ...
                        drawPolygon = function (cursor) {
                            ...
                            if (confirmedSpts.length >= 2) {
                                ...
                                var strokeWidth = acapScaledOverlayLineWidth(canvasLineWidth, fillCanvas, context.view);
                            ...
                            if (cursor && confirmedSpts.length >= 1) {
                                var last = confirmedSpts[confirmedSpts.length - 1];
                                var sc = context.view.worldToScreen(cursor);
                                ctx.beginPath();
                                ctx.moveTo(last.x, last.y);
                                ctx.lineTo(sc.x, sc.y);
                                ctx.strokeStyle = acapCssColor(color);
                                ctx.lineWidth = acapScaledOverlayLineWidth(canvasLineWidth, fillCanvas, context.view);
                                ctx.stroke();
                            }
                            ctx.restore();
                        };
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.withMeasureInput(context, function () { return __awaiter(_this, void 0, void 0, function () {
                                var p1Result, p1, _loop_1, state_1, _a;
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0: return [4 /*yield*/, editor.getPoint(new AcEdPromptPointOptions(AcApI18n.t('jig.measureArea.firstPoint')))];
                                        case 1:
                                            p1Result = _b.sent();
                                                    ...
                                                    switch (_c.label) {
                                                        case 0:
                                                            ...
                                                            onMove = function (cursor) {
                                                                ...
                                                                var liveStyle = acapGetCurrentMeasurementStyle(db);
                    ...
                    case 4:
                        if (points.length < 3)
                            return [2 /*return*/];
                        placeAreaMeasurement(context.view, db, points, acapGetCurrentMeasurementStyle(db));
                        return [2 /*return*/];
                }
            });
        });
