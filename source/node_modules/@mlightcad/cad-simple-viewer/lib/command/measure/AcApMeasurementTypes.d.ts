...
export type AcApMeasurementType = 'distance' | 'angle' | 'area' | 'arc' | 'point';
...
export type AcApMeasurementGeometry = AcApMeasurementDistanceGeometry | AcApMeasurementAngleGeometry | AcApMeasurementAreaGeometry | AcApMeasurementArcGeometry | AcApMeasurementPointGeometry;
...
//# sourceMappingURL=AcApMeasurementTypes.d.ts.map