 ...
 */
export function registerMeasureCommands(addSystemCommand, installCtx) {
    acapInstallDrawStyleSessionAccessory(installCtx);
    addSystemCommand('measuredistance', 'measuredistance', new AcApMeasureDistanceCmd());
    addSystemCommand('measurecontinuous', 'measurecontinuous', new AcApMeasureContinuousCmd());
...
//# sourceMappingURL=AcApRegisterMeasureCommands.js.map