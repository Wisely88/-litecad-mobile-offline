...
import { AcDbEllipse, AcGePoint3d, AcGeTol, TAU } from '@mlightcad/data-model';
import { AcApDocManager } from '../../app';
import { AcEdCommand, AcEdOpenMode, AcEdPreviewJig, AcEdPromptAngleOptions, AcEdPromptDoubleOptions, AcEdPromptPointOptions, AcEdPromptStatus } from '../../editor';
...
function buildEllipseDefinition(center, firstAxisUnit, firstAxisRadius, secondAxisRadius, startAngle, endAngle) {
    ...
    var normalizedAngles = normalizeFullEllipseAngles(startAngle, endAngle);
...
function normalizeFullEllipseAngles(startAngle, endAngle) {
...
var AcApEllipseCmd = /** @class */ (function (_super) {
    ...
    AcApEllipseCmd.prototype.warnInvalidInput = function (key) {
        this.notify(AcApI18n.t("jig.ellipse.invalid.".concat(key)), 'warning');
    };
    /**
