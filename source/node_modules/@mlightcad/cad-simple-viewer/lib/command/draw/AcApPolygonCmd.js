            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        sidesPrompt = new AcEdPromptStringOptions(AcApI18n.t('jig.polygon.numberOfSides'));
