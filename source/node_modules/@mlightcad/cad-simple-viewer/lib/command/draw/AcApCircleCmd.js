...
import { AcDbCircle, AcGeCircArc2d, AcGePoint3d } from '@mlightcad/data-model';
...
function toCircleDefinition(arc) {
    if (!arc)
        return undefined;
    return {
...
function createCircleFromTwoPoints(first, second) {
    return toCircleDefinition(AcGeCircArc2d.tryCreateCircleByDiameter(first, second));
}
function createCircleFromThreePoints(p1, p2, p3) {
    return toCircleDefinition(AcGeCircArc2d.tryCreateCircleByThreePoints(p1, p2, p3));
}
/**
