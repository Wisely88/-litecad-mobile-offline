...
var AcApHatchCmd = /** @class */ (function (_super) {
    ...
    AcApHatchCmd.prototype.buildLoopInfos = function (loops) {
        ...
        loops.forEach(function (loop) {
            var points = loop.tessellate().map(function (p) { return ({ x: p.x, y: p.y }); });
            if (points.length < 3)
                return;
            infos.push({
                loop: loop,
    ...
    AcApHatchCmd.prototype.promptStyle = function () {
        return __awaiter(this, void 0, void 0, function () {
            var settings, current, options, normal, outer, ignore, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        settings = this.getActiveSettings();
                        current = this.styleToKeyword(settings.style);
                        options = new AcEdPromptKeywordOptions(AcApI18n.t('jig.hatch.style'));
                        options.allowNone = true;
                        normal = options.keywords.add(AcApI18n.t('jig.hatch.keywords.normal.display'), AcApI18n.t('jig.hatch.keywords.normal.global'), AcApI18n.t('jig.hatch.keywords.normal.local'));
                        outer = options.keywords.add(AcApI18n.t('jig.hatch.keywords.outer.display'), AcApI18n.t('jig.hatch.keywords.outer.global'), AcApI18n.t('jig.hatch.keywords.outer.local'));
                        ignore = options.keywords.add(AcApI18n.t('jig.hatch.keywords.ignore.display'), AcApI18n.t('jig.hatch.keywords.ignore.global'), AcApI18n.t('jig.hatch.keywords.ignore.local'));
    ...
    AcApHatchCmd.prototype.promptAssociative = function () {
        return __awaiter(this, void 0, void 0, function () {
            var settings, options, yes, no, result, associative;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        settings = this.getActiveSettings();
                        options = new AcEdPromptKeywordOptions(AcApI18n.t('jig.hatch.associative'));
                        options.allowNone = true;
                        yes = options.keywords.add(AcApI18n.t('jig.hatch.keywords.yes.display'), AcApI18n.t('jig.hatch.keywords.yes.global'), AcApI18n.t('jig.hatch.keywords.yes.local'));
                        no = options.keywords.add(AcApI18n.t('jig.hatch.keywords.no.display'), AcApI18n.t('jig.hatch.keywords.no.global'), AcApI18n.t('jig.hatch.keywords.no.local'));
