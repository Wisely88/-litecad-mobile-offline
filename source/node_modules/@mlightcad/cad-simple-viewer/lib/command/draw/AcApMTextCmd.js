...
var AcApMTextCmd = /** @class */ (function (_super) {
    ...
    AcApMTextCmd.prototype.execute = function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var boxPrompt, boxResult, box, width, view, textHeight, location, availableFonts, toolbarFontFamilies, result, contents, mtext;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, AcApDocManager.instance.getAvaiableFonts()];
                    case 2:
                        availableFonts = (_a = (_b.sent())) !== null && _a !== void 0 ? _a : [];
                        toolbarFontFamilies = Array.from(new Set(availableFonts
