...
export type AcApMarkupType = 'text' | 'line' | 'arrow' | 'cloud' | 'rect' | 'circle' | 'highlight' | 'callout' | 'stamp' | 'symbol';
...
export type AcApMarkupGeometry = AcApMarkupTextGeometry | AcApMarkupLineGeometry | AcApMarkupArrowGeometry | AcApMarkupCloudGeometry | AcApMarkupRectGeometry | AcApMarkupCircleGeometry | AcApMarkupHighlightGeometry | AcApMarkupCalloutGeometry | AcApMarkupStampGeometry | AcApMarkupSymbolGeometry;
...
//# sourceMappingURL=AcApMarkupTypes.d.ts.map