 ...
 */
export declare class AcEdSessionAccessoryMountSkippedError extends Error {
...
export declare abstract class AcEdCommand<TUserData extends object = {}> {
     ...
     */
    protected showMessage(message: string, type?: AcEdMessageType, msgKey?: string): void;
    /**
     ...
     * @param type - Message severity controlling the rendered style
     */
    protected notify(message: string, type?: AcEdMessageType): void;
    /**
     ...
     * @param message - Optional message displayed under the spinner
     */
    protected withBusyIndicator<T>(work: () => T | Promise<T>, message?: string): Promise<T>;
}
