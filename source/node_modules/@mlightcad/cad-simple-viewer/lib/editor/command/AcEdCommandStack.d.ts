...
export declare class AcEdCommandStack {
     ...
     */
    markActive(command: AcEdCommand, view: AcEdBaseView, promise: Promise<void>): void;
    /**
     ...
     */
    runActive(command: AcEdCommand, view: AcEdBaseView, work: () => Promise<void>): Promise<void>;
    /**
     ...
     */
    clearActive(command: AcEdCommand): void;
    /**
