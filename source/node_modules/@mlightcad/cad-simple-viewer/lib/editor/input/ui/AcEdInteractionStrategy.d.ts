...
export interface AcEdBoxPromptHost {
    ...
    acquireTwoPointBox(options: AcEdPromptBoxOptions): Promise<AcEdPromptBoxResult>;
    /**
     * Phone/pad: long-press + drag (touch) or click-drag / two clicks (mouse).
     */
    acquireHoldDragBox(options: AcEdPromptBoxOptions): Promise<AcEdPromptBoxResult>;
}
/**
...
export interface AcEdInteractionStrategy {
    ...
    acquireBox(host: AcEdBoxPromptHost, options: AcEdPromptBoxOptions): Promise<AcEdPromptBoxResult>;
...
export declare class AcEdDesktopInteractionStrategy implements AcEdInteractionStrategy {
    readonly point: AcEdPointPromptPolicy;
    canIdleTouchBox(mode: AcEdViewMode): boolean;
    acquireBox(host: AcEdBoxPromptHost, options: AcEdPromptBoxOptions): Promise<AcEdPromptBoxResult>;
}
 ...
 */
export declare class AcEdMobileInteractionStrategy implements AcEdInteractionStrategy {
    readonly point: AcEdPointPromptPolicy;
    canIdleTouchBox(mode: AcEdViewMode): boolean;
    acquireBox(host: AcEdBoxPromptHost, options: AcEdPromptBoxOptions): Promise<AcEdPromptBoxResult>;
}
 ...
 */
export declare function acedInteractionStrategy(): AcEdInteractionStrategy;
//# sourceMappingURL=AcEdInteractionStrategy.d.ts.map