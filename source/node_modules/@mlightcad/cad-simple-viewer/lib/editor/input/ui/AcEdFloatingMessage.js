...
var AcEdFloatingMessage = /** @class */ (function () {
    ...
    function AcEdFloatingMessage(view, options) {
        ...
        var message = (_b = options.message) !== null && _b !== void 0 ? _b : '';
        ...
        this.boundOnSysVarChanged = function (args) {
            var _a;
            var name = (_a = args.name) === null || _a === void 0 ? void 0 : _a.toLowerCase();
            if (name === AcDbSystemVariables.DYNMODE.toLowerCase() ||
                name === AcDbSystemVariables.DYNPROMPT.toLowerCase()) {
                _this.updateDynamicDisplay();
            }
        };
        AcDbSysVarManager.instance().events.sysVarChanged.addEventListener(this.boundOnSysVarChanged);
    ...
    AcEdFloatingMessage.prototype.dispose = function () {
        ...
        AcDbSysVarManager.instance().events.sysVarChanged.removeEventListener(this.boundOnSysVarChanged);
    ...
    // ---------------------------------------------------------------------------
    AcEdFloatingMessage.prototype.getSysVarValue = function (name) {
        var db = acdbHostApplicationServices().workingDatabase;
        return AcDbSysVarManager.instance().getVar(name, db);
    };
    AcEdFloatingMessage.prototype.isDynamicInputEnabled = function () {
        return acedIsDynamicInputEnabled();
    };
    AcEdFloatingMessage.prototype.isDynamicPromptEnabled = function () {
        return !!this.getSysVarValue(AcDbSystemVariables.DYNPROMPT);
    };
    AcEdFloatingMessage.prototype.shouldShowPrompt = function () {
        var _a;
        var hasMessage = !!((_a = this.label.textContent) === null || _a === void 0 ? void 0 : _a.trim());
        if (!hasMessage)
            return false;
        if (!this.allowPrompt)
            return false;
        if (!this.isDynamicInputEnabled())
            return false;
        if (!this.isDynamicPromptEnabled())
            return false;
        return true;
    };
    AcEdFloatingMessage.prototype.updateDynamicDisplay = function () {
        if (!this.shouldShowPrompt()) {
            this.hide();
            return;
        }
