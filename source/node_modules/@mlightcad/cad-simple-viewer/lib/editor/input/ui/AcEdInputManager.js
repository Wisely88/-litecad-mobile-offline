...
var AcEdInputManager = /** @class */ (function () {
     ...
     */
    AcEdInputManager.prototype.cancelActiveInput = function () {
        var rejector = this._activeRejector;
        if (!rejector)
            return;
        this._activeRejector = null;
        rejector();
    ...
    AcEdInputManager.prototype.hasScriptInputs = function () {
     ...
     */
    AcEdInputManager.prototype.drainScriptInputs = function () {
    ...
    AcEdInputManager.prototype.formatNumber = function (value, type) {
        var _a;
        var db = (_a = AcApDocManager.instance.curDocument) === null || _a === void 0 ? void 0 : _a.database;
        if (!db) {
            switch (type) {
                case 'angle':
     ...
     */
    AcEdInputManager.prototype.startPromptInputSession = function (options, handler, inputCount, allowTyping) {
        var _this = this;
        var keywordOptions = this.buildKeywordOptions(options);
        var allowNone = 'allowNone' in options
            ? options.allowNone
            : false;
        return {
            promise: this._commandLine.getPromptInput(keywordOptions, function (text) { return _this.parseCommandLineInput(text, handler, inputCount, options); }, {
     ...
     */
    AcEdInputManager.prototype.resolvePromptInputMode = function (handler) {
     ...
     */
    AcEdInputManager.prototype.resolvePointInputContext = function (promptOptions) {
        var _a;
        var promptDefaults = this.resolvePromptDefaults(promptOptions);
        var referencePoint = promptDefaults.useBasePoint && promptDefaults.basePoint
            ? promptDefaults.basePoint
            : ((_a = this.lastPoint) !== null && _a !== void 0 ? _a : undefined);
        return {
            referencePoint: referencePoint,
            cursorPoint: this.view.screenToWorld(this.view.viewportToCanvas(this.view.curMousePos))
        };
    };
    /**
     * Parses one command-line token into the value expected by the active prompt.
     */
    AcEdInputManager.prototype.parseCommandLineInput = function (text, handler, inputCount, promptOptions) {
        var trimmed = text.trim();
        if (!trimmed)
            return null;
        var pointContext = handler instanceof AcEdPointHandler || inputCount === 2
     ...
     */
    AcEdInputManager.prototype.resolveDistanceBasePoint = function (options) {
     ...
     */
    AcEdInputManager.prototype.createDistanceDynamicValue = function (basePoint) {
        var _this = this;
        return function (pos) {
     ...
     */
    AcEdInputManager.prototype.getDistanceTwoPoint = function (options, handler) {
        return __awaiter(this, void 0, void 0, function () {
            var firstPoint, floatingInput, getDynamicValue;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        getDynamicValue = function (pos) {
                            ...
                            return _this.createDistanceDynamicValue(firstPoint)(pos);
                        };
                        return [4 /*yield*/, this.makeFloatingInputPromise({
                                ...
                                handler: handler,
                                getDynamicValue: getDynamicValue,
                                onFloatingInputCreated: function (input) {
                                    floatingInput = input;
                                },
                                onCommit: function (_val, pos) {
                                    if (firstPoint) {
                                        return true;
                                    }
                                    if (pos) {
                ...
                return [2 /*return*/, this.executePrompt(function () { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1: return [2 /*return*/, _a.sent()];
                                case 2: return [4 /*yield*/, this.getDistanceTwoPoint(options, handler)];
    ...
    AcEdInputManager.prototype.getInteger = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            var _this = this;
            return __generator(this, function (_a) {
                scriptedValue = this.tryGetScriptedNumber(new AcEdIntegerHandler(options), options);
                if (scriptedValue != null) {
    ...
    AcEdInputManager.prototype.getString = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            var _this = this;
            return __generator(this, function (_a) {
                scriptedValue = this.tryGetScriptedValue(new AcEdStringHandler(options), options);
                if (scriptedValue != null) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.executePrompt(function () { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        var _this = this;
                        return __generator(this, function (_a) {
                            scriptedValue = this.tryGetScriptedValue(new AcEdKeywordHandler(options), options);
                            if (scriptedValue != null) {
                ...
                return [2 /*return*/, this.executePrompt(function () {
                        return new Promise(function (resolve, reject) {
                            ...
                            var cleanup = function () {
                                ...
                                document.removeEventListener('keydown', keyHandler);
                                _this.view.canvas.removeEventListener('mousedown', mouseDownHandler);
                                _this.view.canvas.removeEventListener('click', clickHandler);
                                _this.view.canvas.removeEventListener('contextmenu', contextMenuHandler);
                                floatingMessage === null || floatingMessage === void 0 ? void 0 : floatingMessage.dispose();
                                keywordSession === null || keywordSession === void 0 ? void 0 : keywordSession.cancel();
                                _this._commandLine.clear();
                            ...
                            document.addEventListener('keydown', keyHandler);
                            _this.view.canvas.addEventListener('mousedown', mouseDownHandler);
                            _this.view.canvas.addEventListener('click', clickHandler);
                            _this.view.canvas.addEventListener('contextmenu', contextMenuHandler);
                        });
                    }, function (value) {
    ...
    AcEdInputManager.prototype.tryGetScriptedPoint = function (options) {
        ...
        var value = handler.parseCommandLine(token, this.resolvePointInputContext(options));
        if (value != null) {
     ...
     */
    AcEdInputManager.prototype.tryResolveScriptedKeyword = function (token, options) {
        if (!token || !(options === null || options === void 0 ? void 0 : options.keywords))
            return;
        var keyword = options.keywords.findByName(token);
        if (keyword) {
     ...
     */
    AcEdInputManager.prototype.tryGetScriptedValue = function (handler, options) {
        var token = this.dequeueScriptInput();
        if (token === undefined)
            return undefined;
        var trimmed = token.trim();
        ...
        if (handler instanceof AcEdStringHandler) {
            this.tryResolveScriptedKeyword(trimmed, options);
            var stringValue = handler.parse(token);
            if (stringValue != null)
                return stringValue;
            throw new Error("Invalid scripted input '".concat(token, "'"));
        }
        var value = this.parseCommandLineInput(token, handler, handler instanceof AcEdPointHandler ? 2 : 1, (options !== null && options !== void 0 ? options : new AcEdPromptOptions('')));
        if (value != null) {
            return value;
        }
        this.tryResolveScriptedKeyword(trimmed, options);
     ...
     */
    AcEdInputManager.prototype.tryGetScriptedNumber = function (handler, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        var promptInputSession = _this.startPromptInputSession(options.promptOptions, options.handler, (_a = options.inputCount) !== null && _a !== void 0 ? _a : 1, true);
                        var basePoint = undefined;
                        if (promptDefaults.useBasePoint && promptDefaults.basePoint) {
                            basePoint = promptDefaults.basePoint;
                        }
                        var orthoReferencePoint = promptDefaults.useBasePoint && promptDefaults.basePoint
                            ? promptDefaults.basePoint
                            : ((_b = _this.lastPoint) !== null && _b !== void 0 ? _b : undefined);
                        ...
                        var floatingInput = new AcEdFloatingInput(_this.view, {
                            ...
                            basePoint: basePoint,
                            orthoReferencePoint: orthoReferencePoint,
                                ...
                                case 'value':
                                    if (options.handler instanceof AcEdPointHandler) {
                                        ...
                                        if (point &&
                                            ...
                                            _this.lastPoint = { x: point.x, y: point.y };
                                        }
                                    }
