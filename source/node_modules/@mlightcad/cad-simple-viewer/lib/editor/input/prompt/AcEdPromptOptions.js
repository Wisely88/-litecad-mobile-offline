...
var AcEdPromptOptions = /** @class */ (function () {
     ...
     */
    function AcEdPromptOptions(message, globalKeywords) {
        this._message = '';
     ...
     */
    AcEdPromptOptions.prototype.getDefaultValueDisplayText = function () {
        return undefined;
    };
    /**
     ...
     */
    AcEdPromptOptions.prototype.getDisplayMessage = function () {
        var defaultText = this.getDefaultValueDisplayText();
        if (defaultText == null) {
            return this._message;
        }
        var core = this._message.trim().replace(/[：:]\s*$/, '');
        return "".concat(core, " <").concat(defaultText, ">");
    };
