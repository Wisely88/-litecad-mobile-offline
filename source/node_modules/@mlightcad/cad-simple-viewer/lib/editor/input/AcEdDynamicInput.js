 ...
 */
export function acedIsDynamicInputEnabled(database) {
    if (!acedInteractionStrategy().point.showsCursorDynamicInput)
        return false;
    var db = database !== null && database !== void 0 ? database : acdbHostApplicationServices().workingDatabase;
    var mode = Number(AcDbSysVarManager.instance().getVar(AcDbSystemVariables.DYNMODE, db));
    return mode !== 0;
}
//# sourceMappingURL=AcEdDynamicInput.js.map