...
var AcEditor = /** @class */ (function () {
     ...
     * command runs.
     */
    AcEditor.prototype.cancelActiveInput = function () {
     ...
     */
    AcEditor.prototype.showMessage = function (message, type, msgKey) {
     ...
     */
    AcEditor.prototype.syncCursorBackground = function (backgroundColor) {
     ...
     */
    AcEditor.prototype.getKeywords = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._inputManager.getKeywords(options)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
     ...
     * @returns Promise that resolves to the input one keyword.
     */
    AcEditor.prototype.getEntity = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._inputManager.getEntity(options)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
     ...
     */
    AcEditor.prototype.getSelection = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._inputManager.getSelection(options)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
