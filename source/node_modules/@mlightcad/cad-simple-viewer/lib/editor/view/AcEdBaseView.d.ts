...
export declare abstract class AcEdBaseView {
     ...
     */
    abstract search(box: AcGeBox2d | AcGeBox3d, options?: AcTrSpatialSearchOptions): AcEdSpatialQueryResultItemEx[];
    /**
     ...
     * the hit-region.
     */
    abstract pick(point?: AcGePoint2dLike, hitRadius?: number, pickOneOnly?: boolean): AcEdSpatialQueryResultItemEx[];
    /**
     ...
     */
    abstract updateLayer(layer: AcDbLayerTableRecord, changes: Partial<AcDbLayerTableRecordAttrs>): void;
    /**
     ...
     */
    abstract updateTransientPreviewTransforms(transforms: ReadonlyArray<{
     ...
     * ```
     */
    withMode<T>(mode: AcEdViewMode, action: () => Promise<T> | T): Promise<T>;
    /**
     ...
     */
    getSelectionMode(startCanvas: AcGePoint2dLike, endCanvas: AcGePoint2dLike): AcEdSelectionMode;
    /**
     * Returns the selection action based on modifier keys.
     * Shift: remove, Ctrl/Cmd: add, default: replace.
     */
    getSelectionActionFromEvent(e: MouseEvent, defaultAction?: AcEdSelectionAction): AcEdSelectionAction;
    /**
     * Determine whether a drag is effectively a click.
     */
    isSelectionClick(startCanvas: AcGePoint2dLike, endCanvas: AcGePoint2dLike, threshold?: number): boolean;
    /**
     * Returns preview styles for selection rectangle.
     */
    getSelectionPreviewStyle(mode: AcEdSelectionMode, action: AcEdSelectionAction): {
        borderStyle: string;
        lineColor: string;
        background: string;
    };
     ...
     */
    applySelection(ids: AcDbObjectId[], action: AcEdSelectionAction): void;
    /**
