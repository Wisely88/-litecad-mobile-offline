...
export declare class AcApPluginManager {
     ...
     */
    setContext(context: AcApContext): void;
    /**
     ...
     */
    loadByTrigger(trigger: string): Promise<boolean>;
    /**
