...
var AcApPluginManager = /** @class */ (function () {
    ...
    Object.defineProperty(AcApPluginManager.prototype, "context", {
        /**
     ...
     */
    AcApPluginManager.prototype.setContext = function (context) {
        this._context = context;
    };
    /**
     ...
     */
    AcApPluginManager.prototype.registerLazyPlugin = function (registration) {
        var e_1, _a;
        var pluginName = registration.name;
        if (!pluginName) {
            throw new Error('[AcApPluginManager] Lazy plugin name is required');
        }
        if (this._lazyRegistrations.has(pluginName)) {
            throw new Error("[AcApPluginManager] Lazy plugin '".concat(pluginName, "' is already registered"));
        }
        if (!registration.triggers.length) {
            throw new Error("[AcApPluginManager] Lazy plugin '".concat(pluginName, "' requires at least one trigger"));
        }
        this._lazyRegistrations.set(pluginName, registration);
        try {
            for (var _b = __values(registration.triggers), _c = _b.next(); !_c.done; _c = _b.next()) {
                var trigger = _c.value;
                var normalizedTrigger = trigger.trim().toUpperCase();
                if (!normalizedTrigger) {
                    continue;
                }
                if (this._triggerToPluginName.has(normalizedTrigger)) {
                    throw new Error("[AcApPluginManager] Trigger '".concat(trigger, "' is already registered to lazy plugin '").concat(this._triggerToPluginName.get(normalizedTrigger), "'"));
                }
     ...
     */
    AcApPluginManager.prototype.isLazyPluginTrigger = function (trigger) {
     ...
     */
    AcApPluginManager.prototype.getLazyPluginTriggers = function () {
     ...
     */
    AcApPluginManager.prototype.loadByTrigger = function (trigger) {
        return __awaiter(this, void 0, void 0, function () {
            var normalizedTrigger, pluginName, inFlight, registration, loadPromise;
            var _this = this;
            return __generator(this, function (_a) {
                normalizedTrigger = trigger.trim().toUpperCase();
                pluginName = this._triggerToPluginName.get(normalizedTrigger);
                if (!pluginName) {
                ...
                inFlight = this._lazyLoadPromises.get(pluginName);
                if (inFlight) {
                    return [2 /*return*/, inFlight];
                }
                registration = this._lazyRegistrations.get(pluginName);
                if (!registration) {
                    return [2 /*return*/, false];
                }
                loadPromise = (function () { return __awaiter(_this, void 0, void 0, function () {
                    var plugin, error_2;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                _a.trys.push([0, 4, 5, 6]);
                                return [4 /*yield*/, registration.loader()];
                            case 1:
                                plugin = _a.sent();
                                if (plugin.name !== pluginName) {
                                    throw new Error("[AcApPluginManager] Lazy plugin '".concat(pluginName, "' loader returned plugin '").concat(plugin.name, "'"));
                                }
                                if (!!this.isPluginLoaded(pluginName)) return [3 /*break*/, 3];
                            ...
                            case 4:
                                error_2 = _a.sent();
                                log.error("[AcApPluginManager] Failed to load lazy plugin '".concat(pluginName, "' for trigger '").concat(trigger, "':"), error_2);
                                return [2 /*return*/, false];
                            case 5:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_3 = _a.sent();
                        log.error("[AcApPluginManager] Error unloading plugin '".concat(pluginName, "':"), error_3);
                        return [3 /*break*/, 4];
                    case 4:
    ...
    AcApPluginManager.prototype.unloadAllPlugins = function () {
        return __awaiter(this, void 0, void 0, function () {
            var pluginNames, pluginNames_1, pluginNames_1_1, pluginName, e_2_1;
            var e_2, _a;
    ...
    AcApPluginManager.prototype.loadPluginsFromConfig = function (plugins, options) {
        return __awaiter(this, void 0, void 0, function () {
            var continueOnError, loaded, failed, plugins_1, plugins_1_1, pluginOrFactory, plugin, error_4, pluginName, err, e_3_1;
            var e_3, _a;
            var _b;
    ...
    AcApPluginManager.prototype.loadPluginsFromFolder = function (folderPath, options) {
        return __awaiter(this, void 0, void 0, function () {
            var continueOnError, pluginList, loaded, failed, normalizedPath, basePath, pluginList_1, pluginList_1_1, pluginFile, importPath, module_1, pluginExport, className, fileName, exportName, plugin, error_5, err, e_4_1;
            var e_4, _a;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        if (pluginList.length === 0) {
                            log.warn('[AcApPluginManager] No plugin list provided. Cannot load plugins from folder without a list of files.');
