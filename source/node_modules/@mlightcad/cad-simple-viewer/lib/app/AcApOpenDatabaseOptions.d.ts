import { AcCmColor, AcDbOpenDatabaseOptions } from '@mlightcad/data-model';
import { AcEdOpenMode } from '../editor/view';
/**
 * Controls how the view is framed immediately after a document opens.
 */
export declare enum AcApOpenViewMode {
 ...
 */
export type AcApOpenSysVars = Record<string, number | boolean | string | AcCmColor>;
/**
 ...
 * ```
 */
export interface AcApOpenDatabaseOptions extends Omit<AcDbOpenDatabaseOptions, 'readOnly' | 'sysVars'> {
    /**
...
//# sourceMappingURL=AcApOpenDatabaseOptions.d.ts.map