...
export var MLIGHTCAD_ICON_SVG = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" aria-hidden="true">' +
...
export var MLIGHTCAD_BRAND_NAME = 'mlightcad';
/** Marketing / demo site. */
export var MLIGHTCAD_WEBSITE_URL = 'https://mlightcad.github.io/cad-viewer/';
/** User-guide / docs site root (localized pages live under this base). */
export var MLIGHTCAD_DOCS_URL = 'https://mlightcad.com/cad-viewer/docs/';
/** Source repository. */
export var MLIGHTCAD_REPO_URL = 'https://github.com/mlightcad/cad-viewer';
/**
...
export function acapCreateMlightcadIcon(options) {
    ...
    icon.className = (_a = options === null || options === void 0 ? void 0 : options.className) !== null && _a !== void 0 ? _a : 'ml-brand-mark-icon';
    icon.setAttribute('role', 'img');
    icon.setAttribute('aria-label', MLIGHTCAD_BRAND_NAME);
    icon.innerHTML = MLIGHTCAD_ICON_SVG;
    var size = (_b = options === null || options === void 0 ? void 0 : options.size) !== null && _b !== void 0 ? _b : '40px';
...
export function acapCreateMlightcadBrandMark(options) {
    ...
    root.className = (_a = options === null || options === void 0 ? void 0 : options.className) !== null && _a !== void 0 ? _a : 'ml-brand-mark';
    root.setAttribute('role', 'img');
    root.setAttribute('aria-label', MLIGHTCAD_BRAND_NAME);
    var icon = acapCreateMlightcadIcon({
        className: 'ml-brand-mark-icon',
        size: (_b = options === null || options === void 0 ? void 0 : options.iconSize) !== null && _b !== void 0 ? _b : '40px'
    });
...
//# sourceMappingURL=AcApBrand.js.map