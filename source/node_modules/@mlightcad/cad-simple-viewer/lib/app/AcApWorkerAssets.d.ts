 ...
 */
export declare const LIBREDWG_PARSER_WORKER_FILE = "libredwg-parser-worker.js";
/**
 * LibreDWG wasm sibling of {@link LIBREDWG_PARSER_WORKER_FILE}.
 * Must be deployed next to the worker (wasm is not inlined).
 */
export declare const LIBREDWG_PARSER_WASM_FILE = "libredwg-web.wasm";
/** MTEXT layout/shaping worker from `@mlightcad/mtext-renderer`. */
export declare const MTEXT_RENDERER_WORKER_FILE = "mtext-renderer-worker.js";
/**
 ...
 */
export declare const DWG_PARSER_WORKER_FILE = "dwg-parser-worker.js";
/**
 ...
 */
export declare const DWG_PARSER_MAIN_FILE = "dwg-parser-main.js";
/** npm package that ships {@link LIBREDWG_PARSER_WORKER_FILE}. */
export declare const LIBREDWG_CONVERTER_PACKAGE = "@mlightcad/libredwg-converter";
/** npm package that ships {@link MTEXT_RENDERER_WORKER_FILE}. */
export declare const MTEXT_RENDERER_PACKAGE = "@mlightcad/mtext-renderer";
/** Private npm package that ships {@link DWG_PARSER_WORKER_FILE} / {@link DWG_PARSER_MAIN_FILE}. */
export declare const DWG_CONVERTER_PACKAGE = "@mlight-cad/dwg-converter";
//# sourceMappingURL=AcApWorkerAssets.d.ts.map