 ...
 */
export var LIBREDWG_PARSER_WORKER_FILE = 'libredwg-parser-worker.js';
/**
 * LibreDWG wasm sibling of {@link LIBREDWG_PARSER_WORKER_FILE}.
 * Must be deployed next to the worker (wasm is not inlined).
 */
export var LIBREDWG_PARSER_WASM_FILE = 'libredwg-web.wasm';
/** MTEXT layout/shaping worker from `@mlightcad/mtext-renderer`. */
export var MTEXT_RENDERER_WORKER_FILE = 'mtext-renderer-worker.js';
/**
 ...
 */
export var DWG_PARSER_WORKER_FILE = 'dwg-parser-worker.js';
/**
 ...
 */
export var DWG_PARSER_MAIN_FILE = 'dwg-parser-main.js';
/** npm package that ships {@link LIBREDWG_PARSER_WORKER_FILE}. */
export var LIBREDWG_CONVERTER_PACKAGE = '@mlightcad/libredwg-converter';
/** npm package that ships {@link MTEXT_RENDERER_WORKER_FILE}. */
export var MTEXT_RENDERER_PACKAGE = '@mlightcad/mtext-renderer';
/** Private npm package that ships {@link DWG_PARSER_WORKER_FILE} / {@link DWG_PARSER_MAIN_FILE}. */
export var DWG_CONVERTER_PACKAGE = '@mlight-cad/dwg-converter';
//# sourceMappingURL=AcApWorkerAssets.js.map