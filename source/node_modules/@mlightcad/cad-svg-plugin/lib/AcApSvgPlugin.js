 ...
 */
var AcApSvgPlugin = /** @class */ (function () {
    function AcApSvgPlugin() {
        /** @inheritdoc */
        this.name = 'SvgPlugin';
        /** @inheritdoc */
        this.version = packageJson.version;
        /** @inheritdoc */
        this.description = 'SVG export (csvg) command';
     ...
     */
    AcApSvgPlugin.prototype.onLoad = function (_context, commandManager) {
        var group = AcEdCommandStack.SYSTEMT_COMMAND_GROUP_NAME;
        commandManager.addCommand(group, 'csvg', 'csvg', new AcApConvertToSvgCmd());
        this.registeredCommands.push({ group: group, name: 'csvg' });
    };
    /**
     ...
     */
    AcApSvgPlugin.prototype.onUnload = function (_context, commandManager) {
        var e_1, _a;
        try {
    ...
    return AcApSvgPlugin;
}());
export { AcApSvgPlugin };
//# sourceMappingURL=AcApSvgPlugin.js.map