...
import { type AcExInitialViewMode, type AcExSnapshot, type AcExViewerMode, type AcExViewState } from './AcExSnapshotTypes';
/**
...
export declare class AcApHtmlSnapshotBuilder {
     ...
     */
    build(scene: AcTrScene, database: AcDbDatabase, options?: AcApHtmlSnapshotBuilderOptions): AcExSnapshot;
    /**
     ...
     * @returns A complete v1 snapshot ready for `packHtml`.
     */
    buildAsync(scene: AcTrScene, database: AcDbDatabase, options?: AcApHtmlSnapshotBuilderOptions): Promise<AcExSnapshot>;
    /**
 ...
 */
export declare function listDatabaseLayouts(database: AcDbDatabase): AcExDatabaseLayoutInfo[];
export {};
