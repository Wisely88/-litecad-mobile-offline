...
export type AcExMarkupType = 'text' | 'line' | 'arrow' | 'cloud' | 'rect' | 'circle' | 'highlight' | 'callout' | 'stamp' | 'symbol';
...
export type AcExMarkupGeometry = AcExMarkupTextGeometry | AcExMarkupLineGeometry | AcExMarkupArrowGeometry | AcExMarkupCloudGeometry | AcExMarkupRectGeometry | AcExMarkupCircleGeometry | AcExMarkupHighlightGeometry | AcExMarkupCalloutGeometry | AcExMarkupStampGeometry | AcExMarkupSymbolGeometry;
...
export type AcExMarkupMode = 'cloud' | 'callout' | 'text' | 'rect' | 'circle' | 'arrow' | 'stamp';
//# sourceMappingURL=AcExMarkupTypes.d.ts.map