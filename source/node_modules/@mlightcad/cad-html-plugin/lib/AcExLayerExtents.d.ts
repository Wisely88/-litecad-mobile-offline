import type { AcExExtents, AcExLayoutSnapshot, AcExLineBatch, AcExMeshBatch } from './AcExSnapshotTypes';
/**
 ...
 */
export declare function createEmptyExtents(): AcExMutableExtents;
/**
 ...
 */
export declare function expandExtentsFromPositions(extents: AcExMutableExtents, positions: Float32Array, offset: [number, number, number]): void;
/**
 ...
 */
export declare function expandExtentsFromBatch(extents: AcExMutableExtents, batch: AcExLineBatch | AcExMeshBatch): void;
/**
 ...
 */
export declare function toExtents(extents: AcExMutableExtents): AcExExtents | null;
/**
 ...
 */
export declare function computeLayoutExtents(lineBatches: AcExLineBatch[], meshBatches: AcExMeshBatch[]): AcExExtents | null;
/**
 * Unions two XY extents, ignoring `null` operands.
 */
export declare function unionExtents(a: AcExExtents | null | undefined, b: AcExExtents | null | undefined): AcExExtents | null;
/**
 ...
 */
export declare function computeViewportPaperExtents(viewports: ReadonlyArray<{
    paper: AcExExtents;
}> | undefined): AcExExtents | null;
/**
 ...
 */
export declare function computeLayoutViewExtents(layout: Pick<AcExLayoutSnapshot, 'lineBatches' | 'meshBatches' | 'viewports'>): AcExExtents | null;
/**
 ...
 */
export declare function resolveLayoutViewExtents(layout: Pick<AcExLayoutSnapshot, 'lineBatches' | 'meshBatches' | 'viewports'>, fallbackExtents?: AcExExtents): AcExExtents;
/**
 ...
 */
export declare function computeLayerExtentsMap(lineBatches: AcExLineBatch[], meshBatches: AcExMeshBatch[]): Map<string, AcExExtents | null>;
//# sourceMappingURL=AcExLayerExtents.d.ts.map