 ...
 */
export declare function acexToolbarButton(icon: string, title: string, attrs: Record<string, string>): string;
/**
 ...
 * @param attrs - Additional attributes (e.g. `data-action`, `data-i18n-key`).
 */
export declare function acexDropdownItem(icon: string, label: string, attrs: Record<string, string>): string;
//# sourceMappingURL=AcExHtmlIcons.d.ts.map