import { ACEX_SNAPSHOT_VERSION, type AcExLayerSnapshot, type AcExSnapshot, type AcExSnapshotVersion, type AcExViewportSnapshot } from './AcExSnapshotTypes';
/** Current multi-file package / manifest protocol version. */
export declare const ACEX_PACKAGE_VERSION: 1;
 ...
 */
export declare const ACEX_DEFAULT_CHUNK_MAX_BYTES: number;
/**
 ...
 */
export declare const ACEX_MAX_GEOMETRY_BATCH_BYTES: number;
/**
 ...
 */
export declare const ACEX_DEFAULT_OSNAP_CHUNK_MAX_BYTES: number;
/**
 ...
 */
export declare const ACEX_EMBEDDED_CHUNK_THRESHOLD_BYTES: number;
/**
 ...
 */
export declare const ACEX_EMBEDDED_CHUNK_MAX_BYTES: number;
/**
 * Max estimated uncompressed ACEO size per OSNAP chunk in embedded HTML.
 */
export declare const ACEX_EMBEDDED_OSNAP_CHUNK_MAX_BYTES: number;
export { ACEX_SNAPSHOT_VERSION };
//# sourceMappingURL=AcExPackageTypes.d.ts.map