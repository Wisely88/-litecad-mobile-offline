...
var AcExOsnapMarker = /** @class */ (function () {
    ...
    AcExOsnapMarker.prototype.applyShape = function (shape) {
        ...
        var hidden = this.el.classList.contains('mlcad-osnap-marker--hidden');
        this.el.className = "mlcad-osnap-marker mlcad-osnap-marker--".concat(shape).concat(hidden ? ' mlcad-osnap-marker--hidden' : '');
    };
