...
export declare const ACEX_SNAP_LOUPE_SIZE_PX = 128;
/** Magnification relative to the main view. */
export declare const ACEX_SNAP_LOUPE_ZOOM = 3;
/** Horizontal / vertical offset of the loupe from the canvas top-left. */
export declare const ACEX_SNAP_LOUPE_INSET_PX = 8;
/** Gap between the top chrome row and the loupe when the row is visible. */
export declare const ACEX_SNAP_LOUPE_GAP_BELOW_STATUS_PX = 8;
/**
 * @deprecated Prefer {@link ACEX_SNAP_LOUPE_INSET_PX}; kept for call-site stability.
 */
export declare const ACEX_SNAP_LOUPE_TOP_INSET_PX = 8;
/**
 ...
 */
export declare function acexResolveLoupePlacement(host: HTMLElement, _statusEl?: HTMLElement | null): {
    x: number;
    y: number;
    size: number;
};
 ...
 */
export declare function acexLoupeLocalFromCanvasDelta(dx: number, dy: number, size?: number, zoom?: number): {
    x: number;
    y: number;
};
//# sourceMappingURL=AcExSnapLoupeMath.d.ts.map