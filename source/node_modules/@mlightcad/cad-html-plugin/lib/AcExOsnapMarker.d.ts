 ...
 */
export type AcExOsnapMarkerShape = 'rect' | 'triangle' | 'x' | 'circle' | 'diamond' | 'intersection';
/**
 ...
 */
export declare class AcExOsnapMarker {
...
//# sourceMappingURL=AcExOsnapMarker.d.ts.map