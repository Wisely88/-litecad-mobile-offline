 ...
 */
export var ACEX_HTML_LOCALES = ['en', 'zh', 'cs', 'tr', 'ar'];
/** Short button badge per locale (shown on the language parent and strip). */
export var ACEX_HTML_LOCALE_BADGES = {
    en: 'EN',
    zh: '中',
    cs: 'CS',
    tr: 'TR',
 ...
 */
export var ACEX_HTML_LOCALE_STORAGE_KEY = 'mlcad-html-locale';
var BASE_MESSAGES = {
    en: {
        toolbar: {
        ...
        textHeight: {
            ...
            fromScreenHint: 'Enter how large the text should look on screen at the current zoom. It is converted to a fixed world-space height that stays constant when you zoom later.',
        ...
        touchPointTutorial: {
            ...
            description: 'Long-press on the screen for about 0.5 seconds. A cross appears above your finger and follows as you move, snapping to geometry for more accurate picks.',
        ...
        status: {
            ...
            measureContinuousHint: 'Tap successive points to measure each segment; tap ✓ to finish. Long-press for precise snap.',
            measureAreaHint: 'Tap polygon vertices; tap ✓ to finish when at least three points are set. Long-press for precise snap.',
            measureAngleHint: 'Click vertex, then two points on each arm (object snap enabled).',
            measureArcHint: 'Click a circle or arc to measure along it, or click start, a point on the arc, then end (object snap enabled). Ctrl (⌘ on Mac) switches major/minor arc.',
            ...
            markupCalloutHint: 'Click the leader tip, or the outline of a cloud / rectangle / circle that has no callout, then the text anchor.',
            ...
            markupShapeCalloutHint: 'Click to place the text box (leader attaches to the shape). Esc cancels the callout.',
            ...
            coordinates: 'X: {x} | Y: {y}',
            angle: 'Angle: {value}',
            arcLength: 'Arc length: {length} | Radius: {radius} | Angle: {angle} | Chord: {chord}',
        ...
        package: {
            ...
            hintUrlOnly: 'No drawing.acex.json was found next to this page. Enter the manifest URL to open the package.',
            ...
            invalidManifest: 'The package manifest is invalid or uses an unsupported version: {error}',
            folderMissingManifest: 'The selected folder must contain drawing.acex.json.',
            folderUnsupported: 'This browser cannot open a local package folder. Paste a manifest URL instead.',
        ...
        access: {
            ...
            expiredDetail: 'This file expired on {time} and can no longer be opened.',
            expiresAt: 'Expires: {time}',
            badgeExpires: 'Expires {time}',
            badgeCountdown: 'Expires in {time}',
            tooManyAttempts: 'Too many incorrect password attempts. Refresh the page to try again.'
        }
    },
    zh: {
        toolbar: {
        ...
        textHeight: {
            ...
            fromScreen: '按屏幕字号换算',
            fromScreenHint: '按当前视图缩放，输入希望看到的屏幕字号（像素），换算为固定的世界坐标字高；之后缩放时字的世界高度不变。',
        ...
        touchPointTutorial: {
            title: '怎样可以精确取点？',
            description: '手指在屏幕上长按0.5s左右，上方出现十字，手指移动时十字跟随移动并自动捕捉。取点更精准。',
            snoozeToday: '今日不再提醒',
            hideForever: '不再提醒',
            ok: '我知道了'
        },
        status: {
            ...
            measureContinuousHint: '依次点击多个点测量各段距离，点 ✓ 完成。长按可精确捕捉。',
            measureAreaHint: '依次点击多边形顶点；至少三点后点 ✓ 完成。长按可精确捕捉。',
            measureAngleHint: '依次点击顶点与两条边上的点（已启用对象捕捉）。',
            measureArcHint: '点击圆或圆弧可沿其测量；否则依次点击弧起点、弧上一点与弧端点（已启用对象捕捉）。锁定后按 Ctrl（Mac 为 Control 或 ⌘）可在大弧与小弧之间切换。',
            ...
            markupCalloutHint: '先点击引线端点，或点击尚无标注的云线/矩形/圆外框，再点击文字位置。',
            ...
            markupShapeCalloutHint: '点击放置文本框（引线自动贴到图形）。Esc 取消引线和文本框。',
            ...
            coordinates: 'X：{x} | Y：{y}',
            angle: '角度：{value}',
            arcLength: '弧长：{length} | 半径：{radius} | 总角度：{angle} | 弦长：{chord}',
        ...
        package: {
            ...
            hintUrlOnly: '当前页面同级目录未找到 drawing.acex.json。请输入清单 URL 以打开图纸包。',
            ...
            folderUnsupported: '当前浏览器无法选择本地包文件夹，请改为输入清单 URL。',
    ...
    cs: {
        ...
        textHeight: {
            ...
            fromScreenHint: 'Zadejte, jak velký má text vypadat na obrazovce při aktuálním zoomu. Přepočítá se na pevnou světovou výšku, která se při pozdějším zoomování nemění.',
        ...
        touchPointTutorial: {
            ...
            description: 'Podržte prst na obrazovce asi 0,5 sekundy. Nad prstem se objeví kříž, který při pohybu sleduje prst a přichytává se k geometrii pro přesnější výběr.',
        ...
        status: {
            ...
            measureDistanceHint: 'Klikněte na dva body pro změření vzdálenosti (uchopení objektů zapnuto).',
            measureContinuousHint: 'Klepejte na další body pro měření každého úseku; dokončete klepnutím na ✓. Dlouhé stisknutí pro přesné uchopení.',
            measureAngleHint: 'Klikněte na vrchol, poté na dva body na každém rameni (uchopení objektů zapnuto).',
            measureArcHint: 'Klikněte na kružnici nebo oblouk pro měření podél něj, nebo klikněte na začátek, bod na oblouku a konec (uchopení objektů zapnuto). Ctrl (⌘ na Macu) přepíná velký/malý oblouk.',
            measureAreaHint: 'Klepejte na vrcholy mnohoúhelníku; dokončete klepnutím na ✓ po alespoň třech bodech.',
            measureCoordinateHint: 'Klikněte na bod pro zobrazení jeho souřadnic X/Y (uchopení objektů zapnuto).',
            ...
            markupCalloutHint: 'Klikněte na hrot vodítka, nebo na obrys obláčku/obdélníku/kružnice bez odkazu, a poté na kotvu textu.',
            ...
            markupTextEditHint: 'Pište text přímo na plátno. Enter dokončí, Esc zruší.',
            markupShapeCalloutHint: 'Klikněte pro umístění textového pole (vodítko se připojí k tvaru). Esc zruší odkaz.',
            ...
            coordinates: 'X: {x} | Y: {y}',
            angle: 'Úhel: {value}',
            arcLength: 'Délka oblouku: {length} | Poloměr: {radius} | Úhel: {angle} | Tětiva: {chord}',
        ...
        package: {
            ...
            hintUrlOnly: 'Vedle této stránky nebyl nalezen drawing.acex.json. Zadejte URL manifestu pro otevření balíčku.',
            ...
            invalidManifest: 'Manifest balíčku je neplatný nebo používá nepodporovanou verzi: {error}',
            folderMissingManifest: 'Vybraná složka musí obsahovat drawing.acex.json.',
            folderUnsupported: 'Tento prohlížeč neumí otevřít místní složku balíčku. Zadejte místo toho URL manifestu.',
        ...
        access: {
            ...
            expiredDetail: 'Platnost tohoto souboru vypršela dne {time} a již jej nelze otevřít.',
            expiresAt: 'Platnost do: {time}',
            badgeExpires: 'Platnost do {time}',
            badgeCountdown: 'Vyprší za {time}',
            tooManyAttempts: 'Příliš mnoho nesprávných pokusů o heslo. Obnovte stránku a zkuste to znovu.'
        }
    },
    tr: {
        toolbar: {
        ...
        textHeight: {
            ...
            fromScreenHint: 'Geçerli yakınlaştırmada ekranda istediğiniz yazı boyutunu girin. Sabit bir dünya yüksekliğine dönüştürülür; sonra yakınlaştırınca bu yükseklik değişmez.',
        ...
        touchPointTutorial: {
            ...
            description: 'Ekranda yaklaşık 0,5 saniye basılı tutun. Parmağınızın üstünde bir artı belirir ve hareket ederken geometriye yapışarak daha doğru seçim yapmanızı sağlar.',
        ...
        status: {
            ...
            measureDistanceHint: 'Mesafe ölçmek için iki nokta tıklayın (nesne yakalama etkin).',
            measureContinuousHint: 'Her segmenti ölçmek için ardışık noktalar dokunun; bitirmek için ✓. Hassas yakalama için basılı tutun.',
            measureAngleHint: 'Önce köşe noktasını, sonra her koldan birer nokta tıklayın (nesne yakalama etkin).',
            measureArcHint: 'Ölçmek için bir çember veya yaya tıklayın; ya da yay başlangıcı, yay üzerindeki bir nokta ve yay sonunu tıklayın (nesne yakalama etkin). Ctrl (Mac’te ⌘) büyük/küçük yay arasında geçiş yapar.',
            measureAreaHint: 'Çokgen köşelerini dokunun; en az üç noktadan sonra bitirmek için ✓.',
            measureCoordinateHint: 'X/Y koordinatlarını okumak için bir nokta tıklayın (nesne yakalama etkin).',
            ...
            markupCalloutHint: 'Lider ucunu veya çağrısı olmayan bulut/dikdörtgen/daire dış çerçevesini tıklayın, ardından metin konumunu tıklayın.',
            ...
            markupTextEditHint: 'Metni tuval üzerinde yazın. Enter ile bitirin, Esc ile iptal edin.',
            markupShapeCalloutHint: 'Metin kutusunu yerleştirmek için tıklayın (lider şekle bağlanır). Esc çağrıyı iptal eder.',
            ...
            coordinates: 'X: {x} | Y: {y}',
            angle: 'Açı: {value}',
            arcLength: 'Yay uzunluğu: {length} | Yarıçap: {radius} | Açı: {angle} | Kiriş: {chord}',
        ...
        package: {
            ...
            hintUrlOnly: 'Bu sayfanın yanında drawing.acex.json bulunamadı. Paketi açmak için manifesto URL’sini girin.',
            ...
            invalidManifest: 'Paket manifestosu geçersiz veya desteklenmeyen bir sürüm kullanıyor: {error}',
            folderMissingManifest: 'Seçilen klasör drawing.acex.json içermelidir.',
            folderUnsupported: 'Bu tarayıcı yerel paket klasörü açamıyor. Bunun yerine manifesto URL’si yapıştırın.',
        ...
        access: {
            ...
            expiredDetail: 'Bu dosyanın süresi {time} tarihinde doldu ve artık açılamaz.',
            expiresAt: 'Son geçerlilik: {time}',
            badgeExpires: 'Son geçerlilik {time}',
            badgeCountdown: 'Kalan süre {time}',
            tooManyAttempts: 'Çok fazla yanlış parola denemesi yapıldı. Tekrar denemek için sayfayı yenileyin.'
        }
    }
};
var AR_MESSAGES = {
    ...
    'textHeight': {
        ...
        'fromScreenHint': 'أدخل حجم النص المطلوب على الشاشة عند التكبير الحالي. يُحوَّل إلى ارتفاع ثابت في إحداثيات الرسم ويبقى كما هو عند تغيير التكبير لاحقًا.',
    ...
    'touchPointTutorial': {
        ...
        'description': 'اضغط مطولاً على الشاشة لمدة نصف ثانية تقريباً. يظهر صليب فوق إصبعك ويتبعه أثناء الحركة ويلتقط إلى الهندسة لاختيار أدق.',
    ...
    'status': {
        ...
        'markupCalloutHint': 'انقر على طرف خط الإشارة، أو على إطار سحابة/مستطيل/دائرة بدون تعليق توضيحي، ثم موضع النص.',
        ...
        'coordinates': 'X: {x} | Y: {y}',
        'angle': 'الزاوية: {value}',
        'arcLength': 'طول القوس: {length} | نصف القطر: {radius} | الزاوية: {angle} | الوتر: {chord}',
    ...
    package: {
        ...
        hintUrlOnly: 'لم يتم العثور على drawing.acex.json بجانب هذه الصفحة. أدخل عنوان URL للقائمة لفتح الحزمة.',
        ...
        invalidManifest: 'قائمة الحزمة غير صالحة أو تستخدم إصداراً غير مدعوم: {error}',
        folderMissingManifest: 'يجب أن يحتوي المجلد المحدد على drawing.acex.json.',
        folderUnsupported: 'لا يمكن لهذا المتصفح فتح مجلد حزمة محلي. الصق عنوان URL للقائمة بدلاً من ذلك.',
    ...
    access: {
        ...
        expiredDetail: 'انتهت صلاحية هذا الملف في {time} ولا يمكن فتحه.',
        expiresAt: 'ينتهي في: {time}',
        badgeExpires: 'ينتهي في {time}',
        badgeCountdown: 'متبقي {time}',
        tooManyAttempts: 'عدد محاولات إدخال كلمة المرور كبير جدًا. قم بتحديث الصفحة للمحاولة مرة أخرى.'
    }
};
var MESSAGES = __assign(__assign({}, BASE_MESSAGES), { ar: AR_MESSAGES });
/**
 ...
 */
export function isAcExHtmlLocale(value) {
    return ACEX_HTML_LOCALES.includes(value);
}
/**
 ...
 */
export function resolveAcExHtmlLocale(value) {
    var e_1, _a;
    if (value == null || value === '')
        return null;
    var normalized = value.toLowerCase().replace('_', '-');
    try {
        for (var ACEX_HTML_LOCALES_1 = __values(ACEX_HTML_LOCALES), ACEX_HTML_LOCALES_1_1 = ACEX_HTML_LOCALES_1.next(); !ACEX_HTML_LOCALES_1_1.done; ACEX_HTML_LOCALES_1_1 = ACEX_HTML_LOCALES_1.next()) {
            var locale = ACEX_HTML_LOCALES_1_1.value;
            if (normalized === locale || normalized.startsWith("".concat(locale, "-"))) {
                return locale;
            }
        }
    }
        ...
        try {
            if (ACEX_HTML_LOCALES_1_1 && !ACEX_HTML_LOCALES_1_1.done && (_a = ACEX_HTML_LOCALES_1.return)) _a.call(ACEX_HTML_LOCALES_1);
        }
 ...
 * defaults to `'en'`.
 */
export function detectBrowserAcExHtmlLocale() {
    var e_2, _a;
    var _b;
    if (typeof navigator === 'undefined')
        return 'en';
    var candidates = __spreadArray(__spreadArray([], __read(((_b = navigator.languages) !== null && _b !== void 0 ? _b : [])), false), [
        navigator.language
    ], false).filter(Boolean);
    try {
        for (var candidates_1 = __values(candidates), candidates_1_1 = candidates_1.next(); !candidates_1_1.done; candidates_1_1 = candidates_1.next()) {
            var candidate = candidates_1_1.value;
            var resolved = resolveAcExHtmlLocale(candidate);
            if (resolved)
                return resolved;
        }
    }
...
export function detectAcExHtmlLocale() {
    if (typeof localStorage !== 'undefined') {
        try {
            var stored = localStorage.getItem(ACEX_HTML_LOCALE_STORAGE_KEY);
            var fromStorage = resolveAcExHtmlLocale(stored);
            if (fromStorage)
                return fromStorage;
        }
        catch (_a) {
...
function lookupMessage(tree, key) {
    var e_3, _a;
    var parts = key.split('.');
    var node = tree;
    try {
 ...
 */
export function formatAcExHtmlMessage(template, params) {
    if (!params)
        return template;
    return template.replace(/\{(\w+)\}/g, function (_, name) {
        var value = params[name];
        return value != null ? String(value) : "{".concat(name, "}");
    });
}
/**
 ...
 */
var AcExHtmlI18n = /** @class */ (function () {
    /**
     * @param initialLocale - Starting locale; defaults to {@link detectAcExHtmlLocale} when omitted.
     */
    function AcExHtmlI18n(initialLocale) {
        this._onChange = null;
        this._locale = initialLocale !== null && initialLocale !== void 0 ? initialLocale : detectAcExHtmlLocale();
    }
    Object.defineProperty(AcExHtmlI18n.prototype, "locale", {
    ...
    Object.defineProperty(AcExHtmlI18n.prototype, "localeBadge", {
     ...
     */
    AcExHtmlI18n.prototype.setOnChange = function (handler) {
     ...
     */
    AcExHtmlI18n.prototype.t = function (key, params) {
        var _a, _b;
        var template = (_b = (_a = lookupMessage(MESSAGES[this._locale], key)) !== null && _a !== void 0 ? _a : lookupMessage(MESSAGES.en, key)) !== null && _b !== void 0 ? _b : key;
     ...
     */
    AcExHtmlI18n.prototype.toggleLocale = function () {
        var index = ACEX_HTML_LOCALES.indexOf(this._locale);
        var next = ACEX_HTML_LOCALES[(index + 1) % ACEX_HTML_LOCALES.length];
        this.setLocale(next);
        return next;
    };
    /**
     ...
     */
    AcExHtmlI18n.prototype.setLocale = function (locale) {
        var _a;
     ...
     */
    AcExHtmlI18n.prototype.applyToDocument = function (root) {
        var _this = this;
        if (typeof document === 'undefined')
            return;
        var scope = root !== null && root !== void 0 ? root : document;
        ...
        scope.querySelectorAll('[data-i18n-text]').forEach(function (el) {
            ...
            if (!key)
                return;
            el.textContent = _this.t(key);
        });
        scope.querySelectorAll('[data-i18n-attr]').forEach(function (el) {
            var e_4, _a;
            var _b, _c;
            var key = el.dataset.i18nKey;
            var attrs = (_c = (_b = el.dataset.i18nAttr) === null || _b === void 0 ? void 0 : _b.split(/\s+/)) !== null && _c !== void 0 ? _c : [];
            if (!key || attrs.length === 0)
                return;
            var text = _this.t(key);
            try {
        ...
        var badge = document.getElementById('mlcad-lang-badge');
        if (badge)
            badge.textContent = this.localeBadge;
    };
    return AcExHtmlI18n;
}());
export { AcExHtmlI18n };
//# sourceMappingURL=AcExHtmlI18n.js.map