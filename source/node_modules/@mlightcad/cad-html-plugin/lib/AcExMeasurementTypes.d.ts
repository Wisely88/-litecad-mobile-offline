...
export type AcExMeasurementType = 'distance' | 'angle' | 'area' | 'arc' | 'point';
...
export type AcExMeasurementGeometry = AcExMeasurementDistanceGeometry | AcExMeasurementAngleGeometry | AcExMeasurementAreaGeometry | AcExMeasurementArcGeometry | AcExMeasurementPointGeometry;
...
//# sourceMappingURL=AcExMeasurementTypes.d.ts.map