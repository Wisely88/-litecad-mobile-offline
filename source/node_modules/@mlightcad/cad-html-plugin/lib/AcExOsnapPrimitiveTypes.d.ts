 ...
 */
export type AcExOsnapMode = 'endpoint' | 'midpoint' | 'center' | 'quadrant' | 'nearest' | 'node' | 'intersection';
/**
 ...
 */
export declare const ACEX_DEFAULT_OSNAP_MODES: readonly AcExOsnapMode[];
/**
 ...
 */
export type AcExOsnapPrimitive = AcExOsnapLinePrimitive | AcExOsnapCirclePrimitive | AcExOsnapArcPrimitive | AcExOsnapEllipsePrimitive | AcExOsnapSplinePrimitive | AcExOsnapPointPrimitive | AcExOsnapPathPrimitive;
/**
...
//# sourceMappingURL=AcExOsnapPrimitiveTypes.d.ts.map