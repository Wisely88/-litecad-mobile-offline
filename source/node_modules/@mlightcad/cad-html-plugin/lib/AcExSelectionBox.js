 ...
 */
export function acexExtentsMatchBox(item, box, mode) {
    if (mode === 'window') {
 ...
 */
export function acexSelectionModeFromDrag(startX, endX) {
    return endX >= startX ? 'window' : 'crossing';
}
//# sourceMappingURL=AcExSelectionBox.js.map