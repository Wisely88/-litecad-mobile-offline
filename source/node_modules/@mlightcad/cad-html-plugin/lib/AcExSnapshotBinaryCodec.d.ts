 ...
 */
export declare function encodeSnapshotBinary(snapshot: AcExSnapshot): Uint8Array;
/**
 * Parses a binary snapshot byte array produced by {@link encodeSnapshotBinary}.
 */
export declare function decodeSnapshotBinary(bytes: Uint8Array): AcExSnapshot;
//# sourceMappingURL=AcExSnapshotBinaryCodec.d.ts.map