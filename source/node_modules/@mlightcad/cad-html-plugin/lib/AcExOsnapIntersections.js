...
function intersectCircles(a, b, tol) {
    ...
    try {
        for (var points_1 = __values(points), points_1_1 = points_1.next(); !points_1_1.done; points_1_1 = points_1.next()) {
            ...
            if (isPointOnCircArc(p.x, p.y, a, tol) &&
