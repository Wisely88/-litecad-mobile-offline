...
export var HTML_PLUGIN_NAME = 'HtmlPlugin';
/**
 ...
 */
export var HTML_PLUGIN_TRIGGERS = ['-chtml', 'chtml'];
/**
 ...
 */
export function registerLazyHtmlPlugin(pluginManager, options) {
    var _this = this;
    if (options) {
        registeredOptions = __assign(__assign({}, registeredOptions), options);
    }
    var optionsForLoader = __assign({}, registeredOptions);
    pluginManager.registerLazyPlugin({
        name: HTML_PLUGIN_NAME,
        triggers: __spreadArray([], __read(HTML_PLUGIN_TRIGGERS), false),
        loader: function () { return __awaiter(_this, void 0, void 0, function () {
            var createHtmlPlugin;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, import('@mlightcad/cad-html-plugin')];
                    case 1:
                        createHtmlPlugin = (_a.sent()).createHtmlPlugin;
                        return [2 /*return*/, createHtmlPlugin(optionsForLoader)];
                }
            });
        }); }
    });
