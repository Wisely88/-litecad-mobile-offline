...
export declare const DEFAULT_HTML_VIEWER_RUNTIME_URL = "./viewer-runtime.iife.js";
/**
 ...
 */
export declare function configureHtmlPlugin(options: AcApHtmlPluginOptions): void;
/** Returns the current HTML plugin defaults (shallow copy). */
export declare function getHtmlPluginOptions(): AcApHtmlPluginOptions;
/**
 ...
 */
export declare function resolveViewerRuntimeUrl(override?: string | URL): string;
//# sourceMappingURL=AcApHtmlPluginOptions.d.ts.map